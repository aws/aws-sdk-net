...
{
    /// <summary>
    /// Response Unmarshaller for CreatePresignedNotebookUrl operation
    /// </summary>  
    public class CreatePresignedNotebookUrlResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePresignedNotebookUrlResponse response = new CreatePresignedNotebookUrlResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("NotebookUrl", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.NotebookUrl = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static CreatePresignedNotebookUrlResponseUnmarshaller _instance = new CreatePresignedNotebookUrlResponseUnmarshaller();        

        internal static CreatePresignedNotebookUrlResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePresignedNotebookUrlResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
