...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    public class ListCapacityReservationsRequestMarshaller : IMarshaller<IRequest, ListCapacityReservationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(ListCapacityReservationsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Athena");
            string target = "AmazonAthena.ListCapacityReservations";
        ...
        private static ListCapacityReservationsRequestMarshaller _instance = new ListCapacityReservationsRequestMarshaller();        

        internal static ListCapacityReservationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCapacityReservationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
