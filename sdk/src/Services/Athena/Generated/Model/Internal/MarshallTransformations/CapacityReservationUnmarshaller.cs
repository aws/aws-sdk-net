...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    public class CapacityReservationUnmarshaller : IJsonUnmarshaller<CapacityReservation, JsonUnmarshallerContext>
    {
        ...
        public CapacityReservation Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AllocatedDpus", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("LastAllocation", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("LastSuccessfulAllocationTime", targetDepth, ref reader))
                {
                    var unmarshaller = NullableDateTimeUnmarshaller.Instance;
                ...
                if (context.TestExpression("TargetDpus", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
