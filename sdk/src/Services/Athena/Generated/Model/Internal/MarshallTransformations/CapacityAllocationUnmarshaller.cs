...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CapacityAllocationUnmarshaller : IUnmarshaller<CapacityAllocation, XmlUnmarshallerContext>, IUnmarshaller<CapacityAllocation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CapacityAllocation IUnmarshaller<CapacityAllocation, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public CapacityAllocation Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("RequestCompletionTime", targetDepth))
                {
                    ...
                    unmarshalledObject.RequestCompletionTime = unmarshaller.Unmarshall(context);
                    continue;
                }
