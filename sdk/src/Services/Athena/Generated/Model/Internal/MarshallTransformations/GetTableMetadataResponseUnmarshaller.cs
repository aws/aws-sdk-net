...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    public class GetTableMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("TableMetadata", targetDepth, ref reader))
                {
                    var unmarshaller = TableMetadataUnmarshaller.Instance;
                    response.TableMetadata = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("MetadataException"))
                {
                    return MetadataExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
            }
        ...
        private static GetTableMetadataResponseUnmarshaller _instance = new GetTableMetadataResponseUnmarshaller();        

        internal static GetTableMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
