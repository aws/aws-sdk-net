...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    public class ImportNotebookRequestMarshaller : IMarshaller<IRequest, ImportNotebookRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(ImportNotebookRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Athena");
            string target = "AmazonAthena.ImportNotebook";
            ...
            if(publicRequest.IsSetNotebookS3LocationUri())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.NotebookS3LocationUri);
            }

            if(publicRequest.IsSetPayload())
            {
                context.Writer.WritePropertyName("Payload");
                context.Writer.WriteStringValue(publicRequest.Payload);
            }
        ...
        private static ImportNotebookRequestMarshaller _instance = new ImportNotebookRequestMarshaller();        

        internal static ImportNotebookRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportNotebookRequestMarshaller Instance
        {
            get
            {
                return _instance;
