...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    public class GetTableMetadataRequestMarshaller : IMarshaller<IRequest, GetTableMetadataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTableMetadataRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Athena");
            string target = "AmazonAthena.GetTableMetadata";
            ...
            if(publicRequest.IsSetCatalogName())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.CatalogName);
            }
        ...
        private static GetTableMetadataRequestMarshaller _instance = new GetTableMetadataRequestMarshaller();        

        internal static GetTableMetadataRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableMetadataRequestMarshaller Instance
        {
            get
            {
                return _instance;
