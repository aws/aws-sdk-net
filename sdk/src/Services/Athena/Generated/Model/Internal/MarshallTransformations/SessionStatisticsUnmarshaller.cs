...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SessionStatisticsUnmarshaller : IUnmarshaller<SessionStatistics, XmlUnmarshallerContext>, IUnmarshaller<SessionStatistics, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SessionStatistics IUnmarshaller<SessionStatistics, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public SessionStatistics Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
