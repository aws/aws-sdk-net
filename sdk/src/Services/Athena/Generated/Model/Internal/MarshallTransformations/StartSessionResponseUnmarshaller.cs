...
{
    /// <summary>
    /// Response Unmarshaller for StartSession operation
    /// </summary>  
    public class StartSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, context.ResponseData))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("SessionAlreadyExistsException"))
                {
                    return SessionAlreadyExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref readerCopy);
                }
        ...
        private static StartSessionResponseUnmarshaller _instance = new StartSessionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
