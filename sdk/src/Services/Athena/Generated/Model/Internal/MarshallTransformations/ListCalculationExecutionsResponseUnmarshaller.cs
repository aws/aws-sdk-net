    ...
    public class ListCalculationExecutionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CalculationSummary, CalculationSummaryUnmarshaller>(CalculationSummaryUnmarshaller.Instance);
                    response.Calculations = unmarshaller.Unmarshall(context);
                    continue;
                }
