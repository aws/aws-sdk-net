    ...
    public class ListCapacityReservationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<CapacityReservation, CapacityReservationUnmarshaller>(CapacityReservationUnmarshaller.Instance);
                    response.CapacityReservations = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static ListCapacityReservationsResponseUnmarshaller _instance = new ListCapacityReservationsResponseUnmarshaller();        

        internal static ListCapacityReservationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCapacityReservationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
