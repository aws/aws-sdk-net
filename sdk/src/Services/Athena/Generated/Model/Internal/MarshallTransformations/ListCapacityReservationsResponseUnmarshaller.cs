    ...
    public class ListCapacityReservationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CapacityReservation, CapacityReservationUnmarshaller>(CapacityReservationUnmarshaller.Instance);
                    response.CapacityReservations = unmarshaller.Unmarshall(context);
                    continue;
                }
