...
namespace Amazon.Athena.Internal
{
    /// <inheritdoc cref="IAuthSchemeParameters" />
    public class AmazonAthenaAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAthenaAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Athena.
        /// </summary>
        public AmazonAthenaAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAthenaAuthSchemeParameters
            {
    ...
    public class AmazonAthenaAuthSchemeResolver : IAuthSchemeResolver<AmazonAthenaAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAthenaAuthSchemeParameters authParameters)
        {
