...
namespace Amazon.IoT1ClickDevicesService.Internal
{
    ...
    public class AmazonIoT1ClickDevicesServiceAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonIoT1ClickDevicesServiceAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for IoT1ClickDevicesService.
        /// </summary>
        public AmazonIoT1ClickDevicesServiceAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonIoT1ClickDevicesServiceAuthSchemeParameters
            {
    ...
    public class AmazonIoT1ClickDevicesServiceAuthSchemeResolver : IAuthSchemeResolver<AmazonIoT1ClickDevicesServiceAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonIoT1ClickDevicesServiceAuthSchemeParameters authParameters)
        {
