...
namespace Amazon.IoT1ClickDevicesService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeviceMethodUnmarshaller : IJsonUnmarshaller<DeviceMethod, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DeviceMethod Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
