    ...
    public class GetDeviceMethodsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<DeviceMethod, DeviceMethodUnmarshaller>(DeviceMethodUnmarshaller.Instance);
                    response.DeviceMethods = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
