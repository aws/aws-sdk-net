...
{
    /// <summary>
    /// Response Unmarshaller for FinalizeDeviceClaim operation
    /// </summary>  
    public class FinalizeDeviceClaimResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            FinalizeDeviceClaimResponse response = new FinalizeDeviceClaimResponse();
        ...
        private static FinalizeDeviceClaimResponseUnmarshaller _instance = new FinalizeDeviceClaimResponseUnmarshaller();        

        internal static FinalizeDeviceClaimResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static FinalizeDeviceClaimResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
