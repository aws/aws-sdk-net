...
namespace Amazon.IoT1ClickDevicesService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeviceEventUnmarshaller : IJsonUnmarshaller<DeviceEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DeviceEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("stdEvent", targetDepth))
                {
                    ...
                    unmarshalledObject.StdEvent = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
