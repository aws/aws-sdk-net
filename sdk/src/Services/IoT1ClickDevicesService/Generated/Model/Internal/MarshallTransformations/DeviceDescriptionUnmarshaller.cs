...
namespace Amazon.IoT1ClickDevicesService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeviceDescriptionUnmarshaller : IJsonUnmarshaller<DeviceDescription, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public DeviceDescription Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("remainingLife", targetDepth))
                {
                    ...
                    unmarshalledObject.RemainingLife = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
