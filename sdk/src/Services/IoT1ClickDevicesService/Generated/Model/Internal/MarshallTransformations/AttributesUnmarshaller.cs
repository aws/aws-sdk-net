...
namespace Amazon.IoT1ClickDevicesService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AttributesUnmarshaller : IJsonUnmarshaller<Attributes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public Attributes Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
