...
{
    /// <summary>
    /// Response Unmarshaller for InitiateDeviceClaim operation
    /// </summary>  
    public class InitiateDeviceClaimResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            InitiateDeviceClaimResponse response = new InitiateDeviceClaimResponse();
        ...
        private static InitiateDeviceClaimResponseUnmarshaller _instance = new InitiateDeviceClaimResponseUnmarshaller();        

        internal static InitiateDeviceClaimResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InitiateDeviceClaimResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
