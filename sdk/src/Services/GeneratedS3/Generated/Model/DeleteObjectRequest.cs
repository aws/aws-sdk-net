...
namespace Amazon.S3.Model
{
    ...
    ///  </li> </ul>
    /// </summary>
    public partial class DeleteObjectRequest : AmazonS3Request
    {
        private string _bucketName;
        private bool? _bypassGovernanceRetention;
        private string _expectedBucketOwner;
        private string _ifMatch;
        private DateTime? _ifMatchLastModifiedTime;
        private long? _ifMatchSize;
        private string _key;
        private string _mfa;
        ...
        /// <para>
        /// The <c>If-Match</c> header field makes the request method conditional on ETags. If
        /// the ETag value does not match, the operation returns a <c>412 Precondition Failed</c>
        /// error. If the ETag matches or if the object doesn't exist, the operation will return
        /// a <c>204 Success (No Content) response</c>.
        /// </para>
        ///  
        /// <para>
        ...
        /// <c>Timestamp</c>. If the <c>Timestamp</c> values do not match, the operation returns
        /// a <c>412 Precondition Failed</c> error. If the <c>Timestamp</c> matches or if the
        /// object doesn’t exist, the operation returns a <c>204 Success (No Content)</c> response.
        /// </para>
        ///  <note> 
        /// <para>
        /// This functionality is only supported for directory buckets.
        ...
        {
            get { return this._ifMatchLastModifiedTime; }
            set { this._ifMatchLastModifiedTime = value; }
        }

        // Check to see if IfMatchLastModifiedTime property is set
        internal bool IsSetIfMatchLastModifiedTime()
        {
            return this._ifMatchLastModifiedTime.HasValue; 
        }
        ...
        /// If the <c>Size</c> value does not match, the operation returns a <c>412 Precondition
        /// Failed</c> error. If the <c>Size</c> matches or if the object doesn’t exist, the operation
        /// returns a <c>204 Success (No Content)</c> response.
        /// </para>
        ///  <note> 
        /// <para>
        /// This functionality is only supported for directory buckets.
        ...
        ///  </note> <important> 
        /// <para>
        /// You can use the <c>If-Match</c>, <c>x-amz-if-match-last-modified-time</c> and <c>x-amz-if-match-size</c>
        ...
        {
            get { return this._ifMatchSize; }
            set { this._ifMatchSize = value; }
        }

        // Check to see if IfMatchSize property is set
        internal bool IsSetIfMatchSize()
        {
            return this._ifMatchSize.HasValue; 
        }
