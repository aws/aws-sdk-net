...
namespace Amazon.S3.Model
{
    ...
    ///  </li> </ul>
    /// </summary>
    public partial class ListMultipartUploadsRequest : AmazonS3Request
    {
        ...
        ///  <note> <ul> <li> 
        /// <para>
        ///  <b>General purpose buckets</b> - For general purpose buckets, <c>key-marker</c> is
        /// an object key. Together with <c>upload-id-marker</c>, this parameter specifies the
        /// multipart upload after which listing should begin.
        /// </para>
        ///  
        /// <para>
        /// If <c>upload-id-marker</c> is not specified, only the keys lexicographically greater
        /// than the specified <c>key-marker</c> will be included in the list.
        /// </para>
        ///  
        /// <para>
        /// If <c>upload-id-marker</c> is specified, any multipart uploads for a key equal to
        /// the <c>key-marker</c> might also be included, provided those multipart uploads have
        /// upload IDs lexicographically greater than the specified <c>upload-id-marker</c>.
        /// </para>
        ///  </li> <li> 
        /// <para>
        ...
        /// the value of <c>key-marker</c> to the <c>NextKeyMarker</c> value from the previous
        /// response. 
        /// </para>
        ///  
        /// <para>
        /// In the <c>ListMultipartUploads</c> response, the multipart uploads aren't sorted lexicographically
