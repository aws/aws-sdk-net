...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetBucketIntelligentTieringConfigurationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, GetBucketIntelligentTieringConfigurationResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = IntelligentTieringConfigurationUnmarshaller.Instance;
                        response.IntelligentTieringConfiguration = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        private static GetBucketIntelligentTieringConfigurationResponseUnmarshaller _instance = new GetBucketIntelligentTieringConfigurationResponseUnmarshaller();        

        internal static GetBucketIntelligentTieringConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
