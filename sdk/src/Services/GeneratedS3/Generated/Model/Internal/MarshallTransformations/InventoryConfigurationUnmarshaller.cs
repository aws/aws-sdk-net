        ...
        public InventoryConfiguration Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        if (unmarshalledObject.OptionalFields == null)
                        {
                            unmarshalledObject.OptionalFields = new List<string>();
                        }
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.OptionalFields.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
