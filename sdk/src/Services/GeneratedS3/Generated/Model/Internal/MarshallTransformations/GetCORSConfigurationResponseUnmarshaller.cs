...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetCORSConfigurationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, GetCORSConfigurationResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        if (response.CORSRules == null)
                        {
                            response.CORSRules = new List<CORSRule>();
                        }
                        var unmarshaller = CORSRuleUnmarshaller.Instance;
                        response.CORSRules.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
                }
