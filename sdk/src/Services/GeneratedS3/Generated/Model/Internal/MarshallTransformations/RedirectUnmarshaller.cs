...
{
    /// <summary>
    /// Response Unmarshaller for Redirect Object
    /// </summary>  
    public class RedirectUnmarshaller : IXmlUnmarshaller<Redirect, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public Redirect Unmarshall(XmlUnmarshallerContext context)
        {
            Redirect unmarshalledObject = new Redirect();
        ...
        private static RedirectUnmarshaller _instance = new RedirectUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RedirectUnmarshaller Instance
        {
            get
            {
                return _instance;
