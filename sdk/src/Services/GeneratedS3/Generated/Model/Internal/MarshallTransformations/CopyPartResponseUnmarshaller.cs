...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CopyPartResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, CopyPartResponse response)
        {
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("CopyPartResult", targetDepth))
                    {
                        var unmarshaller = CopyPartResultUnmarshaller.Instance;
                        response.CopyPartResult = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
