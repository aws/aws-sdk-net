...
{
    /// <summary>
    /// Response Unmarshaller for Part Object
    /// </summary>  
    public class PartUnmarshaller : IXmlUnmarshaller<Part, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public Part Unmarshall(XmlUnmarshallerContext context)
        {
            Part unmarshalledObject = new Part();
        ...
        private static PartUnmarshaller _instance = new PartUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PartUnmarshaller Instance
        {
            get
            {
                return _instance;
