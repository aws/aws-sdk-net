...
{
    /// <summary>
    /// Response Unmarshaller for CopyObjectResult Object
    /// </summary>  
    public class CopyObjectResultUnmarshaller : IXmlUnmarshaller<CopyObjectResult, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public CopyObjectResult Unmarshall(XmlUnmarshallerContext context)
        {
            CopyObjectResult unmarshalledObject = new CopyObjectResult();
        ...
        private static CopyObjectResultUnmarshaller _instance = new CopyObjectResultUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CopyObjectResultUnmarshaller Instance
        {
            get
            {
                return _instance;
