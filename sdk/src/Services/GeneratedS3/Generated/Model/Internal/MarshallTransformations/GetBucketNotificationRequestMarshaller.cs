...
{
    /// <summary>
    /// GetBucketNotification Request Marshaller
    /// </summary>       
    public class GetBucketNotificationRequestMarshaller : IMarshaller<IRequest, GetBucketNotificationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(GetBucketNotificationRequest publicRequest)
        {
        ...
        private static GetBucketNotificationRequestMarshaller _instance = new GetBucketNotificationRequestMarshaller();        

        internal static GetBucketNotificationRequestMarshaller GetInstance()
        {
            return _instance;
        }
