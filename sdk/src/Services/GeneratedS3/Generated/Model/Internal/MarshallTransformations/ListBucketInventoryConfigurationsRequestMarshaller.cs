...
{
    /// <summary>
    /// ListBucketInventoryConfigurations Request Marshaller
    /// </summary>       
    public class ListBucketInventoryConfigurationsRequestMarshaller : IMarshaller<IRequest, ListBucketInventoryConfigurationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(ListBucketInventoryConfigurationsRequest publicRequest)
        {
        ...
        private static ListBucketInventoryConfigurationsRequestMarshaller _instance = new ListBucketInventoryConfigurationsRequestMarshaller();        

        internal static ListBucketInventoryConfigurationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
