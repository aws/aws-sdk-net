...
{
    /// <summary>
    /// Response Unmarshaller for ListBucketInventoryConfigurations operation
    /// </summary>  
    public class ListBucketInventoryConfigurationsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("InventoryConfiguration", targetDepth))
                    {
                        ...
                        var unmarshaller = InventoryConfigurationUnmarshaller.Instance;
                        response.InventoryConfigurationList.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
        ...
        internal static ListBucketInventoryConfigurationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
