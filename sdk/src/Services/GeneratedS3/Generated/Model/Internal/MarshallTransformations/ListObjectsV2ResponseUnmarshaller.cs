...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListObjectsV2ResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("CommonPrefixes", targetDepth))
                    {
                        ...
                        {
                            response.CommonPrefixes = new List<CommonPrefix>();
                        }
                        var unmarshaller = CommonPrefixUnmarshaller.Instance;
                    ...
                    if (context.TestExpression("Contents", targetDepth))
                    {
                        ...
                        {
                            response.Contents = new List<Object>();
                        }
                        var unmarshaller = ObjectUnmarshaller.Instance;
                        response.Contents.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        response.EncodingType = unmarshaller.Unmarshall(context);
                        continue;
                    }
