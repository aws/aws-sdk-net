...
{
    /// <summary>
    /// GetBucketLogging Request Marshaller
    /// </summary>       
    public class GetBucketLoggingRequestMarshaller : IMarshaller<IRequest, GetBucketLoggingRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(GetBucketLoggingRequest publicRequest)
        {
        ...
        private static GetBucketLoggingRequestMarshaller _instance = new GetBucketLoggingRequestMarshaller();        

        internal static GetBucketLoggingRequestMarshaller GetInstance()
        {
            return _instance;
        }
