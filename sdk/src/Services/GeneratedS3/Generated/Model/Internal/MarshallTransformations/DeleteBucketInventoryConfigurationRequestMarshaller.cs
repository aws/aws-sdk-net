...
{
    /// <summary>
    /// DeleteBucketInventoryConfiguration Request Marshaller
    /// </summary>       
    public class DeleteBucketInventoryConfigurationRequestMarshaller : IMarshaller<IRequest, DeleteBucketInventoryConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteBucketInventoryConfigurationRequest publicRequest)
        {
        ...
        private static DeleteBucketInventoryConfigurationRequestMarshaller _instance = new DeleteBucketInventoryConfigurationRequestMarshaller();        

        internal static DeleteBucketInventoryConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
