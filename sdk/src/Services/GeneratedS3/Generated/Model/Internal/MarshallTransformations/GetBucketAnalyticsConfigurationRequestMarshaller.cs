...
{
    /// <summary>
    /// GetBucketAnalyticsConfiguration Request Marshaller
    /// </summary>       
    public class GetBucketAnalyticsConfigurationRequestMarshaller : IMarshaller<IRequest, GetBucketAnalyticsConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(GetBucketAnalyticsConfigurationRequest publicRequest)
        {
        ...
        private static GetBucketAnalyticsConfigurationRequestMarshaller _instance = new GetBucketAnalyticsConfigurationRequestMarshaller();        

        internal static GetBucketAnalyticsConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
