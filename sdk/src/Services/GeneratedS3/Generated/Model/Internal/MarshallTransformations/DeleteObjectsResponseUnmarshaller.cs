...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteObjectsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("Deleted", targetDepth))
                    {
                        ...
                        var unmarshaller = DeletedObjectUnmarshaller.Instance;
                        response.DeletedObjects.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
                    if (context.TestExpression("Error", targetDepth))
                    {
                        ...
                        response.Errors.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
                }
        ...
        private static DeleteObjectsResponseUnmarshaller _instance = new DeleteObjectsResponseUnmarshaller();        
