...
{
    /// <summary>
    /// Response Unmarshaller for ObjectVersion Object
    /// </summary>  
    public class ObjectVersionUnmarshaller : IXmlUnmarshaller<ObjectVersion, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public ObjectVersion Unmarshall(XmlUnmarshallerContext context)
        {
            ObjectVersion unmarshalledObject = new ObjectVersion();
        ...
        private static ObjectVersionUnmarshaller _instance = new ObjectVersionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ObjectVersionUnmarshaller Instance
        {
            get
            {
                return _instance;
