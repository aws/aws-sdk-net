...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StatsUnmarshaller : IXmlUnmarshaller<Stats, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public Stats Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = NullableLongUnmarshaller.Instance;
                        unmarshalledObject.BytesReturned = unmarshaller.Unmarshall(context);
                        continue;
                    }
