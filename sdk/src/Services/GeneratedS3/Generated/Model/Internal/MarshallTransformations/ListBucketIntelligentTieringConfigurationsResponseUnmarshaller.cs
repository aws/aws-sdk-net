...
{
    /// <summary>
    /// Response Unmarshaller for ListBucketIntelligentTieringConfigurations operation
    /// </summary>  
    public class ListBucketIntelligentTieringConfigurationsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("IntelligentTieringConfiguration", targetDepth))
                    {
                        ...
                        response.IntelligentTieringConfigurationList.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
        ...
        internal static ListBucketIntelligentTieringConfigurationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
