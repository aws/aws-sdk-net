...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    public class WriteGetObjectResponseRequestMarshaller : IMarshaller<IRequest, WriteGetObjectResponseRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(WriteGetObjectResponseRequest publicRequest)
        {
            ...
            {
                request.Headers["x-amz-fwd-header-x-amz-server-side-encryption"] = publicRequest.ServerSideEncryption;
            }
        
            if (publicRequest.IsSetSSECustomerAlgorithm()) 
            {
                request.Headers["x-amz-fwd-header-x-amz-server-side-encryption-customer-algorithm"] = publicRequest.SSECustomerAlgorithm;
            }
