...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetBucketLoggingResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, GetBucketLoggingResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = LoggingEnabledUnmarshaller.Instance;
        ...
        private static GetBucketLoggingResponseUnmarshaller _instance = new GetBucketLoggingResponseUnmarshaller();        

        internal static GetBucketLoggingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
