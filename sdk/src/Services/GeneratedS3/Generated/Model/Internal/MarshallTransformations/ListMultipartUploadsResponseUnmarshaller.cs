...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListMultipartUploadsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("Upload", targetDepth))
                    {
                        ...
                        {
                            response.Uploads = new List<MultipartUpload>();
                        }
                        var unmarshaller = MultipartUploadUnmarshaller.Instance;
                        response.Uploads.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
                }
