        ...
        public IRequest Marshall(PutBucketVersioningRequest publicRequest)
        {
            ...
            {   
                if (publicRequest.IsSetVersioningConfig())
                {
                    ...
                    if(publicRequest.VersioningConfig.IsSetMFADelete())
                        xmlWriter.WriteElementString("MfaDelete", StringUtils.FromString(publicRequest.VersioningConfig.MFADelete));
