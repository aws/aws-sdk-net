...
{
    /// <summary>
    /// GetLifecycleConfiguration Request Marshaller
    /// </summary>       
    public class GetLifecycleConfigurationRequestMarshaller : IMarshaller<IRequest, GetLifecycleConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(GetLifecycleConfigurationRequest publicRequest)
        {
        ...
        private static GetLifecycleConfigurationRequestMarshaller _instance = new GetLifecycleConfigurationRequestMarshaller();        

        internal static GetLifecycleConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
