...
{
    /// <summary>
    /// Response Unmarshaller for Tiering Object
    /// </summary>  
    public class TieringUnmarshaller : IXmlUnmarshaller<Tiering, XmlUnmarshallerContext>
    {
        ...
        {
            Tiering unmarshalledObject = new Tiering();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("AccessTier", targetDepth))
                    {
                        ...
                        unmarshalledObject.AccessTier = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        private static TieringUnmarshaller _instance = new TieringUnmarshaller();        
