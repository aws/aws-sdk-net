...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LifecycleRuleUnmarshaller : IXmlUnmarshaller<LifecycleRule, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        public LifecycleRule Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("NoncurrentVersionTransition/member", targetDepth))
                    {
                    ...
                    if (context.TestExpression("Transition/member", targetDepth))
                    {
