...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetBucketAccelerateConfigurationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBucketAccelerateConfigurationResponse response = new GetBucketAccelerateConfigurationResponse();
        ...
        internal static GetBucketAccelerateConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
