...
{
    /// <summary>
    /// DeleteBucketWebsite Request Marshaller
    /// </summary>       
    public class DeleteBucketWebsiteRequestMarshaller : IMarshaller<IRequest, DeleteBucketWebsiteRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteBucketWebsiteRequest publicRequest)
        {
        ...
        private static DeleteBucketWebsiteRequestMarshaller _instance = new DeleteBucketWebsiteRequestMarshaller();        

        internal static DeleteBucketWebsiteRequestMarshaller GetInstance()
        {
            return _instance;
        }
