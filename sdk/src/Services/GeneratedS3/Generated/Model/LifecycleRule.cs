...
namespace Amazon.S3.Model
{
    ...
    public partial class LifecycleRule
    {
        ...
        /// <c>Filter</c> must have exactly one of <c>Prefix</c>, <c>Tag</c>, or <c>And</c> specified.
        /// <c>Filter</c> is required if the <c>LifecycleRule</c> does not contain a <c>Prefix</c>
        /// element.
        /// </para>
        ///  <note> 
        /// <para>
