...
namespace Amazon.BedrockAgent.Endpoints
{
    /// <summary>
    /// Contains parameters used for resolving BedrockAgent endpoints.
    /// <para />
    /// Parameters can be sourced from client config and service operations used by the
    /// internal <see cref="AmazonBedrockAgentEndpointProvider"/> and <see cref="AmazonBedrockAgentEndpointResolver"/>.
    /// <para />
    /// Can be used by custom Endpoint Providers, <see cref="ClientConfig.EndpointProvider"/>
    /// </summary>
    public class BedrockAgentEndpointParameters : EndpointParameters
    {
        /// <summary>
        /// BedrockAgentEndpointParameters constructor
        /// </summary>
        public BedrockAgentEndpointParameters()
        {
            UseDualStack = false;
            UseFIPS = false;
        }
