...
namespace Amazon.BedrockAgent
{
    ...
    public partial class AmazonBedrockAgentClient : AmazonServiceClient, IAmazonBedrockAgent
    {
        ...
        /// 
        /// </summary>
        public AmazonBedrockAgentClient() : base(new AmazonBedrockAgentConfig()) { }
        ...
        public AmazonBedrockAgentClient(RegionEndpoint region) : base(new AmazonBedrockAgentConfig { RegionEndpoint = region }) { }
        ...
        public AmazonBedrockAgentClient(AmazonBedrockAgentConfig config) : base(config) { }
