...
{
    /// <summary>
    /// Container for the parameters to the GetPrompt operation. Retrieves information about
    /// the working draft (<c>DRAFT</c> version) of a prompt or a version of it, depending
    /// on whether you include the <c>promptVersion</c> field or not. For more information,
