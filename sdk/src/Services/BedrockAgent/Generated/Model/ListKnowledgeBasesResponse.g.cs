...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class ListKnowledgeBasesResponse : AmazonWebServiceResponse
    {
        ...
        public List<KnowledgeBaseSummary> KnowledgeBaseSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<KnowledgeBaseSummary>() : null;

        /// <summary>
        /// Checks to see if the KnowledgeBaseSummaries property is set.
        /// </summary>
        internal bool IsSetKnowledgeBaseSummaries() => this.KnowledgeBaseSummaries != null && (this.KnowledgeBaseSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
