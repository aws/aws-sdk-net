...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class AssociateAgentKnowledgeBaseResponse : AmazonWebServiceResponse
    {
        ...
        public AgentKnowledgeBase AgentKnowledgeBase { get; set; }

        /// <summary>
        /// Checks to see if the AgentKnowledgeBase property is set.
        /// </summary>
        internal bool IsSetAgentKnowledgeBase() => this.AgentKnowledgeBase != null;
    }
}
