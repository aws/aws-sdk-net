...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class RedshiftConfiguration
    {
        ...
        public RedshiftQueryEngineConfiguration QueryEngineConfiguration { get; set; }

        /// <summary>
        /// Checks to see if the QueryEngineConfiguration property is set.
        /// </summary>
        internal bool IsSetQueryEngineConfiguration() => this.QueryEngineConfiguration != null;
        ...
        /// </para>
        /// </summary>
        public QueryGenerationConfiguration QueryGenerationConfiguration { get; set; }

        /// <summary>
        /// Checks to see if the QueryGenerationConfiguration property is set.
        /// </summary>
        internal bool IsSetQueryGenerationConfiguration() => this.QueryGenerationConfiguration != null;
        ...
        public List<RedshiftQueryEngineStorageConfiguration> StorageConfigurations { get; set; } = AWSConfigs.InitializeCollections ? new List<RedshiftQueryEngineStorageConfiguration>() : null;
