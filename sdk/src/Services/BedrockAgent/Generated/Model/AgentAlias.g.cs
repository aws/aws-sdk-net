...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class AgentAlias
    {
        ...
        /// </summary>
        [AWSProperty(Max = 10)]
        public List<AgentAliasHistoryEvent> AgentAliasHistoryEvents { get; set; } = AWSConfigs.InitializeCollections ? new List<AgentAliasHistoryEvent>() : null;

        /// <summary>
        /// Checks to see if the AgentAliasHistoryEvents property is set.
        /// </summary>
        internal bool IsSetAgentAliasHistoryEvents() => this.AgentAliasHistoryEvents != null && (this.AgentAliasHistoryEvents.Count > 0 || !AWSConfigs.InitializeCollections);
