...
{
    /// <summary>
    /// Container for the parameters to the DeleteAgentActionGroup operation. Deletes an action
    /// group in an agent.
    /// </summary>
    public partial class DeleteAgentActionGroupRequest : AmazonBedrockAgentRequest
    {
        ...
        /// <summary>
        /// Checks to see if the SkipResourceInUseCheck property is set.
        /// </summary>
        internal bool IsSetSkipResourceInUseCheck() => this.SkipResourceInUseCheck.HasValue;
    }
}
