...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class CustomTransformationConfiguration
    {
        ...
        public IntermediateStorage IntermediateStorage { get; set; }

        /// <summary>
        /// Checks to see if the IntermediateStorage property is set.
        /// </summary>
        internal bool IsSetIntermediateStorage() => this.IntermediateStorage != null;
        ...
        public List<Transformation> Transformations { get; set; } = AWSConfigs.InitializeCollections ? new List<Transformation>() : null;

        /// <summary>
        /// Checks to see if the Transformations property is set.
        /// </summary>
        internal bool IsSetTransformations() => this.Transformations != null && (this.Transformations.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
