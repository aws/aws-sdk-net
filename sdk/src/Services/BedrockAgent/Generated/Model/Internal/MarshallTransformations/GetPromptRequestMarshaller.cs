...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetPromptRequestMarshaller : IMarshaller<IRequest, GetPromptRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetPromptRequestMarshaller _instance = new GetPromptRequestMarshaller();        

        internal static GetPromptRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPromptRequestMarshaller Instance
        {
            get
            {
                return _instance;
