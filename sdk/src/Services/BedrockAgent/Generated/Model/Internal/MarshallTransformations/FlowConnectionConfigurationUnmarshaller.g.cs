...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FlowConnectionConfigurationUnmarshaller : IJsonUnmarshaller<FlowConnectionConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public FlowConnectionConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new FlowConnectionConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static FlowConnectionConfigurationUnmarshaller Instance => _instance;
    }
}
