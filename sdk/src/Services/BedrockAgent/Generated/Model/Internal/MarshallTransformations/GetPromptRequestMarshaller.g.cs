...
{
    /// <summary>
    /// GetPrompt Request Marshaller
    /// </summary>
    public partial class GetPromptRequestMarshaller : IMarshaller<IRequest, GetPromptRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetPromptRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(GetPromptRequest publicRequest)
        {
        ...
        private static readonly GetPromptRequestMarshaller _instance = new();

        internal static GetPromptRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetPromptRequestMarshaller Instance => _instance;
    }
}
