...
{
    /// <summary>
    /// CreatePrompt Request Marshaller
    /// </summary>       
    public class CreatePromptRequestMarshaller : IMarshaller<IRequest, CreatePromptRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreatePromptRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreatePromptRequest publicRequest)
        {
        ...
        private static CreatePromptRequestMarshaller _instance = new CreatePromptRequestMarshaller();        

        internal static CreatePromptRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePromptRequestMarshaller Instance
        {
            get
            {
                return _instance;
