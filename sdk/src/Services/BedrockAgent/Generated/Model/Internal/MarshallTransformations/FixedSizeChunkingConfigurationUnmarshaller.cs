...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FixedSizeChunkingConfigurationUnmarshaller : IJsonUnmarshaller<FixedSizeChunkingConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public FixedSizeChunkingConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("overlapPercentage", targetDepth, ref reader))
                {
                    var unmarshaller = NullableIntUnmarshaller.Instance;
                    unmarshalledObject.OverlapPercentage = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
