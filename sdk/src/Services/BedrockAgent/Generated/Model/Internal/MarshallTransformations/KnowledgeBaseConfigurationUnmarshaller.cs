...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class KnowledgeBaseConfigurationUnmarshaller : IUnmarshaller<KnowledgeBaseConfiguration, XmlUnmarshallerContext>, IUnmarshaller<KnowledgeBaseConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        KnowledgeBaseConfiguration IUnmarshaller<KnowledgeBaseConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public KnowledgeBaseConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("vectorKnowledgeBaseConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.VectorKnowledgeBaseConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
