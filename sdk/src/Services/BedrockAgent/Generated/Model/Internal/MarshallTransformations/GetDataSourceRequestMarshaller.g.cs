...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class GetDataSourceRequestMarshaller : IMarshaller<IRequest, GetDataSourceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly GetDataSourceRequestMarshaller _instance = new();

        internal static GetDataSourceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static GetDataSourceRequestMarshaller Instance => _instance;
    }
}
