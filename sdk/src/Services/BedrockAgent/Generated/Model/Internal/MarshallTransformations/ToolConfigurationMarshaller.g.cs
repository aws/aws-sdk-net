...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ToolConfigurationMarshaller : IRequestMarshaller<ToolConfiguration, JsonMarshallerContext>
    {
        /// <summary>
        ...
        public void Marshall(ToolConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetToolChoice())
            {
                context.Writer.WritePropertyName("toolChoice");
                context.Writer.WriteStartObject();

                var marshaller = ToolChoiceMarshaller.Instance;
                marshaller.Marshall(requestObject.ToolChoice, context);
