...
{
    /// <summary>
    /// DeleteAgentActionGroup Request Marshaller
    /// </summary>
    public partial class DeleteAgentActionGroupRequestMarshaller : IMarshaller<IRequest, DeleteAgentActionGroupRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteAgentActionGroupRequest)input);
        }

        /// <summary>
        /// Marshall the request object to the HTTP request.
        /// </summary>
        public IRequest Marshall(DeleteAgentActionGroupRequest publicRequest)
        {
        ...
        private static readonly DeleteAgentActionGroupRequestMarshaller _instance = new();

        internal static DeleteAgentActionGroupRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteAgentActionGroupRequestMarshaller Instance => _instance;
    }
}
