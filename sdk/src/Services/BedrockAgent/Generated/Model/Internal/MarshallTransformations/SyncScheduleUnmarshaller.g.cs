...
{
    /// <summary>
    /// Response Unmarshaller for SyncSchedule Object
    /// </summary>
    public partial class SyncScheduleUnmarshaller : IJsonUnmarshaller<SyncSchedule, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public SyncSchedule Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new SyncSchedule();
        ...
        private static SyncScheduleUnmarshaller _instance = new SyncScheduleUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static SyncScheduleUnmarshaller Instance => _instance;
    }
}
