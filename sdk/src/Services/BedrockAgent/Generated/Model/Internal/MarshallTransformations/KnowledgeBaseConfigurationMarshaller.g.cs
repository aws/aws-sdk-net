...
{
    /// <summary>
    /// KnowledgeBaseConfiguration Marshaller
    /// </summary>
    public partial class KnowledgeBaseConfigurationMarshaller : IRequestMarshaller<KnowledgeBaseConfiguration, JsonMarshallerContext>
    {
        /// <summary>
        /// Marshall the structure from the request object to the service
        /// </summary>
        public void Marshall(KnowledgeBaseConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if (requestObject.IsSetManagedKnowledgeBaseConfiguration())
            {
                context.Writer.WritePropertyName("managedKnowledgeBaseConfiguration");
                context.Writer.WriteStartObject();

                var marshaller = ManagedKnowledgeBaseConfigurationMarshaller.Instance;
                marshaller.Marshall(requestObject.ManagedKnowledgeBaseConfiguration, context);
        ...
        /// </summary>
        public readonly static KnowledgeBaseConfigurationMarshaller Instance = new KnowledgeBaseConfigurationMarshaller();
    }
}
