...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class VectorIngestionConfigurationUnmarshaller : IJsonUnmarshaller<VectorIngestionConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new VectorIngestionConfiguration();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("contextEnrichmentConfiguration", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("customTransformationConfiguration", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static VectorIngestionConfigurationUnmarshaller Instance => _instance;
    }
}
