...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VectorSearchBedrockRerankingConfigurationUnmarshaller : IUnmarshaller<VectorSearchBedrockRerankingConfiguration, XmlUnmarshallerContext>, IUnmarshaller<VectorSearchBedrockRerankingConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        VectorSearchBedrockRerankingConfiguration IUnmarshaller<VectorSearchBedrockRerankingConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public VectorSearchBedrockRerankingConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("numberOfRerankedResults", targetDepth))
                {
                    ...
                    unmarshalledObject.NumberOfRerankedResults = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
