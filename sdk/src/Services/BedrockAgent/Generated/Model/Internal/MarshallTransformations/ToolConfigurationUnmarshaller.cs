...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ToolConfigurationUnmarshaller : IJsonUnmarshaller<ToolConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ToolConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("toolChoice", targetDepth, ref reader))
                {
                    var unmarshaller = ToolChoiceUnmarshaller.Instance;
                    unmarshalledObject.ToolChoice = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
