...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BedrockEmbeddingModelConfigurationUnmarshaller : IJsonUnmarshaller<BedrockEmbeddingModelConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new BedrockEmbeddingModelConfiguration();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("embeddingDataType", targetDepth, ref reader))
                {
        ...
        /// Gets the singleton.
        /// </summary>
        public static BedrockEmbeddingModelConfigurationUnmarshaller Instance => _instance;
    }
}
