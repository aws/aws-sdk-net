...
{
    /// <summary>
    /// Response Unmarshaller for IngestionJob Object
    /// </summary>
    public partial class IngestionJobUnmarshaller : IJsonUnmarshaller<IngestionJob, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public IngestionJob Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new IngestionJob();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ingestionJobId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.IngestionJobId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                {
                    var unmarshaller = IngestionJobStatisticsUnmarshaller.Instance;
        ...
        private static IngestionJobUnmarshaller _instance = new IngestionJobUnmarshaller();

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static IngestionJobUnmarshaller Instance => _instance;
    }
}
