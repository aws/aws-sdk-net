    ...
    public class FlowDefinitionUnmarshaller : IUnmarshaller<FlowDefinition, XmlUnmarshallerContext>, IUnmarshaller<FlowDefinition, JsonUnmarshallerContext>
    {
        ...
        public FlowDefinition Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<FlowConnection, FlowConnectionUnmarshaller>(FlowConnectionUnmarshaller.Instance);
                    unmarshalledObject.Connections = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("nodes", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<FlowNode, FlowNodeUnmarshaller>(FlowNodeUnmarshaller.Instance);
