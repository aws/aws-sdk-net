...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PerformanceConfigurationUnmarshaller : IJsonUnmarshaller<PerformanceConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public PerformanceConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("latency", targetDepth, ref reader))
                {
