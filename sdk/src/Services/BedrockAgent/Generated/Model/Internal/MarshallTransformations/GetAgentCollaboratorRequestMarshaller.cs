...
{
    /// <summary>
    /// GetAgentCollaborator Request Marshaller
    /// </summary>       
    public class GetAgentCollaboratorRequestMarshaller : IMarshaller<IRequest, GetAgentCollaboratorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAgentCollaboratorRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAgentCollaboratorRequest publicRequest)
        {
        ...
        private static GetAgentCollaboratorRequestMarshaller _instance = new GetAgentCollaboratorRequestMarshaller();        

        internal static GetAgentCollaboratorRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAgentCollaboratorRequestMarshaller Instance
        {
            get
            {
                return _instance;
