...
{
    /// <summary>
    /// CreateFlowAlias Request Marshaller
    /// </summary>       
    public class CreateFlowAliasRequestMarshaller : IMarshaller<IRequest, CreateFlowAliasRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateFlowAliasRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateFlowAliasRequest publicRequest)
        {
        ...
        private static CreateFlowAliasRequestMarshaller _instance = new CreateFlowAliasRequestMarshaller();        

        internal static CreateFlowAliasRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFlowAliasRequestMarshaller Instance
        {
            get
            {
                return _instance;
