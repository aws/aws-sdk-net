...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class FlowNodeUnmarshaller : IJsonUnmarshaller<FlowNode, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public FlowNode Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new FlowNode();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<FlowNodeInput, FlowNodeInputUnmarshaller>(FlowNodeInputUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = new JsonListUnmarshaller<FlowNodeOutput, FlowNodeOutputUnmarshaller>(FlowNodeOutputUnmarshaller.Instance);
        ...
        /// Gets the singleton.
        /// </summary>
        public static FlowNodeUnmarshaller Instance => _instance;
    }
}
