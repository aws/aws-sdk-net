...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OpenSearchServerlessConfigurationUnmarshaller : IUnmarshaller<OpenSearchServerlessConfiguration, XmlUnmarshallerContext>, IUnmarshaller<OpenSearchServerlessConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public OpenSearchServerlessConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("collectionArn", targetDepth))
                {
                    ...
                    unmarshalledObject.CollectionArn = unmarshaller.Unmarshall(context);
                    continue;
                }
