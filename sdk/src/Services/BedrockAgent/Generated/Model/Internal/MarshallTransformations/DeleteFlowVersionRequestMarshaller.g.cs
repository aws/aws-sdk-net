...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteFlowVersionRequestMarshaller : IMarshaller<IRequest, DeleteFlowVersionRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteFlowVersionRequestMarshaller _instance = new();

        internal static DeleteFlowVersionRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteFlowVersionRequestMarshaller Instance => _instance;
    }
}
