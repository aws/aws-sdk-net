...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteAgentRequestMarshaller : IMarshaller<IRequest, DeleteAgentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteAgentRequestMarshaller _instance = new DeleteAgentRequestMarshaller();        

        internal static DeleteAgentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAgentRequestMarshaller Instance
        {
            get
            {
                return _instance;
