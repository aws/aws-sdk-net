...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    public class OpenSearchManagedClusterConfigurationUnmarshaller : IJsonUnmarshaller<OpenSearchManagedClusterConfiguration, JsonUnmarshallerContext>
    {
        ...
        private static OpenSearchManagedClusterConfigurationUnmarshaller _instance = new OpenSearchManagedClusterConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static OpenSearchManagedClusterConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
