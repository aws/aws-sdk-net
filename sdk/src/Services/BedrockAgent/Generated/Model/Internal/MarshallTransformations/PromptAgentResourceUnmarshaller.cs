...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    public class PromptAgentResourceUnmarshaller : IJsonUnmarshaller<PromptAgentResource, JsonUnmarshallerContext>
    {
        ...
        public PromptAgentResource Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("agentIdentifier", targetDepth, ref reader))
                {
        ...
        private static PromptAgentResourceUnmarshaller _instance = new PromptAgentResourceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PromptAgentResourceUnmarshaller Instance
        {
            get
            {
                return _instance;
