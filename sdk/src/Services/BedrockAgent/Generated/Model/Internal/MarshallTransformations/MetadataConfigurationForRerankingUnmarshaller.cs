...
namespace Amazon.BedrockAgent.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MetadataConfigurationForRerankingUnmarshaller : IUnmarshaller<MetadataConfigurationForReranking, XmlUnmarshallerContext>, IUnmarshaller<MetadataConfigurationForReranking, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        MetadataConfigurationForReranking IUnmarshaller<MetadataConfigurationForReranking, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public MetadataConfigurationForReranking Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("selectiveModeConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.SelectiveModeConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
