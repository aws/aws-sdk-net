...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class ListAgentKnowledgeBasesResponse : AmazonWebServiceResponse
    {
        ...
        public List<AgentKnowledgeBaseSummary> AgentKnowledgeBaseSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<AgentKnowledgeBaseSummary>() : null;

        /// <summary>
        /// Checks to see if the AgentKnowledgeBaseSummaries property is set.
        /// </summary>
        internal bool IsSetAgentKnowledgeBaseSummaries() => this.AgentKnowledgeBaseSummaries != null && (this.AgentKnowledgeBaseSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
