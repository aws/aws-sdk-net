...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class S3DataSourceConfiguration
    {
        ...
        /// <summary>
        /// Checks to see if the BucketOwnerAccountId property is set.
        /// </summary>
        internal bool IsSetBucketOwnerAccountId() => this.BucketOwnerAccountId != null;
        ...
        public List<string> InclusionPrefixes { get; set; } = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Checks to see if the InclusionPrefixes property is set.
        /// </summary>
        internal bool IsSetInclusionPrefixes() => this.InclusionPrefixes != null && (this.InclusionPrefixes.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
