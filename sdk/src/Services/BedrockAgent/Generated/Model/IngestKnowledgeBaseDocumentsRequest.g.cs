...
{
    /// <summary>
    /// Container for the parameters to the IngestKnowledgeBaseDocuments operation. Ingests
    /// documents directly into the knowledge base that is connected to the data source. The
    /// <c>dataSourceType</c> specified in the content for each document must match the type
    /// of the data source that you specify in the header. For more information, see <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/kb-direct-ingestion.html">Ingest
    ...
    public partial class IngestKnowledgeBaseDocumentsRequest : AmazonBedrockAgentRequest
    {
        ...
        public List<KnowledgeBaseDocument> Documents { get; set; } = AWSConfigs.InitializeCollections ? new List<KnowledgeBaseDocument>() : null;
