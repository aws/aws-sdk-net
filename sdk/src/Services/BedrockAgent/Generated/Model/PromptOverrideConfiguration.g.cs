...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class PromptOverrideConfiguration
    {
        ...
        public List<PromptConfiguration> PromptConfigurations { get; set; } = AWSConfigs.InitializeCollections ? new List<PromptConfiguration>() : null;

        /// <summary>
        /// Checks to see if the PromptConfigurations property is set.
        /// </summary>
        internal bool IsSetPromptConfigurations() => this.PromptConfigurations != null && (this.PromptConfigurations.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
