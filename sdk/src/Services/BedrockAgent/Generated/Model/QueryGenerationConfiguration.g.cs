...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class QueryGenerationConfiguration
    {
        ...
        public QueryGenerationContext GenerationContext { get; set; }

        /// <summary>
        /// Checks to see if the GenerationContext property is set.
        /// </summary>
        internal bool IsSetGenerationContext() => this.GenerationContext != null;
    }
}
