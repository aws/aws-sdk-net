...
namespace Amazon.BedrockAgent.Model
{
    ...
    internal sealed partial class ListFlowsPaginator : IPaginator<ListFlowsResponse>, IListFlowsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<FlowSummary> FlowSummaries =>
            new PaginatedResultKeyResponse<ListFlowsResponse, FlowSummary>(this, (i) => i.FlowSummaries ?? new List<FlowSummary>());

        internal ListFlowsPaginator(IAmazonBedrockAgent client, ListFlowsRequest request)
        {
            this._client = client;
