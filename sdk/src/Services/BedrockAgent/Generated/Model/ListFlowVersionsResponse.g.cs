...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class ListFlowVersionsResponse : AmazonWebServiceResponse
    {
        ...
        public List<FlowVersionSummary> FlowVersionSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<FlowVersionSummary>() : null;

        /// <summary>
        /// Checks to see if the FlowVersionSummaries property is set.
        /// </summary>
        internal bool IsSetFlowVersionSummaries() => this.FlowVersionSummaries != null && (this.FlowVersionSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
