...
{
    /// <summary>
    /// Container for the parameters to the DeleteKnowledgeBaseDocuments operation. Deletes
    /// documents from a data source and syncs the changes to the knowledge base that is connected
    /// to it. For more information, see <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/kb-direct-ingestion.html">Ingest
