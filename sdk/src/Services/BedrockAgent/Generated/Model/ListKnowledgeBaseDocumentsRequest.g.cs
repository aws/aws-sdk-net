...
{
    /// <summary>
    /// Container for the parameters to the ListKnowledgeBaseDocuments operation. Retrieves
    /// all the documents contained in a data source that is connected to a knowledge base.
