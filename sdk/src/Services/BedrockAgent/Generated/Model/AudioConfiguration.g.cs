...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class AudioConfiguration
    {
        ...
        public AudioSegmentationConfiguration SegmentationConfiguration { get; set; }

        /// <summary>
        /// Checks to see if the SegmentationConfiguration property is set.
        /// </summary>
        internal bool IsSetSegmentationConfiguration() => this.SegmentationConfiguration != null;
    }
}
