...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class SupplementalDataStorageConfiguration
    {
        ...
        public List<SupplementalDataStorageLocation> StorageLocations { get; set; } = AWSConfigs.InitializeCollections ? new List<SupplementalDataStorageLocation>() : null;

        /// <summary>
        /// Checks to see if the StorageLocations property is set.
        /// </summary>
        internal bool IsSetStorageLocations() => this.StorageLocations != null && (this.StorageLocations.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
