...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class VideoSegmentationConfiguration
    {
        ...
        public int? FixedLengthDuration { get; set; }

        /// <summary>
        /// Checks to see if the FixedLengthDuration property is set.
        /// </summary>
        internal bool IsSetFixedLengthDuration() => this.FixedLengthDuration.HasValue;
    }
}
