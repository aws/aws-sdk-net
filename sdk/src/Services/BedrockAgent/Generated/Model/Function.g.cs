...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class Function
    {
        ...
        /// </summary>
        public Dictionary<string, ParameterDetail> Parameters { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, ParameterDetail>() : null;
        ...
        /// </para>
        /// </summary>
        public RequireConfirmation RequireConfirmation { get; set; }

        /// <summary>
        /// Checks to see if the RequireConfirmation property is set.
        /// </summary>
        internal bool IsSetRequireConfirmation() => this.RequireConfirmation != null;
    }
}
