...
{
    /// <summary>
    /// Container for the parameters to the CreatePromptVersion operation. Creates a static
    /// snapshot of your prompt that can be deployed to production. For more information,
    /// see <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/prompt-management-deploy.html">Deploy
