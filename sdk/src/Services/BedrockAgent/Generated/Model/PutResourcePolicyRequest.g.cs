...
{
    /// <summary>
    /// Container for the parameters to the PutResourcePolicy operation. Associates a resource
    /// policy with a knowledge base. A resource policy allows other AWS accounts to access
    /// the knowledge base. For more information, see <a href="https://docs.aws.amazon.com/bedrock/latest/userguide/kb-managed-cross-account.html">Cross-account
