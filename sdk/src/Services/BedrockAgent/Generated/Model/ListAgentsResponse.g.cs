...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class ListAgentsResponse : AmazonWebServiceResponse
    {
        ...
        public List<AgentSummary> AgentSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<AgentSummary>() : null;

        /// <summary>
        /// Checks to see if the AgentSummaries property is set.
        /// </summary>
        internal bool IsSetAgentSummaries() => this.AgentSummaries != null && (this.AgentSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
