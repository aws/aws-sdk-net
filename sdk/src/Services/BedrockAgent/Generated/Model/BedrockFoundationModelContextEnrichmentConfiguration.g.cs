...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class BedrockFoundationModelContextEnrichmentConfiguration
    {
        ...
        public EnrichmentStrategyConfiguration EnrichmentStrategyConfiguration { get; set; }

        /// <summary>
        /// Checks to see if the EnrichmentStrategyConfiguration property is set.
        /// </summary>
        internal bool IsSetEnrichmentStrategyConfiguration() => this.EnrichmentStrategyConfiguration != null;
