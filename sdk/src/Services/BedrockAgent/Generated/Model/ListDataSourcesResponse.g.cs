...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class ListDataSourcesResponse : AmazonWebServiceResponse
    {
        ...
        public List<DataSourceSummary> DataSourceSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<DataSourceSummary>() : null;

        /// <summary>
        /// Checks to see if the DataSourceSummaries property is set.
        /// </summary>
        internal bool IsSetDataSourceSummaries() => this.DataSourceSummaries != null && (this.DataSourceSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
