...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class ListFlowAliasesResponse : AmazonWebServiceResponse
    {
        ...
        public List<FlowAliasSummary> FlowAliasSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<FlowAliasSummary>() : null;

        /// <summary>
        /// Checks to see if the FlowAliasSummaries property is set.
        /// </summary>
        internal bool IsSetFlowAliasSummaries() => this.FlowAliasSummaries != null && (this.FlowAliasSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
