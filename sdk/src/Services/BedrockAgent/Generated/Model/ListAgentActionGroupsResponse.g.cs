...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class ListAgentActionGroupsResponse : AmazonWebServiceResponse
    {
        ...
        public List<ActionGroupSummary> ActionGroupSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<ActionGroupSummary>() : null;

        /// <summary>
        /// Checks to see if the ActionGroupSummaries property is set.
        /// </summary>
        internal bool IsSetActionGroupSummaries() => this.ActionGroupSummaries != null && (this.ActionGroupSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
