...
namespace Amazon.BedrockAgent.Model
{
    ...
    public partial class ListAgentAliasesResponse : AmazonWebServiceResponse
    {
        ...
        public List<AgentAliasSummary> AgentAliasSummaries { get; set; } = AWSConfigs.InitializeCollections ? new List<AgentAliasSummary>() : null;

        /// <summary>
        /// Checks to see if the AgentAliasSummaries property is set.
        /// </summary>
        internal bool IsSetAgentAliasSummaries() => this.AgentAliasSummaries != null && (this.AgentAliasSummaries.Count > 0 || !AWSConfigs.InitializeCollections);
