...
{
    /// <summary>
    /// DeploymentParameterInput Marshaller
    /// </summary>
    public class DeploymentParameterInputMarshaller : IRequestMarshaller<DeploymentParameterInput, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(DeploymentParameterInput requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetSecretString())
            {
                context.Writer.WritePropertyName("secretString");
                context.Writer.WriteStringValue(requestObject.SecretString);
            }
        ...
        /// </summary>
        public readonly static DeploymentParameterInputMarshaller Instance = new DeploymentParameterInputMarshaller();
