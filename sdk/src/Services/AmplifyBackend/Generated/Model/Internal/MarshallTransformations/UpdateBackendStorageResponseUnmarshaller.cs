...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBackendStorage operation
    /// </summary>  
    public class UpdateBackendStorageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBackendStorageResponse response = new UpdateBackendStorageResponse();
        ...
        private static UpdateBackendStorageResponseUnmarshaller _instance = new UpdateBackendStorageResponseUnmarshaller();        

        internal static UpdateBackendStorageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBackendStorageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
