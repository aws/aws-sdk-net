...
{
    /// <summary>
    /// Response Unmarshaller for RemoveBackendConfig operation
    /// </summary>  
    public class RemoveBackendConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveBackendConfigResponse response = new RemoveBackendConfigResponse();
        ...
        private static RemoveBackendConfigResponseUnmarshaller _instance = new RemoveBackendConfigResponseUnmarshaller();        

        internal static RemoveBackendConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveBackendConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
