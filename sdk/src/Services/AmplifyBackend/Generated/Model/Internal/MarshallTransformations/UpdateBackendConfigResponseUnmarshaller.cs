...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBackendConfig operation
    /// </summary>  
    public class UpdateBackendConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBackendConfigResponse response = new UpdateBackendConfigResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("backendManagerAppId", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.BackendManagerAppId = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("loginAuthConfig", targetDepth, ref reader))
                {
                    var unmarshaller = LoginAuthConfigReqObjUnmarshaller.Instance;
                    response.LoginAuthConfig = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static UpdateBackendConfigResponseUnmarshaller _instance = new UpdateBackendConfigResponseUnmarshaller();        

        internal static UpdateBackendConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBackendConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
