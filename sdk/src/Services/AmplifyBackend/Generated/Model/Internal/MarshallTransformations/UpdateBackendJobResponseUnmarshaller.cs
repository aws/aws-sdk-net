...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBackendJob operation
    /// </summary>  
    public class UpdateBackendJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBackendJobResponse response = new UpdateBackendJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("backendEnvironmentName", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
        ...
        private static UpdateBackendJobResponseUnmarshaller _instance = new UpdateBackendJobResponseUnmarshaller();        

        internal static UpdateBackendJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBackendJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
