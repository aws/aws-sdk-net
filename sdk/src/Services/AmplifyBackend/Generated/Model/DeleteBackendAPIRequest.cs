...
{
    /// <summary>
    /// Container for the parameters to the DeleteBackendAPI operation.
    /// Deletes an existing backend API resource.
    /// </summary>
    public partial class DeleteBackendAPIRequest : AmazonAmplifyBackendRequest
    {
        private string _appId;
        private string _backendEnvironmentName;
        private BackendAPIResourceConfig _resourceConfig;
