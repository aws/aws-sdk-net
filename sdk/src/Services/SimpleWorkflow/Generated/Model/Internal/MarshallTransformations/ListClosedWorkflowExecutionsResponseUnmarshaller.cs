...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListClosedWorkflowExecutionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            response.WorkflowExecutionInfos = WorkflowExecutionInfosUnmarshaller.Instance.Unmarshall(context, ref reader);
        ...
        private static ListClosedWorkflowExecutionsResponseUnmarshaller _instance = new ListClosedWorkflowExecutionsResponseUnmarshaller();        

        internal static ListClosedWorkflowExecutionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListClosedWorkflowExecutionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
