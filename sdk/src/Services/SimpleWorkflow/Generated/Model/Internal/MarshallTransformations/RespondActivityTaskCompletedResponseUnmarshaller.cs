...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RespondActivityTaskCompletedResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static RespondActivityTaskCompletedResponseUnmarshaller _instance = new RespondActivityTaskCompletedResponseUnmarshaller();        

        internal static RespondActivityTaskCompletedResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RespondActivityTaskCompletedResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
