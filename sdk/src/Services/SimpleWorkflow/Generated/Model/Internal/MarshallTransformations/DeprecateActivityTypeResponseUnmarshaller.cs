...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeprecateActivityTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            if (errorResponse.Code != null && errorResponse.Code.Equals("TypeDeprecatedFault"))
            {
                return new TypeDeprecatedException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static DeprecateActivityTypeResponseUnmarshaller _instance = new DeprecateActivityTypeResponseUnmarshaller();        

        internal static DeprecateActivityTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        public static DeprecateActivityTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
