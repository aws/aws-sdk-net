...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    public class CountPendingDecisionTasksRequestMarshaller : IMarshaller<IRequest, CountPendingDecisionTasksRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        private static CountPendingDecisionTasksRequestMarshaller _instance = new CountPendingDecisionTasksRequestMarshaller();        

        internal static CountPendingDecisionTasksRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CountPendingDecisionTasksRequestMarshaller Instance
        {
            get
            {
                return _instance;
