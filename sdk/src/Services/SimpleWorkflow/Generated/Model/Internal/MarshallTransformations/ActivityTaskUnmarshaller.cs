...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ActivityTaskUnmarshaller : IJsonUnmarshaller<ActivityTask, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ActivityTask Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("activityId", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("taskToken", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
