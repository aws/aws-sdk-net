...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ChildWorkflowExecutionTimedOutEventAttributesUnmarshaller : IJsonUnmarshaller<ChildWorkflowExecutionTimedOutEventAttributes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public ChildWorkflowExecutionTimedOutEventAttributes Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
        ...
        private static ChildWorkflowExecutionTimedOutEventAttributesUnmarshaller _instance = new ChildWorkflowExecutionTimedOutEventAttributesUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ChildWorkflowExecutionTimedOutEventAttributesUnmarshaller Instance
        {
            get
            {
                return _instance;
