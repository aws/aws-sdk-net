...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RequestCancelWorkflowExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static RequestCancelWorkflowExecutionResponseUnmarshaller _instance = new RequestCancelWorkflowExecutionResponseUnmarshaller();        

        internal static RequestCancelWorkflowExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RequestCancelWorkflowExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
