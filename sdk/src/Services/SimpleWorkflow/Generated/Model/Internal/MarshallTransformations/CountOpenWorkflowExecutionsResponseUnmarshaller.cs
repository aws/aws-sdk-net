...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CountOpenWorkflowExecutionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            response.WorkflowExecutionCount = WorkflowExecutionCountUnmarshaller.Instance.Unmarshall(context, ref reader);
        ...
        private static CountOpenWorkflowExecutionsResponseUnmarshaller _instance = new CountOpenWorkflowExecutionsResponseUnmarshaller();        

        internal static CountOpenWorkflowExecutionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CountOpenWorkflowExecutionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
