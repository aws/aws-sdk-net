...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CountPendingActivityTasksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            response.PendingTaskCount = PendingTaskCountUnmarshaller.Instance.Unmarshall(context, ref reader);
        ...
        private static CountPendingActivityTasksResponseUnmarshaller _instance = new CountPendingActivityTasksResponseUnmarshaller();        

        internal static CountPendingActivityTasksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CountPendingActivityTasksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
