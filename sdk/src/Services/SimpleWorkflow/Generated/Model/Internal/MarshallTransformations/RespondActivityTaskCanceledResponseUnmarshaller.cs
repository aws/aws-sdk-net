...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RespondActivityTaskCanceledResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RespondActivityTaskCanceledResponse response = new RespondActivityTaskCanceledResponse();
        ...
        private static RespondActivityTaskCanceledResponseUnmarshaller _instance = new RespondActivityTaskCanceledResponseUnmarshaller();        

        internal static RespondActivityTaskCanceledResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RespondActivityTaskCanceledResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
