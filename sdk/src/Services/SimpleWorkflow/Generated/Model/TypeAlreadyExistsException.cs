...
namespace Amazon.SimpleWorkflow.Model
{
    ...
    public class TypeAlreadyExistsException : AmazonSimpleWorkflowException 
    {
        ...
        public TypeAlreadyExistsException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
