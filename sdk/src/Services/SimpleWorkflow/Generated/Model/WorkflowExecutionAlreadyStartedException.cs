...
namespace Amazon.SimpleWorkflow.Model
{
    ...
    public partial class WorkflowExecutionAlreadyStartedException : AmazonSimpleWorkflowException
    {
        ...
        public WorkflowExecutionAlreadyStartedException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public WorkflowExecutionAlreadyStartedException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
