...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RoutingInformationNextHopUnmarshaller : IJsonUnmarshaller<RoutingInformationNextHop, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public RoutingInformationNextHop Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("CoreNetworkAttachmentId", targetDepth, ref reader))
                {
