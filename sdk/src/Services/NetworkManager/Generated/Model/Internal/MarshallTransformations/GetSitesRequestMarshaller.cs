...
{
    /// <summary>
    /// GetSites Request Marshaller
    /// </summary>       
    public class GetSitesRequestMarshaller : IMarshaller<IRequest, GetSitesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSitesRequest)input);
        }
        ...
        private static GetSitesRequestMarshaller _instance = new GetSitesRequestMarshaller();        

        internal static GetSitesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSitesRequestMarshaller Instance
        {
            get
            {
                return _instance;
