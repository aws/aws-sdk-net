...
{
    /// <summary>
    /// CreateConnectAttachment Request Marshaller
    /// </summary>       
    public class CreateConnectAttachmentRequestMarshaller : IMarshaller<IRequest, CreateConnectAttachmentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateConnectAttachmentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateConnectAttachmentRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetTransportAttachmentId())
            {
                ...
                context.Writer.WriteStringValue(publicRequest.TransportAttachmentId);
            }
        ...
        private static CreateConnectAttachmentRequestMarshaller _instance = new CreateConnectAttachmentRequestMarshaller();        

        internal static CreateConnectAttachmentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateConnectAttachmentRequestMarshaller Instance
        {
            get
            {
                return _instance;
