...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateCoreNetworkPrefixListAssociationRequestMarshaller : IMarshaller<IRequest, CreateCoreNetworkPrefixListAssociationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CreateCoreNetworkPrefixListAssociationRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetPrefixListAlias())
                {
                    ...
                    context.Writer.Write(publicRequest.PrefixListAlias);
                }

                if(publicRequest.IsSetPrefixListArn())
                {
                    context.Writer.WritePropertyName("PrefixListArn");
                    context.Writer.Write(publicRequest.PrefixListArn);
                }
        ...
        private static CreateCoreNetworkPrefixListAssociationRequestMarshaller _instance = new CreateCoreNetworkPrefixListAssociationRequestMarshaller();        

        internal static CreateCoreNetworkPrefixListAssociationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCoreNetworkPrefixListAssociationRequestMarshaller Instance
        {
            get
            {
                return _instance;
