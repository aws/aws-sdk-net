...
{
    /// <summary>
    /// Response Unmarshaller for AssociateConnectPeer operation
    /// </summary>  
    public class AssociateConnectPeerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateConnectPeerResponse response = new AssociateConnectPeerResponse();
        ...
        private static AssociateConnectPeerResponseUnmarshaller _instance = new AssociateConnectPeerResponseUnmarshaller();        

        internal static AssociateConnectPeerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateConnectPeerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
