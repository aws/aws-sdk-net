...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    public class PrefixListAssociationUnmarshaller : IUnmarshaller<PrefixListAssociation, XmlUnmarshallerContext>, IUnmarshaller<PrefixListAssociation, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        PrefixListAssociation IUnmarshaller<PrefixListAssociation, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public PrefixListAssociation Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PrefixListAlias = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("PrefixListArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PrefixListArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
