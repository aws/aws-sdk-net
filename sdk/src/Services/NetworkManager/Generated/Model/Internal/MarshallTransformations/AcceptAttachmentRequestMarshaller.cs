...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AcceptAttachmentRequestMarshaller : IMarshaller<IRequest, AcceptAttachmentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static AcceptAttachmentRequestMarshaller _instance = new AcceptAttachmentRequestMarshaller();        

        internal static AcceptAttachmentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptAttachmentRequestMarshaller Instance
        {
            get
            {
                return _instance;
