...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class OrganizationStatusUnmarshaller : IUnmarshaller<OrganizationStatus, XmlUnmarshallerContext>, IUnmarshaller<OrganizationStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        OrganizationStatus IUnmarshaller<OrganizationStatus, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public OrganizationStatus Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AccountStatus, AccountStatusUnmarshaller>(AccountStatusUnmarshaller.Instance);
                    unmarshalledObject.AccountStatusList = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("OrganizationAwsServiceAccessStatus", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OrganizationAwsServiceAccessStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
