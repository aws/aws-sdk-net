...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PeeringUnmarshaller : IUnmarshaller<Peering, XmlUnmarshallerContext>, IUnmarshaller<Peering, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        Peering IUnmarshaller<Peering, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public Peering Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PeeringType = unmarshaller.Unmarshall(context);
                    continue;
                }
