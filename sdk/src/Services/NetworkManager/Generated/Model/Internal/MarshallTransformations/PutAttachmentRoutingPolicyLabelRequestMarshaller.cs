...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PutAttachmentRoutingPolicyLabelRequestMarshaller : IMarshaller<IRequest, PutAttachmentRoutingPolicyLabelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static PutAttachmentRoutingPolicyLabelRequestMarshaller _instance = new PutAttachmentRoutingPolicyLabelRequestMarshaller();        

        internal static PutAttachmentRoutingPolicyLabelRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAttachmentRoutingPolicyLabelRequestMarshaller Instance
        {
            get
            {
                return _instance;
