...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CoreNetworkChangeEventUnmarshaller : IJsonUnmarshaller<CoreNetworkChangeEvent, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public CoreNetworkChangeEvent Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("IdentifierPath", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
