...
namespace Amazon.NetworkManager.Model
{
    ...
    /// </summary>
    public partial class RoutingPolicyAssociationDetail
    {
        private List<string> _routingPolicyNames = AWSConfigs.InitializeCollections ? new List<string>() : null;
        private List<string> _sharedSegments = AWSConfigs.InitializeCollections ? new List<string>() : null;

        /// <summary>
        /// Gets and sets the property RoutingPolicyNames. 
        /// <para>
        ...
        {
            get { return this._routingPolicyNames; }
            set { this._routingPolicyNames = value; }
        }

        // Check to see if RoutingPolicyNames property is set
        internal bool IsSetRoutingPolicyNames()
        {
            return this._routingPolicyNames != null && (this._routingPolicyNames.Count > 0 || !AWSConfigs.InitializeCollections); 
        }
