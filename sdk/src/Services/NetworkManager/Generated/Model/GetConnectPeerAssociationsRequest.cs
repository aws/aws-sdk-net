...
{
    /// <summary>
    /// Container for the parameters to the GetConnectPeerAssociations operation.
    ...
    public partial class GetConnectPeerAssociationsRequest : AmazonNetworkManagerRequest
    {
        ...
        /// <summary>
        /// Gets and sets the property ConnectPeerIds. 
        /// <para>
        ...
        /// </summary>
        public List<string> ConnectPeerIds
        {
            get { return this._connectPeerIds; }
            set { this._connectPeerIds = value; }
        }
