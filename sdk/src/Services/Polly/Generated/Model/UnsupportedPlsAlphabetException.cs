...
namespace Amazon.Polly.Model
{
    ...
    public partial class UnsupportedPlsAlphabetException : AmazonPollyException
    {
        ...
        public UnsupportedPlsAlphabetException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnsupportedPlsAlphabetException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
