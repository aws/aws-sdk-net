...
namespace Amazon.Polly.Model
{
    ...
    /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Naming", "CA1710:Identifiers should have correct suffix", Justification = "StartSpeechSynthesisStreamEventStreamCollection is not descriptive")]
    ...
    public sealed class StartSpeechSynthesisStreamEventStream : EnumerableEventOutputStream<IEventStreamEvent, PollyEventStreamException>
    {
        /// <summary>
        ...
        /// </summary>
        protected override IDictionary<string,Func<IEventStreamMessage,PollyEventStreamException>> ExceptionMapping {get;} =
        new Dictionary<string,Func<IEventStreamMessage,PollyEventStreamException>>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        /// </summary>
        public override event EventHandler<EventStreamExceptionReceivedArgs<PollyEventStreamException>> ExceptionReceived;
        /// <summary>
        ...
        ///<summary>
        ///Raised when an AudioEvent event is received
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<AudioEvent>> AudioEventReceived;
        ///<summary>
        ///Raised when an StreamClosedEvent event is received
        ///</summary>
        public event EventHandler<EventStreamEventReceivedArgs<StreamClosedEvent>> StreamClosedEventReceived;

        /// <summary>
        /// Construct an instance
        /// </summary>
        /// <param name="stream"></param>        
        public StartSpeechSynthesisStreamEventStream(Stream stream) : this (stream, null)
        {
        }
        ...
        public StartSpeechSynthesisStreamEventStream(Stream stream, IEventStreamDecoder eventStreamDecoder) : base(stream, eventStreamDecoder)
        {
            ...
            Decoder.MessageReceived += (sender, args) =>
            {
                ...
                var _ =
                    ...
                    RaiseEvent(AudioEventReceived,ev) ||
                    RaiseEvent(StreamClosedEventReceived,ev);
            };       
        }
