...
{
    /// <summary>
    /// Response Unmarshaller for StartSpeechSynthesisStream operation
    /// </summary>  
    public class StartSpeechSynthesisStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartSpeechSynthesisStreamResponse response = new StartSpeechSynthesisStreamResponse();
            response.EventStream = new StartSpeechSynthesisStreamEventStream(context.Stream);
        ...
        private static StartSpeechSynthesisStreamResponseUnmarshaller _instance = new StartSpeechSynthesisStreamResponseUnmarshaller();        

        internal static StartSpeechSynthesisStreamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSpeechSynthesisStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
