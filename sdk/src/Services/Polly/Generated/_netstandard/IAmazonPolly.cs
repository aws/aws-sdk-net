...
namespace Amazon.Polly
{
    ...
    public partial interface IAmazonPolly : IAmazonService, IDisposable
    {
        ...
        Task<GetSpeechSynthesisTaskResponse> GetSpeechSynthesisTaskAsync(GetSpeechSynthesisTaskRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<ListSpeechSynthesisTasksResponse> ListSpeechSynthesisTasksAsync(ListSpeechSynthesisTasksRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartSpeechSynthesisStreamResponse> StartSpeechSynthesisStreamAsync(StartSpeechSynthesisStreamRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StartSpeechSynthesisTaskResponse> StartSpeechSynthesisTaskAsync(StartSpeechSynthesisTaskRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonPollyConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonPollyConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonPollyConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonPollyConfig to create AmazonPollyClient");
            }

            return awsCredentials == null ? 
                    new AmazonPollyClient(serviceClientConfig) :
                    new AmazonPollyClient(awsCredentials, serviceClientConfig);
        }
