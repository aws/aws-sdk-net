...
#elif NET6_0
[assembly: AssemblyDescription("The Amazon Web Services SDK for .NET (6.0) - Amazon SimpleDB. Amazon SimpleDB is a highly available, scalable, and flexible non-relational data store that enables you to store and query data items using web services requests.")]
#else
