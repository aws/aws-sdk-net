...
namespace Amazon.SimpleDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TooManyRequestedAttributesExceptionUnmarshaller : IErrorResponseUnmarshaller<TooManyRequestedAttributesException, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public TooManyRequestedAttributesException Unmarshall(XmlUnmarshallerContext context, ErrorResponse errorResponse)
        {
