...
namespace Amazon.SimpleDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteAttributesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return AttributeDoesNotExistExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static DeleteAttributesResponseUnmarshaller _instance = new DeleteAttributesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAttributesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
