...
namespace Amazon.SimpleDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListDomainsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListDomainsResponseUnmarshaller _instance = new ListDomainsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDomainsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
