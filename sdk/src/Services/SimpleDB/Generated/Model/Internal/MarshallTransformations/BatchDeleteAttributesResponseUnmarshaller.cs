...
namespace Amazon.SimpleDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchDeleteAttributesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static BatchDeleteAttributesResponseUnmarshaller _instance = new BatchDeleteAttributesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeleteAttributesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
