...
#pragma warning disable CA1033
        /// <inheritdoc/>
        [System.Diagnostics.CodeAnalysis.DynamicDependency(System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.PublicProperties, typeof(AmazonSimpleDBConfig))]
        static ClientConfig IAmazonService.CreateDefaultClientConfig() => new AmazonSimpleDBConfig();
    ...
    Justification = "This suppression is here to ignore the warnings caused by CognitoSync. See justification in IAmazonService.")]
        ...
        {
            var serviceClientConfig = clientConfig as AmazonSimpleDBConfig;
            if (serviceClientConfig == null)
            {
                throw new AmazonClientException("ClientConfig is not of type AmazonSimpleDBConfig to create AmazonSimpleDBClient");
            }

            return awsCredentials == null ? 
                    new AmazonSimpleDBClient(serviceClientConfig) :
                    new AmazonSimpleDBClient(awsCredentials, serviceClientConfig);
        }
