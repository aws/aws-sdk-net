...
namespace Amazon.ApplicationInsights.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TagsAlreadyExistExceptionUnmarshaller : ICborErrorResponseUnmarshaller<TagsAlreadyExistException, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public TagsAlreadyExistException Unmarshall(CborUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public TagsAlreadyExistException Unmarshall(CborUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse)
        {
            ...
            context.AddPathSegment("TagsAlreadyExistException");
            reader.ReadStartMap();
