...
namespace Amazon.ApplicationInsights.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListComponentsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListComponents");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ApplicationComponentList":
                        {
                            context.AddPathSegment("ApplicationComponentList");
                            var unmarshaller = new CborListUnmarshaller<ApplicationComponent, ApplicationComponentUnmarshaller>(ApplicationComponentUnmarshaller.Instance);
