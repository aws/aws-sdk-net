    ...
    public class ListProblemsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("ProblemList", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<Problem, ProblemUnmarshaller>(ProblemUnmarshaller.Instance);
                    response.ProblemList = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
