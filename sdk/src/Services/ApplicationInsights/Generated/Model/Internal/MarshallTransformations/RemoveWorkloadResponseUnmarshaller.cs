...
{
    /// <summary>
    /// Response Unmarshaller for RemoveWorkload operation
    /// </summary>  
    public class RemoveWorkloadResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveWorkloadResponse response = new RemoveWorkloadResponse();
            var reader = context.Reader;
            context.AddPathSegment("RemoveWorkload");
        ...
        private static RemoveWorkloadResponseUnmarshaller _instance = new RemoveWorkloadResponseUnmarshaller();        

        internal static RemoveWorkloadResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveWorkloadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
