...
namespace Amazon.ApplicationInsights.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RelatedObservationsUnmarshaller : ICborUnmarshaller<RelatedObservations, CborUnmarshallerContext>
    {
        /// <summary>
        ...
        public RelatedObservations Unmarshall(CborUnmarshallerContext context)
        {
            ...
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ObservationList":
                        {
                            context.AddPathSegment("ObservationList");
                            var unmarshaller = new CborListUnmarshaller<Observation, ObservationUnmarshaller>(ObservationUnmarshaller.Instance);
