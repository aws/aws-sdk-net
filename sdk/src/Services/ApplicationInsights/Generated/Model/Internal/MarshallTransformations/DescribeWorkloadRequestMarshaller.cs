...
namespace Amazon.ApplicationInsights.Model.Internal.MarshallTransformations
{
    ...
    public class DescribeWorkloadRequestMarshaller : IMarshaller<IRequest, DescribeWorkloadRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeWorkloadRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/EC2WindowsBarleyService/operation/DescribeWorkload";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("WorkloadId");
                    context.Writer.WriteTextString(publicRequest.WorkloadId);
                }
                writer.WriteEndMap();
#if !NETFRAMEWORK
