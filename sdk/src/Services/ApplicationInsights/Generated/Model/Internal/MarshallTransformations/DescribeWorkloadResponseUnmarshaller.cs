...
namespace Amazon.ApplicationInsights.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeWorkloadResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("DescribeWorkload");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "WorkloadConfiguration":
                        {
                            context.AddPathSegment("WorkloadConfiguration");
                            var unmarshaller = WorkloadConfigurationUnmarshaller.Instance;
                            response.WorkloadConfiguration = unmarshaller.Unmarshall(context);
                    ...
                    case "WorkloadRemarks":
                        {
                            ...
                            var unmarshaller = CborStringUnmarshaller.Instance;
                            response.WorkloadRemarks = unmarshaller.Unmarshall(context);
                            context.PopPathSegment();
                            break;
                        }
                    default:
