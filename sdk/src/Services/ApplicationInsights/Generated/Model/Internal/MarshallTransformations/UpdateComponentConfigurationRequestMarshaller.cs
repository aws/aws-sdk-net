...
namespace Amazon.ApplicationInsights.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateComponentConfigurationRequestMarshaller : IMarshaller<IRequest, UpdateComponentConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateComponentConfigurationRequest publicRequest)
        {
            ...
            request.ResourcePath = "service/EC2WindowsBarleyService/operation/UpdateComponentConfiguration";
            ...
            try
            {
                ...
                {
                    context.Writer.WriteTextString("ComponentConfiguration");
                    context.Writer.WriteTextString(publicRequest.ComponentConfiguration);
                }
                ...
                {
                    context.Writer.WriteTextString("Monitor");
                    context.Writer.WriteBoolean(publicRequest.Monitor.Value);
                }
                ...
                if (publicRequest.IsSetTier())
                {
                    ...
                    context.Writer.WriteTextString(publicRequest.Tier);
                }
                writer.WriteEndMap();
#if !NETFRAMEWORK
