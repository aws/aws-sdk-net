...
namespace Amazon.ApplicationInsights.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListLogPatternsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListLogPatterns");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "LogPatterns":
                        {
                            context.AddPathSegment("LogPatterns");
                            var unmarshaller = new CborListUnmarshaller<LogPattern, LogPatternUnmarshaller>(LogPatternUnmarshaller.Instance);
