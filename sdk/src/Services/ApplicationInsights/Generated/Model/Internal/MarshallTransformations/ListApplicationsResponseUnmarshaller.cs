...
namespace Amazon.ApplicationInsights.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListApplicationsResponseUnmarshaller : CborResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(CborUnmarshallerContext context)
        {
            ...
            context.AddPathSegment("ListApplications");
            reader.ReadStartMap();
            while (reader.PeekState() != CborReaderState.EndMap)
            {
                ...
                switch (propertyName)
                {
                    case "ApplicationInfoList":
                        {
                            context.AddPathSegment("ApplicationInfoList");
                            var unmarshaller = new CborListUnmarshaller<ApplicationInfo, ApplicationInfoUnmarshaller>(ApplicationInfoUnmarshaller.Instance);
