...
namespace Amazon.CloudHSM.Model
{
    ...
    public partial class CloudHsmInternalException : AmazonCloudHSMException
    {
        ...
        public CloudHsmInternalException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public CloudHsmInternalException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
