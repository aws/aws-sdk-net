...
namespace Amazon.CloudHSM.Internal
{
    ...
    public class AmazonCloudHSMAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonCloudHSMAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for CloudHSM.
        /// </summary>
        public AmazonCloudHSMAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc/>
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonCloudHSMAuthSchemeParameters
            {
    ...
    public class AmazonCloudHSMAuthSchemeResolver : IAuthSchemeResolver<AmazonCloudHSMAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonCloudHSMAuthSchemeParameters authParameters)
        {
