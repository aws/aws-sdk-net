...
namespace Amazon.ChimeSDKIdentity
{
    ...
    public partial class AmazonChimeSDKIdentityConfig : ClientConfig
    {
        private static readonly string UserAgentString =
            InternalSDKUtils.BuildUserAgentString("Chime SDK Identity", "4.0.100.14");
        ...
        /// </summary>
        public static new string ServiceId => "Chime SDK Identity";
        ...
        /// </summary>
        public override string RegionEndpointServiceName => "identity-chime";

        /// <summary>
        /// Gets the ServiceVersion property.
        /// </summary>
        public override string ServiceVersion => "2021-04-20";
