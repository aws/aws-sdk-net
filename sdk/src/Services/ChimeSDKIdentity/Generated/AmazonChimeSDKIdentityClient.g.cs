...
namespace Amazon.ChimeSDKIdentity
{
    ...
    public partial class AmazonChimeSDKIdentityClient : AmazonServiceClient, IAmazonChimeSDKIdentity
    {
        ...
        /// 
        /// </summary>
        public AmazonChimeSDKIdentityClient() : base(new AmazonChimeSDKIdentityConfig()) { }
        ...
        public AmazonChimeSDKIdentityClient(RegionEndpoint region) : base(new AmazonChimeSDKIdentityConfig { RegionEndpoint = region }) { }
        ...
        public AmazonChimeSDKIdentityClient(AmazonChimeSDKIdentityConfig config) : base(config) { }
