...
{
    /// <summary>
    /// Container for the parameters to the PutAppInstanceRetentionSettings operation. Sets
    /// the amount of time in days that a given <c>AppInstance</c> retains data.
    /// </summary>
