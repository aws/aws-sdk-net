...
{
    /// <summary>
    /// Container for the parameters to the DeleteAppInstanceAdmin operation. Demotes an <c>AppInstanceAdmin</c>
    /// to an <c>AppInstanceUser</c> or <c>AppInstanceBot</c>. This action does not delete
    /// the user.
    /// </summary>
