...
namespace Amazon.ChimeSDKIdentity.Model
{
    ...
    public partial class ListAppInstanceUsersResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<AppInstanceUserSummary> AppInstanceUsers { get; set; } = AWSConfigs.InitializeCollections ? new List<AppInstanceUserSummary>() : null;

        /// <summary>
        /// Checks to see if the AppInstanceUsers property is set.
        /// </summary>
        internal bool IsSetAppInstanceUsers() => this.AppInstanceUsers != null && (this.AppInstanceUsers.Count > 0 || !AWSConfigs.InitializeCollections);
