...
namespace Amazon.ChimeSDKIdentity.Model
{
    ...
    public partial class ListAppInstancesResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<AppInstanceSummary> AppInstances { get; set; } = AWSConfigs.InitializeCollections ? new List<AppInstanceSummary>() : null;

        /// <summary>
        /// Checks to see if the AppInstances property is set.
        /// </summary>
        internal bool IsSetAppInstances() => this.AppInstances != null && (this.AppInstances.Count > 0 || !AWSConfigs.InitializeCollections);
