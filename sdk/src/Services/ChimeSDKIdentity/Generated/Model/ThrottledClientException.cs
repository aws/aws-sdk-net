...
namespace Amazon.ChimeSDKIdentity.Model
{
    ...
    public partial class ThrottledClientException : AmazonChimeSDKIdentityException
    {
        ...
        public ThrottledClientException(string message, Exception innerException, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ThrottledClientException(string message, Amazon.Runtime.ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
