...
namespace Amazon.ChimeSDKIdentity.Model
{
    ...
    public partial class ListAppInstanceAdminsResponse : AmazonWebServiceResponse
    {
        ...
        /// </summary>
        public List<AppInstanceAdminSummary> AppInstanceAdmins { get; set; } = AWSConfigs.InitializeCollections ? new List<AppInstanceAdminSummary>() : null;

        /// <summary>
        /// Checks to see if the AppInstanceAdmins property is set.
        /// </summary>
        internal bool IsSetAppInstanceAdmins() => this.AppInstanceAdmins != null && (this.AppInstanceAdmins.Count > 0 || !AWSConfigs.InitializeCollections);
