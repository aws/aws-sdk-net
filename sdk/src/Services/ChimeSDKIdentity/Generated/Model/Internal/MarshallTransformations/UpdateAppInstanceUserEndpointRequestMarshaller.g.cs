...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateAppInstanceUserEndpointRequestMarshaller : IMarshaller<IRequest, UpdateAppInstanceUserEndpointRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateAppInstanceUserEndpointRequestMarshaller _instance = new();

        internal static UpdateAppInstanceUserEndpointRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateAppInstanceUserEndpointRequestMarshaller Instance => _instance;
    }
}
