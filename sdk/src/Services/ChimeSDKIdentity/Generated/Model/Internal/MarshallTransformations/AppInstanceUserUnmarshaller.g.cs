...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AppInstanceUserUnmarshaller : IJsonUnmarshaller<AppInstanceUser, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AppInstanceUser();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AppInstanceUserUnmarshaller Instance => _instance;
    }
}
