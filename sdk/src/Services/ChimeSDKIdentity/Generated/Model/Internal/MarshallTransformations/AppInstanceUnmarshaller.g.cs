...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AppInstanceUnmarshaller : IJsonUnmarshaller<AppInstance, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AppInstance();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AppInstanceUnmarshaller Instance => _instance;
    }
}
