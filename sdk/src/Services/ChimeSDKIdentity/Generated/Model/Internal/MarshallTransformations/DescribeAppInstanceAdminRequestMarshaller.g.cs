...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeAppInstanceAdminRequestMarshaller : IMarshaller<IRequest, DescribeAppInstanceAdminRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeAppInstanceAdminRequestMarshaller _instance = new();

        internal static DescribeAppInstanceAdminRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeAppInstanceAdminRequestMarshaller Instance => _instance;
    }
}
