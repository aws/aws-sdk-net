...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AppInstanceUserEndpointUnmarshaller : IJsonUnmarshaller<AppInstanceUserEndpoint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AppInstanceUserEndpoint();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AppInstanceUserEndpointUnmarshaller Instance => _instance;
    }
}
