...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AppInstanceRetentionSettingsUnmarshaller : IJsonUnmarshaller<AppInstanceRetentionSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AppInstanceRetentionSettings Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("ChannelRetentionSettings", targetDepth, ref reader))
                {
                    var unmarshaller = ChannelRetentionSettingsUnmarshaller.Instance;
                    unmarshalledObject.ChannelRetentionSettings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
