...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAppInstanceUsersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListAppInstanceUsersResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("AppInstanceUsers", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<AppInstanceUserSummary, AppInstanceUserSummaryUnmarshaller>(AppInstanceUserSummaryUnmarshaller.Instance);
                    unmarshalledObject.AppInstanceUsers = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListAppInstanceUsersResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAppInstanceUsersResponseUnmarshaller Instance => _instance;
    }
}
