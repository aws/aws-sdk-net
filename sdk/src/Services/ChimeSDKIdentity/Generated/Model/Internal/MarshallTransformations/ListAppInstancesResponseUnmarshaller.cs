...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    public class ListAppInstancesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("AppInstances", targetDepth, ref reader))
                {
                    var unmarshaller = new JsonListUnmarshaller<AppInstanceSummary, AppInstanceSummaryUnmarshaller>(AppInstanceSummaryUnmarshaller.Instance);
                    response.AppInstances = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
