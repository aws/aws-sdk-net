...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeAppInstanceBotRequestMarshaller : IMarshaller<IRequest, DescribeAppInstanceBotRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeAppInstanceBotRequestMarshaller _instance = new();

        internal static DescribeAppInstanceBotRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeAppInstanceBotRequestMarshaller Instance => _instance;
    }
}
