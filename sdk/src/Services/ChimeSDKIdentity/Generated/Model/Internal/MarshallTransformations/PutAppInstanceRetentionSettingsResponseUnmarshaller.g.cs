...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutAppInstanceRetentionSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new PutAppInstanceRetentionSettingsResponse();
            ...
            {
                if (context.TestExpression("AppInstanceRetentionSettings", targetDepth, ref reader))
                {
                    var unmarshaller = AppInstanceRetentionSettingsUnmarshaller.Instance;
                    unmarshalledObject.AppInstanceRetentionSettings = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("InitiateDeletionTimestamp", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.InitiateDeletionTimestamp = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static PutAppInstanceRetentionSettingsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutAppInstanceRetentionSettingsResponseUnmarshaller Instance => _instance;
    }
}
