...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAppInstancesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListAppInstancesResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AppInstances", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AppInstances = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListAppInstancesResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAppInstancesResponseUnmarshaller Instance => _instance;
    }
}
