...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAppInstanceBotsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListAppInstanceBotsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("AppInstanceBots", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AppInstanceBots = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListAppInstanceBotsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAppInstanceBotsResponseUnmarshaller Instance => _instance;
    }
}
