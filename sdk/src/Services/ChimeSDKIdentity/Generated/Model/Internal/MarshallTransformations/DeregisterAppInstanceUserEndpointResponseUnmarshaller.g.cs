...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeregisterAppInstanceUserEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DeregisterAppInstanceUserEndpointResponse();
        ...
        internal static DeregisterAppInstanceUserEndpointResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeregisterAppInstanceUserEndpointResponseUnmarshaller Instance => _instance;
    }
}
