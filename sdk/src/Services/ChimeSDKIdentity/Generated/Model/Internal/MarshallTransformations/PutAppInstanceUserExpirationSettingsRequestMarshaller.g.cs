...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutAppInstanceUserExpirationSettingsRequestMarshaller : IMarshaller<IRequest, PutAppInstanceUserExpirationSettingsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutAppInstanceUserExpirationSettingsRequestMarshaller _instance = new();

        internal static PutAppInstanceUserExpirationSettingsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutAppInstanceUserExpirationSettingsRequestMarshaller Instance => _instance;
    }
}
