...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateAppInstanceAdminResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAppInstanceAdminResponse response = new CreateAppInstanceAdminResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AppInstanceAdmin", targetDepth))
                {
                    ...
                    response.AppInstanceAdmin = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static CreateAppInstanceAdminResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAppInstanceAdminResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
