...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAppInstanceUsersRequestMarshaller : IMarshaller<IRequest, ListAppInstanceUsersRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListAppInstanceUsersRequestMarshaller _instance = new();

        internal static ListAppInstanceUsersRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAppInstanceUsersRequestMarshaller Instance => _instance;
    }
}
