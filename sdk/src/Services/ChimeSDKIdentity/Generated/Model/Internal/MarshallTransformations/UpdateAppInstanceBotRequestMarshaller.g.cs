...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateAppInstanceBotRequestMarshaller : IMarshaller<IRequest, UpdateAppInstanceBotRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateAppInstanceBotRequestMarshaller _instance = new();

        internal static UpdateAppInstanceBotRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateAppInstanceBotRequestMarshaller Instance => _instance;
    }
}
