...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeAppInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeAppInstanceResponse();
            ...
            {
                if (context.TestExpression("AppInstance", targetDepth, ref reader))
                {
                    var unmarshaller = AppInstanceUnmarshaller.Instance;
                    unmarshalledObject.AppInstance = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DescribeAppInstanceResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeAppInstanceResponseUnmarshaller Instance => _instance;
    }
}
