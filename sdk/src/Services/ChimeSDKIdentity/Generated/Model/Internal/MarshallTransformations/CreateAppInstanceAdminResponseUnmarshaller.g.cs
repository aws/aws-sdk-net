...
{
    /// <summary>
    /// Response Unmarshaller for CreateAppInstanceAdmin operation.
    /// </summary>
    public partial class CreateAppInstanceAdminResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new CreateAppInstanceAdminResponse();
            ...
            {
                if (context.TestExpression("AppInstanceAdmin", targetDepth, ref reader))
                {
                    var unmarshaller = IdentityUnmarshaller.Instance;
                    unmarshalledObject.AppInstanceAdmin = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        private static CreateAppInstanceAdminResponseUnmarshaller _instance = new CreateAppInstanceAdminResponseUnmarshaller();

        internal static CreateAppInstanceAdminResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateAppInstanceAdminResponseUnmarshaller Instance => _instance;
    }
}
