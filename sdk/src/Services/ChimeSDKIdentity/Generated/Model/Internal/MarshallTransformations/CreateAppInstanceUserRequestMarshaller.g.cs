...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateAppInstanceUserRequestMarshaller : IMarshaller<IRequest, CreateAppInstanceUserRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateAppInstanceUserRequestMarshaller _instance = new();

        internal static CreateAppInstanceUserRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateAppInstanceUserRequestMarshaller Instance => _instance;
    }
}
