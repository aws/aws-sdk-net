...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AppInstanceSummaryUnmarshaller : IJsonUnmarshaller<AppInstanceSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AppInstanceSummary();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AppInstanceSummaryUnmarshaller Instance => _instance;
    }
}
