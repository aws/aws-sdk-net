...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteAppInstanceRequestMarshaller : IMarshaller<IRequest, DeleteAppInstanceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteAppInstanceRequestMarshaller _instance = new();

        internal static DeleteAppInstanceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteAppInstanceRequestMarshaller Instance => _instance;
    }
}
