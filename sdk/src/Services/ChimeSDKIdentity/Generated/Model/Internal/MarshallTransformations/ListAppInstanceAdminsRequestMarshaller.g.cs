...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAppInstanceAdminsRequestMarshaller : IMarshaller<IRequest, ListAppInstanceAdminsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListAppInstanceAdminsRequestMarshaller _instance = new();

        internal static ListAppInstanceAdminsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAppInstanceAdminsRequestMarshaller Instance => _instance;
    }
}
