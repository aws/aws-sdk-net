...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeAppInstanceBotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeAppInstanceBotResponse();
            ...
            {
                if (context.TestExpression("AppInstanceBot", targetDepth, ref reader))
                {
                    var unmarshaller = AppInstanceBotUnmarshaller.Instance;
                    unmarshalledObject.AppInstanceBot = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DescribeAppInstanceBotResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeAppInstanceBotResponseUnmarshaller Instance => _instance;
    }
}
