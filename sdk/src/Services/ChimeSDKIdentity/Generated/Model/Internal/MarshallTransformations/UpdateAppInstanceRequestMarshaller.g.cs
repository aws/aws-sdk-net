...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateAppInstanceRequestMarshaller : IMarshaller<IRequest, UpdateAppInstanceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateAppInstanceRequestMarshaller _instance = new();

        internal static UpdateAppInstanceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateAppInstanceRequestMarshaller Instance => _instance;
    }
}
