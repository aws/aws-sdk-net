...
{
    /// <summary>
    /// Response Unmarshaller for CreateAppInstanceUser operation
    /// </summary>  
    public class CreateAppInstanceUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAppInstanceUserResponse response = new CreateAppInstanceUserResponse();
        ...
        private static CreateAppInstanceUserResponseUnmarshaller _instance = new CreateAppInstanceUserResponseUnmarshaller();        

        internal static CreateAppInstanceUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAppInstanceUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
