...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeAppInstanceUserEndpointRequestMarshaller : IMarshaller<IRequest, DescribeAppInstanceUserEndpointRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeAppInstanceUserEndpointRequestMarshaller _instance = new();

        internal static DescribeAppInstanceUserEndpointRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeAppInstanceUserEndpointRequestMarshaller Instance => _instance;
    }
}
