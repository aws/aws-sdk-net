...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAppInstanceUserEndpointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListAppInstanceUserEndpointsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AppInstanceUserEndpoints", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AppInstanceUserEndpoints = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListAppInstanceUserEndpointsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAppInstanceUserEndpointsResponseUnmarshaller Instance => _instance;
    }
}
