...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateAppInstanceUserRequestMarshaller : IMarshaller<IRequest, UpdateAppInstanceUserRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly UpdateAppInstanceUserRequestMarshaller _instance = new();

        internal static UpdateAppInstanceUserRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateAppInstanceUserRequestMarshaller Instance => _instance;
    }
}
