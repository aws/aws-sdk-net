...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class CreateAppInstanceAdminRequestMarshaller : IMarshaller<IRequest, CreateAppInstanceAdminRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly CreateAppInstanceAdminRequestMarshaller _instance = new();

        internal static CreateAppInstanceAdminRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static CreateAppInstanceAdminRequestMarshaller Instance => _instance;
    }
}
