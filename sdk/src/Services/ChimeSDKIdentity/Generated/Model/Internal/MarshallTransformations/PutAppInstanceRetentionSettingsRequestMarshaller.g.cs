...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class PutAppInstanceRetentionSettingsRequestMarshaller : IMarshaller<IRequest, PutAppInstanceRetentionSettingsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly PutAppInstanceRetentionSettingsRequestMarshaller _instance = new();

        internal static PutAppInstanceRetentionSettingsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static PutAppInstanceRetentionSettingsRequestMarshaller Instance => _instance;
    }
}
