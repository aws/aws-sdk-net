...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LexConfigurationUnmarshaller : IJsonUnmarshaller<LexConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public LexConfiguration Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
