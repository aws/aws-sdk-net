...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteAppInstanceUserRequestMarshaller : IMarshaller<IRequest, DeleteAppInstanceUserRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteAppInstanceUserRequestMarshaller _instance = new();

        internal static DeleteAppInstanceUserRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteAppInstanceUserRequestMarshaller Instance => _instance;
    }
}
