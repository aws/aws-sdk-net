...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class UpdateAppInstanceUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new UpdateAppInstanceUserResponse();
        ...
        internal static UpdateAppInstanceUserResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static UpdateAppInstanceUserResponseUnmarshaller Instance => _instance;
    }
}
