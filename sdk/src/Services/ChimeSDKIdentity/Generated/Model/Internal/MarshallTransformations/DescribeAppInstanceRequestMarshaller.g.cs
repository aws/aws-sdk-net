...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeAppInstanceRequestMarshaller : IMarshaller<IRequest, DescribeAppInstanceRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DescribeAppInstanceRequestMarshaller _instance = new();

        internal static DescribeAppInstanceRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeAppInstanceRequestMarshaller Instance => _instance;
    }
}
