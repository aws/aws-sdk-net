...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class EndpointAttributesUnmarshaller : IJsonUnmarshaller<EndpointAttributes, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new EndpointAttributes();
        ...
        /// Gets the singleton.
        /// </summary>
        public static EndpointAttributesUnmarshaller Instance => _instance;
    }
}
