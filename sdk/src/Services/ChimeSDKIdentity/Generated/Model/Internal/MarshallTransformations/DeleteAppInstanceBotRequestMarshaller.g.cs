...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteAppInstanceBotRequestMarshaller : IMarshaller<IRequest, DeleteAppInstanceBotRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteAppInstanceBotRequestMarshaller _instance = new();

        internal static DeleteAppInstanceBotRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteAppInstanceBotRequestMarshaller Instance => _instance;
    }
}
