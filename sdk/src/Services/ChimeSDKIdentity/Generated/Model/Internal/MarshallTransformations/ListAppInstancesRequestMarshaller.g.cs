...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAppInstancesRequestMarshaller : IMarshaller<IRequest, ListAppInstancesRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListAppInstancesRequestMarshaller _instance = new();

        internal static ListAppInstancesRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAppInstancesRequestMarshaller Instance => _instance;
    }
}
