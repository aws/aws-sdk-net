...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeAppInstanceUserEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeAppInstanceUserEndpointResponse();
            ...
            {
                if (context.TestExpression("AppInstanceUserEndpoint", targetDepth, ref reader))
                {
                    var unmarshaller = AppInstanceUserEndpointUnmarshaller.Instance;
                    unmarshalledObject.AppInstanceUserEndpoint = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DescribeAppInstanceUserEndpointResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeAppInstanceUserEndpointResponseUnmarshaller Instance => _instance;
    }
}
