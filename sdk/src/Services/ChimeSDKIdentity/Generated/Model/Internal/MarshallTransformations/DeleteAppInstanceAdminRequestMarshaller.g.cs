...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteAppInstanceAdminRequestMarshaller : IMarshaller<IRequest, DeleteAppInstanceAdminRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteAppInstanceAdminRequestMarshaller _instance = new();

        internal static DeleteAppInstanceAdminRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteAppInstanceAdminRequestMarshaller Instance => _instance;
    }
}
