...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AppInstanceAdminUnmarshaller : IJsonUnmarshaller<AppInstanceAdmin, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AppInstanceAdmin();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AppInstanceAdminUnmarshaller Instance => _instance;
    }
}
