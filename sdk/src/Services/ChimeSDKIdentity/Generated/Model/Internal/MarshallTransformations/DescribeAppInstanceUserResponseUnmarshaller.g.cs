...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DescribeAppInstanceUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new DescribeAppInstanceUserResponse();
            ...
            {
                if (context.TestExpression("AppInstanceUser", targetDepth, ref reader))
                {
                    var unmarshaller = AppInstanceUserUnmarshaller.Instance;
                    unmarshalledObject.AppInstanceUser = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static DescribeAppInstanceUserResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DescribeAppInstanceUserResponseUnmarshaller Instance => _instance;
    }
}
