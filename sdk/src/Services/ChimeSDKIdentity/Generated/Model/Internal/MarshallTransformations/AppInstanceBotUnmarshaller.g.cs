...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class AppInstanceBotUnmarshaller : IJsonUnmarshaller<AppInstanceBot, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new AppInstanceBot();
        ...
        /// Gets the singleton.
        /// </summary>
        public static AppInstanceBotUnmarshaller Instance => _instance;
    }
}
