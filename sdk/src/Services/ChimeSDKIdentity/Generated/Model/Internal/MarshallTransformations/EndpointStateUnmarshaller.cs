...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EndpointStateUnmarshaller : IJsonUnmarshaller<EndpointState, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public EndpointState Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
