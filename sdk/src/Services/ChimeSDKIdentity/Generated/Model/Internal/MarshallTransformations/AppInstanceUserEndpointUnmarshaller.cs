...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AppInstanceUserEndpointUnmarshaller : IJsonUnmarshaller<AppInstanceUserEndpoint, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        public AppInstanceUserEndpoint Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("AllowMessages", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AllowMessages = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("AppInstanceUserArn", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.AppInstanceUserArn = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("EndpointAttributes", targetDepth, ref reader))
                {
                    var unmarshaller = EndpointAttributesUnmarshaller.Instance;
                    unmarshalledObject.EndpointAttributes = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                ...
                if (context.TestExpression("EndpointState", targetDepth, ref reader))
                {
                    var unmarshaller = EndpointStateUnmarshaller.Instance;
                    unmarshalledObject.EndpointState = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
