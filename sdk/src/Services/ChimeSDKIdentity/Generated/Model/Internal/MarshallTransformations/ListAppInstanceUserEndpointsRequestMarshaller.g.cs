...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAppInstanceUserEndpointsRequestMarshaller : IMarshaller<IRequest, ListAppInstanceUserEndpointsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListAppInstanceUserEndpointsRequestMarshaller _instance = new();

        internal static ListAppInstanceUserEndpointsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAppInstanceUserEndpointsRequestMarshaller Instance => _instance;
    }
}
