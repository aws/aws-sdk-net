...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeregisterAppInstanceUserEndpointRequestMarshaller : IMarshaller<IRequest, DeregisterAppInstanceUserEndpointRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeregisterAppInstanceUserEndpointRequestMarshaller _instance = new();

        internal static DeregisterAppInstanceUserEndpointRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeregisterAppInstanceUserEndpointRequestMarshaller Instance => _instance;
    }
}
