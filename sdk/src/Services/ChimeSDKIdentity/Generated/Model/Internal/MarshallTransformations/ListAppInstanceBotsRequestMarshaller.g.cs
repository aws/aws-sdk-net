...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAppInstanceBotsRequestMarshaller : IMarshaller<IRequest, ListAppInstanceBotsRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly ListAppInstanceBotsRequestMarshaller _instance = new();

        internal static ListAppInstanceBotsRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAppInstanceBotsRequestMarshaller Instance => _instance;
    }
}
