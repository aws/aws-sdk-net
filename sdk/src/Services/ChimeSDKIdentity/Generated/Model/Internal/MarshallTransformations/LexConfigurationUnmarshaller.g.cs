...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class LexConfigurationUnmarshaller : IJsonUnmarshaller<LexConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new LexConfiguration();
        ...
        /// Gets the singleton.
        /// </summary>
        public static LexConfigurationUnmarshaller Instance => _instance;
    }
}
