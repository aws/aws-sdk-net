...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListAppInstanceAdminsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListAppInstanceAdminsResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("AppInstanceAdmins", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.AppInstanceAdmins = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        internal static ListAppInstanceAdminsResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListAppInstanceAdminsResponseUnmarshaller Instance => _instance;
    }
}
