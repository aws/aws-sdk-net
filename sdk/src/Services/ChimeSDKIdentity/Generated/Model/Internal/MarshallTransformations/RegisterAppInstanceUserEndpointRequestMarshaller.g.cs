...
namespace Amazon.ChimeSDKIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class RegisterAppInstanceUserEndpointRequestMarshaller : IMarshaller<IRequest, RegisterAppInstanceUserEndpointRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly RegisterAppInstanceUserEndpointRequestMarshaller _instance = new();

        internal static RegisterAppInstanceUserEndpointRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static RegisterAppInstanceUserEndpointRequestMarshaller Instance => _instance;
    }
}
