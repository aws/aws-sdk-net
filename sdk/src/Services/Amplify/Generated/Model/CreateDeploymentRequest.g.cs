...
namespace Amazon.Amplify.Model
{
    ...
    /// for a manually deployed Amplify app. Manually deployed apps are not connected to a
    /// Git repository. <para> The maximum duration between the <c>CreateDeployment</c> call
    /// and the <c>StartDeployment</c> call cannot exceed 8 hours. If the duration exceeds
    /// 8 hours, the <c>StartDeployment</c> call and the associated <c>Job</c> will fail.
    /// </para>
    /// </summary>
    public partial class CreateDeploymentRequest : AmazonAmplifyRequest
    {
        ...
        /// </summary>
        public Dictionary<string, string> FileMap { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the FileMap property is set.
        /// </summary>
        internal bool IsSetFileMap() => this.FileMap != null && (this.FileMap.Count > 0 || !AWSConfigs.InitializeCollections);
    }
}
