...
namespace Amazon.Amplify.Model
{
    ...
    public partial class JobConfig
    {
        ...
        public BuildComputeType BuildComputeType { get; set; }

        /// <summary>
        /// Checks to see if the BuildComputeType property is set.
        /// </summary>
        internal bool IsSetBuildComputeType() => this.BuildComputeType != null;
    }
}
