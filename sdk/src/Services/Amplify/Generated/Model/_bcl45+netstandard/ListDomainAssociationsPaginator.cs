...
{
    /// <summary>
    /// Base class for ListDomainAssociations paginators.
    /// </summary>
    internal sealed partial class ListDomainAssociationsPaginator : IPaginator<ListDomainAssociationsResponse>, IListDomainAssociationsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<ListDomainAssociationsResponse> Responses => new PaginatedResponse<ListDomainAssociationsResponse>(this);
...
#if BCL
        IEnumerable<ListDomainAssociationsResponse> IPaginator<ListDomainAssociationsResponse>.Paginate()
        {
            ...
            ListDomainAssociationsResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.ListDomainAssociations(_request);
