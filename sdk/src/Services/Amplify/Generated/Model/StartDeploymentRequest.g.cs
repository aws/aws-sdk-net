...
namespace Amazon.Amplify.Model
{
    ...
    /// for a manually deployed app. Manually deployed apps are not connected to a Git repository.
    /// <para> The maximum duration between the <c>CreateDeployment</c> call and the <c>StartDeployment</c>
    /// call cannot exceed 8 hours. If the duration exceeds 8 hours, the <c>StartDeployment</c>
    /// call and the associated <c>Job</c> will fail. </para>
    /// </summary>
