...
namespace Amazon.Amplify.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class ListWebhooksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            var unmarshalledObject = new ListWebhooksResponse();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("webhooks", targetDepth, ref reader))
                {
                    ...
                    unmarshalledObject.Webhooks = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        internal static ListWebhooksResponseUnmarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static ListWebhooksResponseUnmarshaller Instance => _instance;
    }
}
