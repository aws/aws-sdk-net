...
namespace Amazon.Amplify.Model.Internal.MarshallTransformations
{
    ...
    public class CreateBranchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                return new DependentServiceFailureException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
            }
        ...
        private static CreateBranchResponseUnmarshaller _instance = new CreateBranchResponseUnmarshaller();        

        internal static CreateBranchResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBranchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
