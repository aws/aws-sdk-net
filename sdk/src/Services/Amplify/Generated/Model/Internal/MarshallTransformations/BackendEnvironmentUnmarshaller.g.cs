...
namespace Amazon.Amplify.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class BackendEnvironmentUnmarshaller : IJsonUnmarshaller<BackendEnvironment, JsonUnmarshallerContext>
    {
        /// <summary>
        /// Unmarshall the response from the service to the response class.
        /// </summary>
        /// <returns>The unmarshalled object</returns>
        public BackendEnvironment Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            var unmarshalledObject = new BackendEnvironment();
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                if (context.TestExpression("deploymentArtifacts", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DeploymentArtifacts = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
        ...
        /// Gets the singleton.
        /// </summary>
        public static BackendEnvironmentUnmarshaller Instance => _instance;
    }
}
