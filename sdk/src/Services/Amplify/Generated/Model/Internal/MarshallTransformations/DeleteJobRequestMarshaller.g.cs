...
namespace Amazon.Amplify.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    public partial class DeleteJobRequestMarshaller : IMarshaller<IRequest, DeleteJobRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static readonly DeleteJobRequestMarshaller _instance = new();

        internal static DeleteJobRequestMarshaller GetInstance() => _instance;

        /// <summary>
        /// Gets the singleton.
        /// </summary>
        public static DeleteJobRequestMarshaller Instance => _instance;
    }
}
