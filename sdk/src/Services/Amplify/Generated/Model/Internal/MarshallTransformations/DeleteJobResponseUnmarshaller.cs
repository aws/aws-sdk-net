...
{
    /// <summary>
    /// Response Unmarshaller for DeleteJob operation
    /// </summary>  
    public class DeleteJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                if (context.TestExpression("jobSummary", targetDepth))
                {
                    ...
                    response.JobSummary = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
            }
        ...
        private static DeleteJobResponseUnmarshaller _instance = new DeleteJobResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
