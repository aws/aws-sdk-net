...
namespace Amazon.Amplify.Model.Internal.MarshallTransformations
{
    ...
    public class StepUnmarshaller : IJsonUnmarshaller<Step, JsonUnmarshallerContext>
    {
        ...
        public Step Unmarshall(JsonUnmarshallerContext context, ref StreamingUtf8JsonReader reader)
        {
            ...
            {
                if (context.TestExpression("artifactsUrl", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("screenshots", targetDepth, ref reader))
                {
                ...
                if (context.TestExpression("testArtifactsUrl", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.TestArtifactsUrl = unmarshaller.Unmarshall(context, ref reader);
                    continue;
                }
                if (context.TestExpression("testConfigUrl", targetDepth, ref reader))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
