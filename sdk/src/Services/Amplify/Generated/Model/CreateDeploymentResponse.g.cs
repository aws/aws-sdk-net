...
namespace Amazon.Amplify.Model
{
    ...
    public partial class CreateDeploymentResponse : AmazonWebServiceResponse
    {
        ...
        public Dictionary<string, string> FileUploadUrls { get; set; } = AWSConfigs.InitializeCollections ? new Dictionary<string, string>() : null;

        /// <summary>
        /// Checks to see if the FileUploadUrls property is set.
        /// </summary>
        internal bool IsSetFileUploadUrls() => this.FileUploadUrls != null && (this.FileUploadUrls.Count > 0 || !AWSConfigs.InitializeCollections);
        ...
        /// <summary>
        /// Checks to see if the ZipUploadUrl property is set.
        /// </summary>
        internal bool IsSetZipUploadUrl() => this.ZipUploadUrl != null;
    }
}
