...
{
    /// <summary>
    /// Container for the parameters to the GetBackendEnvironment operation. Returns a backend
    /// environment for an Amplify app. <para> This API is available only to Amplify Gen 1
    /// applications where the backend is created using Amplify Studio or the Amplify command
