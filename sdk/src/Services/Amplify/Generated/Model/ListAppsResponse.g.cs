...
namespace Amazon.Amplify.Model
{
    ...
    public partial class ListAppsResponse : AmazonWebServiceResponse
    {
        ...
        public List<App> Apps { get; set; } = AWSConfigs.InitializeCollections ? new List<App>() : null;

        /// <summary>
        /// Checks to see if the Apps property is set.
        /// </summary>
        internal bool IsSetApps() => this.Apps != null && (this.Apps.Count > 0 || !AWSConfigs.InitializeCollections);
