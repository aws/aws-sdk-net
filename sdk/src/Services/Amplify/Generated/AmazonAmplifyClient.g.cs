...
namespace Amazon.Amplify
{
    ...
    public partial class AmazonAmplifyClient : AmazonServiceClient, IAmazonAmplify
    {
        ...
        /// 
        /// </summary>
        public AmazonAmplifyClient() : base(new AmazonAmplifyConfig()) { }
        ...
        public AmazonAmplifyClient(RegionEndpoint region) : base(new AmazonAmplifyConfig { RegionEndpoint = region }) { }
        ...
        public AmazonAmplifyClient(AmazonAmplifyConfig config) : base(config) { }
