...
namespace Amazon.Amplify.Internal
{
    ...
    public class AmazonAmplifyAuthSchemeParameters : IAuthSchemeParameters
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class AmazonAmplifyAuthSchemeHandler : BaseAuthResolverHandler
    {
        /// <summary>
        /// Modeled auth scheme resolver for Amplify.
        /// </summary>
        public AmazonAmplifyAuthSchemeResolver AuthSchemeResolver { get; } = new();

        /// <inheritdoc />
        protected override List<IAuthSchemeOption> ResolveAuthOptions(IExecutionContext executionContext)
        {
            var requestContext = executionContext.RequestContext;
            var mappedParameters = new AmazonAmplifyAuthSchemeParameters
            {
    ...
    public class AmazonAmplifyAuthSchemeResolver : IAuthSchemeResolver<AmazonAmplifyAuthSchemeParameters>
    {
        /// <inheritdoc />
        public List<IAuthSchemeOption> ResolveAuthScheme(AmazonAmplifyAuthSchemeParameters authParameters) =>
