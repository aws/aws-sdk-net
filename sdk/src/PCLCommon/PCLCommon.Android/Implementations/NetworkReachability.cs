...
namespace Amazon.Common
{
    ...
    {
        public NetworkStatusChangeBroadcastReceiver _networkBroadcastReceiver;
        ...
        private void NetworkStatusChanged(object sender, Common.NetworkStatus e)
        {
            this._networkStatus = e;
            if (NetworkReachabilityChanged != null)
                NetworkReachabilityChanged(this, e);
        }
