...
namespace Amazon.IdentityManagement
{
    ...
    public class AmazonIdentityManagementServiceClient : AmazonWebServiceClient, AmazonIdentityManagementService
    {
        ...
        {
            IRequest<DeleteVirtualMFADeviceRequest> request = new DeleteVirtualMFADeviceRequestMarshaller().Marshall(deleteVirtualMFADeviceRequest);
            DeleteVirtualMFADeviceResponse response = Invoke<DeleteVirtualMFADeviceRequest, DeleteVirtualMFADeviceResponse> (request, this.signer, DeleteVirtualMFADeviceResponseUnmarshaller.GetInstance());
            return response;
        }
        ...
        {
            IRequest<ListVirtualMFADevicesRequest> request = new ListVirtualMFADevicesRequestMarshaller().Marshall(listVirtualMFADevicesRequest);
            ListVirtualMFADevicesResponse response = Invoke<ListVirtualMFADevicesRequest, ListVirtualMFADevicesResponse> (request, this.signer, ListVirtualMFADevicesResponseUnmarshaller.GetInstance());
            return response;
        }
