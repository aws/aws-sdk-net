...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class DeleteGroupPolicyResponseUnmarshaller : IResponseUnmarshaller<DeleteGroupPolicyResponse, UnmarshallerContext> {

        public DeleteGroupPolicyResponse Unmarshall(UnmarshallerContext context) 
        {
            DeleteGroupPolicyResponse response = new DeleteGroupPolicyResponse();
        ...
        private static DeleteGroupPolicyResponseUnmarshaller instance;

        public static DeleteGroupPolicyResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DeleteGroupPolicyResponseUnmarshaller();
            }
            return instance;
        }
