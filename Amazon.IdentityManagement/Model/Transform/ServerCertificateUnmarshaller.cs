...
namespace Amazon.IdentityManagement.Model.Transform
{
     ...
     /// </summary>
    internal class ServerCertificateUnmarshaller : IUnmarshaller<ServerCertificate, UnmarshallerContext> 
    {
        public ServerCertificate Unmarshall(UnmarshallerContext context) 
        {
