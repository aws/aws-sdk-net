...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class DeleteLoginProfileResponseUnmarshaller : IResponseUnmarshaller<DeleteLoginProfileResponse, UnmarshallerContext> {

        public DeleteLoginProfileResponse Unmarshall(UnmarshallerContext context) 
        {
        ...
        private static DeleteLoginProfileResponseUnmarshaller instance;
