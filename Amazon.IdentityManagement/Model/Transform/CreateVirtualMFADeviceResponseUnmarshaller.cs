...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class CreateVirtualMFADeviceResponseUnmarshaller : IResponseUnmarshaller<CreateVirtualMFADeviceResponse, UnmarshallerContext> {

        public CreateVirtualMFADeviceResponse Unmarshall(UnmarshallerContext context) 
        {
