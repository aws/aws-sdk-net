...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class UpdateSigningCertificateResponseUnmarshaller : IResponseUnmarshaller<UpdateSigningCertificateResponse, UnmarshallerContext> {

        public UpdateSigningCertificateResponse Unmarshall(UnmarshallerContext context) 
        {
