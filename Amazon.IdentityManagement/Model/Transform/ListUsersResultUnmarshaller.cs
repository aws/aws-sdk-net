...
namespace Amazon.IdentityManagement.Model.Transform
{
     ...
     /// </summary>
    internal class ListUsersResultUnmarshaller : IUnmarshaller<ListUsersResult, UnmarshallerContext> 
    {
        public ListUsersResult Unmarshall(UnmarshallerContext context) 
        {
