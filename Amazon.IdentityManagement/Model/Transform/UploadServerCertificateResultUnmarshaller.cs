...
namespace Amazon.IdentityManagement.Model.Transform
{
     ...
     /// </summary>
    internal class UploadServerCertificateResultUnmarshaller : IUnmarshaller<UploadServerCertificateResult, UnmarshallerContext> 
    {
        public UploadServerCertificateResult Unmarshall(UnmarshallerContext context) 
        {
