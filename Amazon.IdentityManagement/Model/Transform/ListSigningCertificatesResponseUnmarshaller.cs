...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class ListSigningCertificatesResponseUnmarshaller : IResponseUnmarshaller<ListSigningCertificatesResponse, UnmarshallerContext> {

        public ListSigningCertificatesResponse Unmarshall(UnmarshallerContext context) 
        {
