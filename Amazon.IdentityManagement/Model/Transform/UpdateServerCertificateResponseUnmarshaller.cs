...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class UpdateServerCertificateResponseUnmarshaller : IResponseUnmarshaller<UpdateServerCertificateResponse, UnmarshallerContext> {

        public UpdateServerCertificateResponse Unmarshall(UnmarshallerContext context) 
        {
