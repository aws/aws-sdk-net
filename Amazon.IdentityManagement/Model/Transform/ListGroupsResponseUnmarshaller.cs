...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class ListGroupsResponseUnmarshaller : IResponseUnmarshaller<ListGroupsResponse, UnmarshallerContext> {

        public ListGroupsResponse Unmarshall(UnmarshallerContext context) 
        {
        ...
        private static ListGroupsResponseUnmarshaller instance;

        public static ListGroupsResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new ListGroupsResponseUnmarshaller();
            }
            return instance;
        }
