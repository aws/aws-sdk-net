...
namespace Amazon.IdentityManagement.Model.Transform
{
     ...
     /// </summary>
    internal class GetAccountSummaryResultUnmarshaller : IUnmarshaller<GetAccountSummaryResult, UnmarshallerContext> 
    {
        public GetAccountSummaryResult Unmarshall(UnmarshallerContext context) 
        {
