...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class DeleteServerCertificateResponseUnmarshaller : IResponseUnmarshaller<DeleteServerCertificateResponse, UnmarshallerContext> {

        public DeleteServerCertificateResponse Unmarshall(UnmarshallerContext context) 
        {
