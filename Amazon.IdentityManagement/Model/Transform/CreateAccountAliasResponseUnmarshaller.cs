...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class CreateAccountAliasResponseUnmarshaller : IResponseUnmarshaller<CreateAccountAliasResponse, UnmarshallerContext> {

        public CreateAccountAliasResponse Unmarshall(UnmarshallerContext context) 
        {
            CreateAccountAliasResponse response = new CreateAccountAliasResponse();
        ...
        private static CreateAccountAliasResponseUnmarshaller instance;

        public static CreateAccountAliasResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new CreateAccountAliasResponseUnmarshaller();
            }
            return instance;
        }
