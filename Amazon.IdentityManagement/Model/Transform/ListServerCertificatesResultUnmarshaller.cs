...
namespace Amazon.IdentityManagement.Model.Transform
{
     ...
     /// </summary>
    internal class ListServerCertificatesResultUnmarshaller : IUnmarshaller<ListServerCertificatesResult, UnmarshallerContext> 
    {
        public ListServerCertificatesResult Unmarshall(UnmarshallerContext context) 
        {
