...
namespace Amazon.IdentityManagement.Model.Transform
{
     ...
     /// </summary>
    internal class ListVirtualMFADevicesResultUnmarshaller : IUnmarshaller<ListVirtualMFADevicesResult, UnmarshallerContext> 
    {
        public ListVirtualMFADevicesResult Unmarshall(UnmarshallerContext context) 
        {
