...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class DeactivateMFADeviceResponseUnmarshaller : IResponseUnmarshaller<DeactivateMFADeviceResponse, UnmarshallerContext> {

        public DeactivateMFADeviceResponse Unmarshall(UnmarshallerContext context) 
        {
            DeactivateMFADeviceResponse response = new DeactivateMFADeviceResponse();
        ...
        private static DeactivateMFADeviceResponseUnmarshaller instance;

        public static DeactivateMFADeviceResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DeactivateMFADeviceResponseUnmarshaller();
            }
            return instance;
        }
