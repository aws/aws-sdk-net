...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class ListAccessKeysResponseUnmarshaller : IResponseUnmarshaller<ListAccessKeysResponse, UnmarshallerContext> {

        public ListAccessKeysResponse Unmarshall(UnmarshallerContext context) 
        {
