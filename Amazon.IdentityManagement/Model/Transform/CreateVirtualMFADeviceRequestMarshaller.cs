...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>       
    public class CreateVirtualMFADeviceRequestMarshaller : IMarshaller<IRequest<CreateVirtualMFADeviceRequest>, CreateVirtualMFADeviceRequest>
    {
        public IRequest<CreateVirtualMFADeviceRequest> Marshall(CreateVirtualMFADeviceRequest createVirtualMFADeviceRequest)
        {
            IRequest<CreateVirtualMFADeviceRequest> request = new DefaultRequest<CreateVirtualMFADeviceRequest>(createVirtualMFADeviceRequest, "AmazonIdentityManagementService");
