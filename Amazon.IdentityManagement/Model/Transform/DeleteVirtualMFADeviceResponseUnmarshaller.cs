...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class DeleteVirtualMFADeviceResponseUnmarshaller : IResponseUnmarshaller<DeleteVirtualMFADeviceResponse, UnmarshallerContext> {

        public DeleteVirtualMFADeviceResponse Unmarshall(UnmarshallerContext context) 
        {
