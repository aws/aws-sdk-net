...
namespace Amazon.IdentityManagement.Model.Transform
{
     ...
     /// </summary>
    internal class VirtualMFADeviceUnmarshaller : IUnmarshaller<VirtualMFADevice, UnmarshallerContext> 
    {
        public VirtualMFADevice Unmarshall(UnmarshallerContext context) 
        {
