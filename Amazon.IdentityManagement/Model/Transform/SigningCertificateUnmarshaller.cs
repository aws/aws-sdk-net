...
namespace Amazon.IdentityManagement.Model.Transform
{
     ...
     /// </summary>
    internal class SigningCertificateUnmarshaller : IUnmarshaller<SigningCertificate, UnmarshallerContext> 
    {
        public SigningCertificate Unmarshall(UnmarshallerContext context) 
        {
