...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class UpdateAccessKeyResponseUnmarshaller : IResponseUnmarshaller<UpdateAccessKeyResponse, UnmarshallerContext> {

        public UpdateAccessKeyResponse Unmarshall(UnmarshallerContext context) 
        {
        ...
        private static UpdateAccessKeyResponseUnmarshaller instance;

        public static UpdateAccessKeyResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new UpdateAccessKeyResponseUnmarshaller();
            }
            return instance;
        }
