...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class ListAccountAliasesResponseUnmarshaller : IResponseUnmarshaller<ListAccountAliasesResponse, UnmarshallerContext> {

        public ListAccountAliasesResponse Unmarshall(UnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)
                {
                    ...
                    {
                        response.ListAccountAliasesResult = ListAccountAliasesResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static ListAccountAliasesResponseUnmarshaller instance;
