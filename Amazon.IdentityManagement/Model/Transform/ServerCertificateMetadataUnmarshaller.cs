...
namespace Amazon.IdentityManagement.Model.Transform
{
     ...
     /// </summary>
    internal class ServerCertificateMetadataUnmarshaller : IUnmarshaller<ServerCertificateMetadata, UnmarshallerContext> 
    {
        public ServerCertificateMetadata Unmarshall(UnmarshallerContext context) 
        {
