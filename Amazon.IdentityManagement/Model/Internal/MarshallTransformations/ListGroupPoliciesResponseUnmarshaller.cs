...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class ListGroupPoliciesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static ListGroupPoliciesResponseUnmarshaller instance;

        public static ListGroupPoliciesResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new ListGroupPoliciesResponseUnmarshaller();
            }
            return instance;
        }
