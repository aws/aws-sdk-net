...
namespace TestAotDeserialization_WithFix;

// This version INCLUDES DynamicDependency attributes to fix the Native AOT trimming issue
[DynamoDBTable("TestQuotesWithFix")]
public class QuoteResponse
{
    // Include DynamicDependency attributes to prevent trimming - THIS IS THE FIX!
...
class Program
{
    ...
    private const string TableName = "TestQuotesWithFix";

    static async Task Main(string[] args)
    {
        try
        {
            Console.WriteLine("Starting DynamoDB Native AOT Test WITH DynamicDependency Fix");
            Console.WriteLine("=====================================================");
            ...
            try
            {
                ...
                Console.WriteLine("SUCCESS: No exception was thrown! The DynamicDependency fix worked!");
            }
            catch (Exception ex)
            {
                ...
                Console.WriteLine("\nEven with the DynamicDependency attributes, an error occurred.");
            }
        }
        catch (Exception ex)
        {
    ...
    static async Task QueryData(DynamoDBContext context, string id)
    {
        ...
        try
        {
            ...
            if (results.Count > 0)
            {
                ...
                // Access the nested list - this should work with DynamicDependency attributes
