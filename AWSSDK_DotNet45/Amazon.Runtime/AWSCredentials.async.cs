    ...
    public partial class AssumeRoleAWSCredentials : RefreshingAWSCredentials, IDisposable
    {
        private Credentials GetServiceCredentials()
        {
            ...
            if (_assumeRequest != null)
                credentials = _stsClient.AssumeRoleAsync(_assumeRequest).Result.Credentials;
            else
                credentials = _stsClient.AssumeRoleWithSAMLAsync(_assumeSamlRequest).Result.Credentials;
