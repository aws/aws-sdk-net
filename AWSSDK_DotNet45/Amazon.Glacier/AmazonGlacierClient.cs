...
namespace Amazon.Glacier
{
	...
	public partial class AmazonGlacierClient : AmazonWebServiceClient, Amazon.Glacier.IAmazonGlacier
    {
        ...
        public AmazonGlacierClient()
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonGlacierConfig(), AuthenticationTypes.User | AuthenticationTypes.Session) { }
        ...
        public AmazonGlacierClient(RegionEndpoint region)
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonGlacierConfig(){RegionEndpoint = region}, AuthenticationTypes.User | AuthenticationTypes.Session) { }
        ...
        /// </param>
        /// <returns>The task object representing the asynchronous operation.</returns>
		public Task<SetVaultNotificationsResponse> SetVaultNotificationsAsync(SetVaultNotificationsRequest request, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return Invoke<IRequest, SetVaultNotificationsRequest, SetVaultNotificationsResponse>(request, marshaller, unmarshaller, signer, cancellationToken);
        }
