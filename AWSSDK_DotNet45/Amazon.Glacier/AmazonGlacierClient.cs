...
namespace Amazon.Glacier
{
    ...
    public partial class AmazonGlacierClient : AmazonServiceClient, IAmazonGlacier
    {
        ...
        /// the vault deletion            fails (that is, the vault is not removed) and Amazon Glacier
        /// returns an error. You can use                <a>DescribeVault</a> to return the number of            archives
        /// in a vault, and you can use <a href="http://docs.aws.amazon.com/amazonglacier/latest/dev/api-initiate-job-post.html">Initiate
        ...
        /// Parts returns an error for            completed uploads. The list returned in the List Parts
        ...
        /// for a <code class="code">marker</code> at which to continue               the list; if there
        /// are no more items the <code class="code">marker</code> is <code class="code">null</code>.
