...
namespace Amazon.Glacier
{
    ...
    public partial class AmazonGlacierClient : AmazonServiceClient, IAmazonGlacier
    {
        ...
        /// </exception>
        public AbortMultipartUploadResponse AbortMultipartUpload(string accountId, string vaultName, string uploadId)
        {
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        public CompleteMultipartUploadResponse CompleteMultipartUpload(string accountId, string vaultName, string uploadId, string archiveSize, string checksum)
        {
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        public CreateVaultResponse CreateVault(string accountId, string vaultName)
        {
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        public DeleteArchiveResponse DeleteArchive(string accountId, string vaultName, string archiveId)
        {
            var request = new DeleteArchiveRequest();
            request.AccountId = accountId;
            request.VaultName = vaultName;
            request.ArchiveId = archiveId;
            return DeleteArchive(request);
        }
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        public DeleteVaultResponse DeleteVault(string accountId, string vaultName)
        {
            var request = new DeleteVaultRequest();
            request.AccountId = accountId;
            request.VaultName = vaultName;
            return DeleteVault(request);
        }
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        public DeleteVaultNotificationsResponse DeleteVaultNotifications(string accountId, string vaultName)
        {
            var request = new DeleteVaultNotificationsRequest();
            request.AccountId = accountId;
            request.VaultName = vaultName;
            return DeleteVaultNotifications(request);
        }
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        public GetJobOutputResponse GetJobOutput(string accountId, string vaultName, string jobId)
        {
            var request = new GetJobOutputRequest();
            request.AccountId = accountId;
            request.VaultName = vaultName;
            request.JobId = jobId;
            return GetJobOutput(request);
        }
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        public InitiateJobResponse InitiateJob(string accountId, string vaultName, JobParameters jobParameters)
        {
            var request = new InitiateJobRequest();
            request.AccountId = accountId;
            request.VaultName = vaultName;
            request.JobParameters = jobParameters;
            return InitiateJob(request);
        }
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        public InitiateMultipartUploadResponse InitiateMultipartUpload(string accountId, string vaultName, string archiveDescription)
        {
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        public InitiateMultipartUploadResponse InitiateMultipartUpload(string accountId, string vaultName, string archiveDescription, long partSize)
        {
            var request = new InitiateMultipartUploadRequest();
            request.AccountId = accountId;
            request.VaultName = vaultName;
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        public ListJobsResponse ListJobs(string accountId, string vaultName)
        {
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        public ListMultipartUploadsResponse ListMultipartUploads(string accountId, string vaultName)
        {
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        public ListPartsResponse ListParts(string accountId, string vaultName, string uploadId)
        {
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        public SetVaultNotificationsResponse SetVaultNotifications(string accountId, string vaultName, VaultNotificationConfig vaultNotificationConfig)
        {
            var request = new SetVaultNotificationsRequest();
            request.AccountId = accountId;
            request.VaultName = vaultName;
            request.VaultNotificationConfig = vaultNotificationConfig;
            return SetVaultNotifications(request);
        }
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        public UploadArchiveResponse UploadArchive(string accountId, string vaultName, string checksum, System.IO.Stream body)
        {
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        public UploadMultipartPartResponse UploadMultipartPart(string accountId, string vaultName, string uploadId, string checksum, System.IO.Stream body, string range)
        {
            ...
            request.Body = body;
            request.Range = range;
            return UploadMultipartPart(request);
        }
