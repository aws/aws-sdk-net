...
namespace Amazon.Glacier
{
    ...
    public partial interface IAmazonGlacier : IDisposable
    {
        ...
        /// </exception>
        AbortMultipartUploadResponse AbortMultipartUpload(string accountId, string vaultName, string uploadId);
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        CompleteMultipartUploadResponse CompleteMultipartUpload(string accountId, string vaultName, string uploadId, string archiveSize, string checksum);
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        CreateVaultResponse CreateVault(string accountId, string vaultName);
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        DeleteArchiveResponse DeleteArchive(string accountId, string vaultName, string archiveId);
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        DeleteVaultResponse DeleteVault(string accountId, string vaultName);
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        DeleteVaultNotificationsResponse DeleteVaultNotifications(string accountId, string vaultName);
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        GetJobOutputResponse GetJobOutput(string accountId, string vaultName, string jobId);
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        InitiateJobResponse InitiateJob(string accountId, string vaultName, JobParameters jobParameters);
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        InitiateMultipartUploadResponse InitiateMultipartUpload(string accountId, string vaultName, string archiveDescription);
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        InitiateMultipartUploadResponse InitiateMultipartUpload(string accountId, string vaultName, string archiveDescription, long partSize);
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        ListJobsResponse ListJobs(string accountId, string vaultName);
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        ListMultipartUploadsResponse ListMultipartUploads(string accountId, string vaultName);
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        ListPartsResponse ListParts(string accountId, string vaultName, string uploadId);
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        SetVaultNotificationsResponse SetVaultNotifications(string accountId, string vaultName, VaultNotificationConfig vaultNotificationConfig);
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        UploadArchiveResponse UploadArchive(string accountId, string vaultName, string checksum, System.IO.Stream body);
        ...
        /// Returned if the service cannot complete the request.
        /// </exception>
        UploadMultipartPartResponse UploadMultipartPart(string accountId, string vaultName, string uploadId, string checksum, System.IO.Stream body, string range);
