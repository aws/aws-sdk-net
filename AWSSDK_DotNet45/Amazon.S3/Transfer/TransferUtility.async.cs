...
namespace Amazon.S3.Transfer
{
    ...
    public partial class TransferUtility : IDisposable
    {
        ...
        private Task ExecuteAsync(Action action, CancellationToken cancellationToken)
        {
        ...
        private Task<T> ExecuteAsync<T>(Func<T> action, CancellationToken cancellationToken)
        {
            return Task<T>.Run(() =>
            {
