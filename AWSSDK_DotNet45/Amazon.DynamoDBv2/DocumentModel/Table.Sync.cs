...
namespace Amazon.DynamoDBv2.DocumentModel
{
    public partial class Table
    {
        ...
        public Document GetItem(Primitive hashKey, Primitive rangeKey = null, GetItemOperationConfig config = null)
        {
        ...
        /// <returns>Null or updated attributes, depending on config.</returns>
        /// <seealso cref="Amazon.DynamoDBv2.DocumentModel.UpdateItemOperationConfig"/>
        public Document UpdateItem(Document doc, Primitive hashKey, Primitive rangeKey = null, UpdateItemOperationConfig config = null)
        {
        ...
        /// <param name="config">Configuration to use.</param>
        /// <returns>Null or old attributes, depending on config.</returns>
        public Document DeleteItem(Primitive hashKey, Primitive rangeKey = null, DeleteItemOperationConfig config = null)
        {
