...
namespace Amazon.DynamoDBv2.DataModel
{
    ...
    partial interface IDynamoDBContext
    {
        ...
        /// </returns>
        T Load<T>(object hashKey, object rangeKey = null, DynamoDBOperationConfig operationConfig = null);
        ...
        /// <param name="operationConfig">Overriding configuration.</param>
        void Delete<T>(T value, DynamoDBOperationConfig operationConfig = null);
        ...
        void Delete<T>(object hashKey, object rangeKey = null, DynamoDBOperationConfig operationConfig = null);
