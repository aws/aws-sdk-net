...
namespace Amazon.DynamoDBv2.DataModel
{
    ...
    public partial class DynamoDBContext : IDynamoDBContext
    {
        ...
        public Task SaveAsync<T>(T value, DynamoDBOperationConfig operationConfig = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Token which can be used to cancel the task.</param>
        /// <returns>A Task that can be used to poll or wait for results, or both.</returns>
        public Task<T> LoadAsync<T>(object hashKey, object rangeKey = null, DynamoDBOperationConfig operationConfig = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Token which can be used to cancel the task.</param>
        /// <returns>A Task that can be used to poll or wait for results, or both.</returns>
        public Task<T> LoadAsync<T>(T keyObject, DynamoDBOperationConfig operationConfig = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Token which can be used to cancel the task.</param>
        /// <returns>A Task that can be used to poll or wait for results, or both.</returns>
        public Task DeleteAsync<T>(T value, DynamoDBOperationConfig operationConfig = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Token which can be used to cancel the task.</param>
        /// <returns>A Task that can be used to poll or wait for results, or both.</returns>
        public Task DeleteAsync<T>(object hashKey, object rangeKey = null, DynamoDBOperationConfig operationConfig = null, CancellationToken cancellationToken = default(CancellationToken))
        {
