...
namespace Amazon.DynamoDBv2.DataModel
{
    ...
    partial interface IDynamoDBContext
    {
        ...
        Task SaveAsync<T>(T value, DynamoDBOperationConfig operationConfig = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Token which can be used to cancel the task.</param>
        /// <returns>A Task that can be used to poll or wait for results, or both.</returns>
        Task<T> LoadAsync<T>(object hashKey, object rangeKey = null, DynamoDBOperationConfig operationConfig = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Token which can be used to cancel the task.</param>
        /// <returns>A Task that can be used to poll or wait for results, or both.</returns>
        Task<T> LoadAsync<T>(T keyObject, DynamoDBOperationConfig operationConfig = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Token which can be used to cancel the task.</param>
        /// <returns>A Task that can be used to poll or wait for results, or both.</returns>
        Task DeleteAsync<T>(T value, DynamoDBOperationConfig operationConfig = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Token which can be used to cancel the task.</param>
        /// <returns>A Task that can be used to poll or wait for results, or both.</returns>
        Task DeleteAsync<T>(object hashKey, object rangeKey = null, DynamoDBOperationConfig operationConfig = null, CancellationToken cancellationToken = default(CancellationToken));
