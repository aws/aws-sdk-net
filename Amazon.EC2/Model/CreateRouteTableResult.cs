...
namespace Amazon.EC2.Model
{
    ...
    {    
        private RouteTable routeTableField;

        /// <summary>
        /// Gets and sets the RouteTable property.
        /// Information about the newly created route table.
        /// </summary>
        [XmlElementAttribute(ElementName = "RouteTable")]
        public RouteTable RouteTable
        {
            get { return this.routeTableField; }
            set { this.routeTableField = value; }
        }
        ...
        public bool IsSetRouteTable()
        {
            return this.routeTableField != null;
        }
