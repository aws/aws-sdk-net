...
namespace Amazon.EC2.Model
{
    ...
    public class DescribeSpotPriceHistoryResult
    {
        ...
        /// <summary>
        /// Sets the SpotPriceHistory property
        /// </summary>
        /// <param name="list">List of data points specifying the Spot Price history.</param>
        /// <returns>this instance</returns>
        public DescribeSpotPriceHistoryResult WithSpotPriceHistory(params SpotPriceHistory[] list)
        {
            foreach (SpotPriceHistory item in list)
            {
                SpotPriceHistory.Add(item);
            }
            return this;
        }
