...
namespace Amazon.EC2.Model
{
    ...
    {    
        private InternetGateway internetGatewayField;

        /// <summary>
        /// Gets and sets the InternetGateway property.
        /// Information about the Internet gateway
        /// </summary>
        [XmlElementAttribute(ElementName = "InternetGateway")]
        public InternetGateway InternetGateway
        {
            get { return this.internetGatewayField; }
            set { this.internetGatewayField = value; }
        }
        ...
        public bool IsSetInternetGateway()
        {
            return this.internetGatewayField != null;
        }
