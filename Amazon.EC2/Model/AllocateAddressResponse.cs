...
namespace Amazon.EC2.Model
{
    ...
    public class AllocateAddressResponse
    {
        ...
        private AllocateAddressResult allocateAddressResultField;
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "AllocateAddressResult")]
        public AllocateAddressResult AllocateAddressResult
        {
            get { return this.allocateAddressResultField ; }
            set { this.allocateAddressResultField = value; }
        }

        /// <summary>
        /// Sets the AllocateAddressResult property
        /// </summary>
        /// <param name="allocateAddressResult">Allocate Address Result</param>
        /// <returns>this instance</returns>
        public AllocateAddressResponse WithAllocateAddressResult(AllocateAddressResult allocateAddressResult)
        {
