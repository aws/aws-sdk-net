...
namespace Amazon.EC2.Model
{
    ...
    public class CreateSubnetResponse
    {
        ...
        public CreateSubnetResponse WithResponseMetadata(ResponseMetadata responseMetadata)
        {
        ...
        /// <summary>
        /// Sets the CreateSubnetResult property
        /// </summary>
        /// <param name="createSubnetResult">Create Subnet Result</param>
        /// <returns>this instance</returns>
        public CreateSubnetResponse WithCreateSubnetResult(CreateSubnetResult createSubnetResult)
        {
