...
namespace Amazon.EC2.Model
{
    ...
    public class DescribeSecurityGroupsResponse
    {
        ...
        /// <summary>
        /// Sets the DescribeSecurityGroupsResult property
        /// </summary>
        /// <param name="describeSecurityGroupsResult">Describe Security Groups Result</param>
        /// <returns>this instance</returns>
        public DescribeSecurityGroupsResponse WithDescribeSecurityGroupsResult(DescribeSecurityGroupsResult describeSecurityGroupsResult)
        {
