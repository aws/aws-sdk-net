...
namespace Amazon.EC2.Model
{
    ...
    public class RunInstancesResponse
    {
        ...
        public RunInstancesResponse WithResponseMetadata(ResponseMetadata responseMetadata)
        {
        ...
        /// <summary>
        /// Sets the RunInstancesResult property
        /// </summary>
        /// <param name="runInstancesResult">Run Instances Result</param>
        /// <returns>this instance</returns>
        public RunInstancesResponse WithRunInstancesResult(RunInstancesResult runInstancesResult)
        {
