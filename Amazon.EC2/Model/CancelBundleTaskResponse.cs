...
namespace Amazon.EC2.Model
{
    ...
    public class CancelBundleTaskResponse
    {
        ...
        /// <summary>
        /// Sets the CancelBundleTaskResult property
        /// </summary>
        /// <param name="cancelBundleTaskResult">Cancel Bundle Task Result</param>
        /// <returns>this instance</returns>
        public CancelBundleTaskResponse WithCancelBundleTaskResult(CancelBundleTaskResult cancelBundleTaskResult)
        {
