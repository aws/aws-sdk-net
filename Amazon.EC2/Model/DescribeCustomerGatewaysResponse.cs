...
namespace Amazon.EC2.Model
{
    ...
    public class DescribeCustomerGatewaysResponse
    {
        ...
        public DescribeCustomerGatewaysResponse WithResponseMetadata(ResponseMetadata responseMetadata)
        {
        ...
        /// <summary>
        /// Sets the DescribeCustomerGatewaysResult property
        /// </summary>
        /// <param name="describeCustomerGatewaysResult">Describe Customer Gateways Result</param>
        /// <returns>this instance</returns>
        public DescribeCustomerGatewaysResponse WithDescribeCustomerGatewaysResult(DescribeCustomerGatewaysResult describeCustomerGatewaysResult)
        {
