...
namespace Amazon.EC2.Model
{
    ...
    public class DescribeVpcsResponse
    {
        ...
        public DescribeVpcsResponse WithResponseMetadata(ResponseMetadata responseMetadata)
        {
        ...
        /// <summary>
        /// Sets the DescribeVpcsResult property
        /// </summary>
        /// <param name="describeVpcsResult">Describe Vpcs Result</param>
        /// <returns>this instance</returns>
        public DescribeVpcsResponse WithDescribeVpcsResult(DescribeVpcsResult describeVpcsResult)
        {
