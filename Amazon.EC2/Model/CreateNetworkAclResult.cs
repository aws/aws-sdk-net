...
namespace Amazon.EC2.Model
{
    ...
    {    
        private NetworkAcl networkAclField;

        /// <summary>
        /// Gets and sets the NetworkAcl property.
        /// Information about the new network ACL.
        /// </summary>
        [XmlElementAttribute(ElementName = "NetworkAcl")]
        public NetworkAcl NetworkAcl
        {
            get { return this.networkAclField; }
            set { this.networkAclField = value; }
        }
        ...
        public bool IsSetNetworkAcl()
        {
            return this.networkAclField != null;
        }
