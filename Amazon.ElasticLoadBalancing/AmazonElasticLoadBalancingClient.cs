...
namespace Amazon.ElasticLoadBalancing
{
    ...
    public class AmazonElasticLoadBalancingClient : AmazonWebServiceClient, AmazonElasticLoadBalancing
    {
        ...
        {
            IRequest<DescribeLoadBalancerPoliciesRequest> request = new DescribeLoadBalancerPoliciesRequestMarshaller().Marshall(describeLoadBalancerPoliciesRequest);
            DescribeLoadBalancerPoliciesResponse response = Invoke<DescribeLoadBalancerPoliciesRequest, DescribeLoadBalancerPoliciesResponse> (request, this.signer, DescribeLoadBalancerPoliciesResponseUnmarshaller.GetInstance());
            return response;
        }
        ...
        {
            IRequest<DescribeLoadBalancerPolicyTypesRequest> request = new DescribeLoadBalancerPolicyTypesRequestMarshaller().Marshall(describeLoadBalancerPolicyTypesRequest);
            DescribeLoadBalancerPolicyTypesResponse response = Invoke<DescribeLoadBalancerPolicyTypesRequest, DescribeLoadBalancerPolicyTypesResponse> (request, this.signer, DescribeLoadBalancerPolicyTypesResponseUnmarshaller.GetInstance());
            return response;
        }
        ...
        {
            IRequest<AttachLoadBalancerToSubnetsRequest> request = new AttachLoadBalancerToSubnetsRequestMarshaller().Marshall(attachLoadBalancerToSubnetsRequest);
            AttachLoadBalancerToSubnetsResponse response = Invoke<AttachLoadBalancerToSubnetsRequest, AttachLoadBalancerToSubnetsResponse> (request, this.signer, AttachLoadBalancerToSubnetsResponseUnmarshaller.GetInstance());
            return response;
        }
        ...
        {
            IRequest<CreateLoadBalancerPolicyRequest> request = new CreateLoadBalancerPolicyRequestMarshaller().Marshall(createLoadBalancerPolicyRequest);
            CreateLoadBalancerPolicyResponse response = Invoke<CreateLoadBalancerPolicyRequest, CreateLoadBalancerPolicyResponse> (request, this.signer, CreateLoadBalancerPolicyResponseUnmarshaller.GetInstance());
            return response;
        }
        ...
        {
            IRequest<SetLoadBalancerPoliciesForBackendServerRequest> request = new SetLoadBalancerPoliciesForBackendServerRequestMarshaller().Marshall(setLoadBalancerPoliciesForBackendServerRequest);
            SetLoadBalancerPoliciesForBackendServerResponse response = Invoke<SetLoadBalancerPoliciesForBackendServerRequest, SetLoadBalancerPoliciesForBackendServerResponse> (request, this.signer, SetLoadBalancerPoliciesForBackendServerResponseUnmarshaller.GetInstance());
            return response;
        }
        ...
        {
            IRequest<ApplySecurityGroupsToLoadBalancerRequest> request = new ApplySecurityGroupsToLoadBalancerRequestMarshaller().Marshall(applySecurityGroupsToLoadBalancerRequest);
            ApplySecurityGroupsToLoadBalancerResponse response = Invoke<ApplySecurityGroupsToLoadBalancerRequest, ApplySecurityGroupsToLoadBalancerResponse> (request, this.signer, ApplySecurityGroupsToLoadBalancerResponseUnmarshaller.GetInstance());
            return response;
        }
