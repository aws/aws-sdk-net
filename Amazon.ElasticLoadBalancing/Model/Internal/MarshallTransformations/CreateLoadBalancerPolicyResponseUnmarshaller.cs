...
namespace Amazon.ElasticLoadBalancing.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class CreateLoadBalancerPolicyResponseUnmarshaller : IResponseUnmarshaller<CreateLoadBalancerPolicyResponse, UnmarshallerContext> {

        public CreateLoadBalancerPolicyResponse Unmarshall(UnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)
                {
                    ...
                    {
                        response.CreateLoadBalancerPolicyResult = CreateLoadBalancerPolicyResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static CreateLoadBalancerPolicyResponseUnmarshaller instance;
