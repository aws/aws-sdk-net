...
namespace Amazon.ElasticLoadBalancing.Model
{
    ...
    public class EnableAvailabilityZonesForLoadBalancerResult
    {
        ...
        /// </summary>
        /// <param name="list">Updated list of Availability Zones for the LoadBalancer.</param>
        /// <returns>this instance</returns>
        public EnableAvailabilityZonesForLoadBalancerResult WithAvailabilityZones(params string[] list)
        {
