...
namespace Amazon.ElasticLoadBalancing.Model
{
    ...
    public class DeleteLoadBalancerResponse
    {
        ...
        /// <summary>
        /// Sets the DeleteLoadBalancerResult property
        /// </summary>
        /// <param name="deleteLoadBalancerResult">No data returned.</param>
        /// <returns>this instance</returns>
        public DeleteLoadBalancerResponse WithDeleteLoadBalancerResult(DeleteLoadBalancerResult deleteLoadBalancerResult)
        {
            this.deleteLoadBalancerResultField = deleteLoadBalancerResult;
            return this;
        }
        ...
        /// <returns>this instance</returns>
        public DeleteLoadBalancerResponse WithResponseMetadata(ResponseMetadata responseMetadata)
        {
