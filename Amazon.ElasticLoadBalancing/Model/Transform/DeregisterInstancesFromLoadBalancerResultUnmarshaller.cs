...
namespace Amazon.ElasticLoadBalancing.Model.Transform
{
    ...
    internal class DeregisterInstancesFromLoadBalancerResultUnmarshaller : IUnmarshaller<DeregisterInstancesFromLoadBalancerResult, UnmarshallerContext> 
    {
        ...
        private static DeregisterInstancesFromLoadBalancerResultUnmarshaller instance;

        public static DeregisterInstancesFromLoadBalancerResultUnmarshaller GetInstance() 
        {
            if (instance == null) 
               instance = new DeregisterInstancesFromLoadBalancerResultUnmarshaller();
