...
namespace Amazon.ElasticLoadBalancing.Model.Transform
{
    ...
    /// </summary>
    internal class DeleteLoadBalancerPolicyResponseUnmarshaller : IResponseUnmarshaller<DeleteLoadBalancerPolicyResponse, UnmarshallerContext> {

        public DeleteLoadBalancerPolicyResponse Unmarshall(UnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)
                {
                    ...
                    {
                        response.DeleteLoadBalancerPolicyResult = DeleteLoadBalancerPolicyResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
