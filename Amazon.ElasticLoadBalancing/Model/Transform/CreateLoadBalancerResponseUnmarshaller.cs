...
namespace Amazon.ElasticLoadBalancing.Model.Transform
{
    ...
    /// </summary>
    internal class CreateLoadBalancerResponseUnmarshaller : IResponseUnmarshaller<CreateLoadBalancerResponse, UnmarshallerContext> {

        public CreateLoadBalancerResponse Unmarshall(UnmarshallerContext context) 
        {
