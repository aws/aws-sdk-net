...
foreach ($nuspec in $nuspecs) 
{
    ...
    try
    {
        $command = "$OriginalDirectory\..\sdk\.nuget\NuGet.exe pack $nuspec -verbosity detailed -Symbols -SymbolPackageFormat snupkg -OutputDirectory $OutputDirectory -BasePath ."
