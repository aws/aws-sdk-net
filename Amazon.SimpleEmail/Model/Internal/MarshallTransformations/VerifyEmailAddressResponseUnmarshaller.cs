...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class VerifyEmailAddressResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static VerifyEmailAddressResponseUnmarshaller instance;

        public static VerifyEmailAddressResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new VerifyEmailAddressResponseUnmarshaller();
            }
            return instance;
        }
