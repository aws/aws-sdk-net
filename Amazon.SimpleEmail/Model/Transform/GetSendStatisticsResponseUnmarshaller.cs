...
namespace Amazon.SimpleEmail.Model.Transform
{
    ...
    /// </summary>
    internal class GetSendStatisticsResponseUnmarshaller : IResponseUnmarshaller<GetSendStatisticsResponse, UnmarshallerContext> {

        public GetSendStatisticsResponse Unmarshall(UnmarshallerContext context) 
        {
