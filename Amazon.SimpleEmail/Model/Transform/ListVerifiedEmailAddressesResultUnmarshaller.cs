...
namespace Amazon.SimpleEmail.Model.Transform
{
     ...
     /// </summary>
    internal class ListVerifiedEmailAddressesResultUnmarshaller : IUnmarshaller<ListVerifiedEmailAddressesResult, UnmarshallerContext> 
    {
        public ListVerifiedEmailAddressesResult Unmarshall(UnmarshallerContext context) 
        {
