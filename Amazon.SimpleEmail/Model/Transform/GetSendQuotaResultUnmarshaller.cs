...
namespace Amazon.SimpleEmail.Model.Transform
{
     ...
     /// </summary>
    internal class GetSendQuotaResultUnmarshaller : IUnmarshaller<GetSendQuotaResult, UnmarshallerContext> 
    {
        public GetSendQuotaResult Unmarshall(UnmarshallerContext context) 
        {
