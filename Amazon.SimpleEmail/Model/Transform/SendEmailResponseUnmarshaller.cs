...
namespace Amazon.SimpleEmail.Model.Transform
{
    ...
    /// </summary>
    internal class SendEmailResponseUnmarshaller : IResponseUnmarshaller<SendEmailResponse, UnmarshallerContext> {

        public SendEmailResponse Unmarshall(UnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)
                {
                    ...
                    {
                        response.SendEmailResult = SendEmailResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static SendEmailResponseUnmarshaller instance;

        public static SendEmailResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new SendEmailResponseUnmarshaller();
            }
            return instance;
        }
