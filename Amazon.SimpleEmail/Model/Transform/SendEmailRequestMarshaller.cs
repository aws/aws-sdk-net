...
namespace Amazon.SimpleEmail.Model.Transform
{
    ...
    /// </summary>       
    public class SendEmailRequestMarshaller : IMarshaller<IRequest<SendEmailRequest>, SendEmailRequest> 
    {

        public IRequest<SendEmailRequest> Marshall(SendEmailRequest sendEmailRequest) 
        {
            IRequest<SendEmailRequest> request = new DefaultRequest<SendEmailRequest>(sendEmailRequest, "AmazonSimpleEmailService");
