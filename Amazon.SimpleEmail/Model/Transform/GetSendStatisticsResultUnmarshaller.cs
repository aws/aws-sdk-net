...
namespace Amazon.SimpleEmail.Model.Transform
{
     ...
     /// </summary>
    internal class GetSendStatisticsResultUnmarshaller : IUnmarshaller<GetSendStatisticsResult, UnmarshallerContext> 
    {
        public GetSendStatisticsResult Unmarshall(UnmarshallerContext context) 
        {
