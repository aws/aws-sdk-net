...
namespace Amazon.SimpleEmail.Model.Transform
{
    ...
    /// </summary>
    internal class VerifyEmailAddressResponseUnmarshaller : IResponseUnmarshaller<VerifyEmailAddressResponse, UnmarshallerContext> {

        public VerifyEmailAddressResponse Unmarshall(UnmarshallerContext context) 
        {
