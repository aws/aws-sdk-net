...
namespace Amazon.SimpleEmail.Model.Transform
{
    ...
    /// </summary>
    internal class GetSendQuotaResponseUnmarshaller : IResponseUnmarshaller<GetSendQuotaResponse, UnmarshallerContext> {

        public GetSendQuotaResponse Unmarshall(UnmarshallerContext context) 
        {
