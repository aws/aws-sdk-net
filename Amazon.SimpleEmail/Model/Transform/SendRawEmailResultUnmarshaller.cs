...
namespace Amazon.SimpleEmail.Model.Transform
{
     ...
     /// </summary>
    internal class SendRawEmailResultUnmarshaller : IUnmarshaller<SendRawEmailResult, UnmarshallerContext> 
    {
        public SendRawEmailResult Unmarshall(UnmarshallerContext context) 
        {
