...
namespace Amazon.SimpleEmail.Model.Transform
{
    ...
    /// </summary>       
    public class SendRawEmailRequestMarshaller : IMarshaller<IRequest<SendRawEmailRequest>, SendRawEmailRequest> 
    {

        public IRequest<SendRawEmailRequest> Marshall(SendRawEmailRequest sendRawEmailRequest) 
        {
            IRequest<SendRawEmailRequest> request = new DefaultRequest<SendRawEmailRequest>(sendRawEmailRequest, "AmazonSimpleEmailService");
