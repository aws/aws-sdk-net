...
namespace Amazon.SimpleEmail.Model.Transform
{
    ...
    /// </summary>
    internal class DeleteVerifiedEmailAddressResponseUnmarshaller : IResponseUnmarshaller<DeleteVerifiedEmailAddressResponse, UnmarshallerContext> {

        public DeleteVerifiedEmailAddressResponse Unmarshall(UnmarshallerContext context) 
        {
