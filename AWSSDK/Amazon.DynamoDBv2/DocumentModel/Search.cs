...
namespace Amazon.DynamoDBv2.DocumentModel
{
    ...
    public class Search
    {
        ...
        private void SplitQueryFilter(Filter filter, Table targetTable, string indexName, out Dictionary<string, Condition> keyConditions, out Dictionary<string, Condition> filterConditions)
        {
