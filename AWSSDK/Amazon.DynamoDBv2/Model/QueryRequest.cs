...
namespace Amazon.DynamoDBv2.Model
{
    ...
    public class QueryRequest : AmazonWebServiceRequest
    {
        ...
        /// </summary>
        /// <param name="pairs">The pairs to be added to the QueryFilter dictionary.</param>
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public QueryRequest WithQueryFilter(params KeyValuePair<string, Condition>[] pairs)
        {
            foreach (KeyValuePair<string, Condition> pair in pairs)
            {
                this.QueryFilter[pair.Key] = pair.Value;
            }
