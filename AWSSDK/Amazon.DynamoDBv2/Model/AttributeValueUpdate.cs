...
namespace Amazon.DynamoDBv2.Model
{
    ...
    public class AttributeValueUpdate
    {
        ...
        /// primary key, and then adds the attribute. </li> <li> <c>DELETE</c>-Nothing happens; there is no attribute to delete. </li> <li>
        /// <c>ADD</c>-Amazon DynamoDB creates an item with the supplied primary key and number (or set of numbers) for the attribute value. The only
        /// data types allowed are number and number set; no other data types can be specified. </li> </ul>
        ///  
        /// <para>
        /// <b>Constraints:</b>
