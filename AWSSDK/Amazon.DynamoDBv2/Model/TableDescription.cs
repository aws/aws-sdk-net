...
namespace Amazon.DynamoDBv2.Model
{
    ...
    public class TableDescription
    {
        ...
        /// <summary>
        /// The total size of the specified table, in bytes. Amazon DynamoDB updates this value approximately every six hours. Recent changes might not
        ...
        /// <summary>
        /// The number of items in the specified table. Amazon DynamoDB updates this value approximately every six hours. Recent changes might not be
        ...
        /// </li> <li> <i>IndexSizeBytes</i> - Represents the total size of the index, in bytes. Amazon DynamoDB updates this value approximately every
        /// six hours. Recent changes might not be reflected in this value.</li> <li> <i>ItemCount</i> - Represents the number of items in the index.
        /// Amazon DynamoDB updates this value approximately every six hours. Recent changes might not be reflected in this value. </li> </ul> If the
        /// table is in the <c>DELETING</c> state, no information about indexes will be returned.
        ///  
        /// </summary>
        ...
        /// <i>IndexName</i> - The name of the global secondary index. </li> <li> <i>KeySchema</i> - Specifies the complete index key schema. The
        /// attribute names in the key schema must be between 1 and 255 characters (inclusive). The key schema must begin with the same hash key
        /// attribute as the table. </li> <li> <i>Projection</i> - Specifies attributes that are copied (projected) from the table into the index. These
        /// are in addition to the primary key attributes and index key attributes, which are automatically projected. Each attribute specification is
        /// composed of: <ul> <li> <i>ProjectionType</i> - One of the following: <ul> <li> <c>KEYS_ONLY</c> - Only the index and primary keys are
        ...
        /// </ul> </li> <li> <i>NonKeyAttributes</i> - A list of one or more non-key attribute names that are projected into the secondary index. The
        /// total count of attributes specified in <i>NonKeyAttributes</i>, summed across all of the secondary indexes, must not exceed 20. If you
        ...
        /// <li> <i>ProvisionedThroughput</i> - The provisioned throughput settings for the global secondary index, consisting of read and write
        /// capacity units, along with data about increases and decreases. </li> <li> <i>IndexSizeBytes</i> - The total size of the global secondary
        /// index, in bytes. Amazon DynamoDB updates this value approximately every six hours. Recent changes might not be reflected in this value.
        /// </li> <li> <i>ItemCount</i> - The number of items in the global secondary index. Amazon DynamoDB updates this value approximately every six
        /// hours. Recent changes might not be reflected in this value. </li> </ul> If the table is in the <c>DELETING</c> state, no information about
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public TableDescription WithGlobalSecondaryIndexes(params GlobalSecondaryIndexDescription[] globalSecondaryIndexes)
        {
            foreach (GlobalSecondaryIndexDescription element in globalSecondaryIndexes)
            {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public TableDescription WithGlobalSecondaryIndexes(IEnumerable<GlobalSecondaryIndexDescription> globalSecondaryIndexes)
        {
            foreach (GlobalSecondaryIndexDescription element in globalSecondaryIndexes)
            {
                this.globalSecondaryIndexes.Add(element);
