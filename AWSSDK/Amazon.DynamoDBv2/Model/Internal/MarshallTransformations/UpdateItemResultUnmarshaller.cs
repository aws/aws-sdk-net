        ...
        public UpdateItemResult Unmarshall(JsonUnmarshallerContext context)
        {
          ...
          updateItemResult.Attributes = null;
            ...
            while (context.Read())
            {
              ...
              {
                updateItemResult.ConsumedCapacity = ConsumedCapacityUnmarshaller.GetInstance().Unmarshall(context);
                continue;
              }
  
              if (context.TestExpression("ItemCollectionMetrics", targetDepth))
              {
                updateItemResult.ItemCollectionMetrics = ItemCollectionMetricsUnmarshaller.GetInstance().Unmarshall(context);
                continue;
              }
