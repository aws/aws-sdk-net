        ...
        public DeleteItemResult Unmarshall(JsonUnmarshallerContext context)
        {
          ...
          deleteItemResult.Attributes = null;
            ...
            while (context.Read())
            {
              ...
              {
                deleteItemResult.ConsumedCapacity = ConsumedCapacityUnmarshaller.GetInstance().Unmarshall(context);
                continue;
              }
  
              if (context.TestExpression("ItemCollectionMetrics", targetDepth))
              {
                deleteItemResult.ItemCollectionMetrics = ItemCollectionMetricsUnmarshaller.GetInstance().Unmarshall(context);
                continue;
              }
