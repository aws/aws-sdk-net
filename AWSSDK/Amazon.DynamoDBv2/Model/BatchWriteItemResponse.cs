...
namespace Amazon.DynamoDBv2.Model
{
    ...
    /// </summary>
    public class BatchWriteItemResponse : AmazonWebServiceResponse
    {
        ...
        public BatchWriteItemResult BatchWriteItemResult
        {
            get
            {
                if(this.batchWriteItemResult == null)
                {
                    this.batchWriteItemResult = new BatchWriteItemResult();
                }

                return this.batchWriteItemResult;
            }
            set { this.batchWriteItemResult = value; }
        }
    }
}
