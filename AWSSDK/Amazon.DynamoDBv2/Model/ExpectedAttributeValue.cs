...
namespace Amazon.DynamoDBv2.Model
{
    ...
    public partial class ExpectedAttributeValue
    {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public ExpectedAttributeValue WithAttributeValueList(params AttributeValue[] attributeValueList)
        {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public ExpectedAttributeValue WithAttributeValueList(IEnumerable<AttributeValue> attributeValueList)
        {
            foreach (AttributeValue element in attributeValueList)
            {
                this.attributeValueList.Add(element);
