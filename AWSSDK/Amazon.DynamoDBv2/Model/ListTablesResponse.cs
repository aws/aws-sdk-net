...
namespace Amazon.DynamoDBv2.Model
{
    ...
    {
        private ListTablesResult listTablesResult;
        ...
        public ListTablesResult ListTablesResult
        {
            get
            {
                if(this.listTablesResult == null)
                {
                    this.listTablesResult = new ListTablesResult();
                }

                return this.listTablesResult;
            }
            set { this.listTablesResult = value; }
        }
    }
}
