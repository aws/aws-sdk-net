...
namespace Amazon.DynamoDBv2.Model
{
    ...
    /// <ul>
    /// <li> <para>For a <i>Query</i> operation, the condition specifies the key attributes to use when querying a table or an index.</para> </li>
    ...
    public class Condition
    {
        ...
        /// <summary>
        /// One or more values to evaluate against the supplied attribute. This list contains exactly one value, except for a <c>BETWEEN</c> or
        /// <c>IN</c> comparison, in which case the list contains two values. <note> For type Number, value comparisons are numeric. String value
        ...
        /// <summary>
        /// A comparator for evaluating attributes. For example, equals, greater than, less than, etc. Valid comparison operators for Query: <c>EQ | LE
        /// | LT | GE | GT | BEGINS_WITH | BETWEEN</c> Valid comparison operators for Scan: <c>EQ | NE | LE | LT | GE | GT | NOT_NULL | NULL | CONTAINS
        /// | NOT_CONTAINS | BEGINS_WITH | IN | BETWEEN</c> For information on specifying data types in JSON, see <a
