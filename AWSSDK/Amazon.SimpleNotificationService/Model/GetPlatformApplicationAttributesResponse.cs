...
namespace Amazon.SimpleNotificationService.Model
{
    ...
    public class GetPlatformApplicationAttributesResponse
    {
        ...
        private GetPlatformApplicationAttributesResult result;

        
        private ResponseMetadata responseMetadata;

        /// <summary>
        /// Gets or sets the get platform application attributes result.
        /// </summary>
        /// <value>
        /// The result of the GetPlatformApplicationAttributes request.
        /// </value>
        [XmlElement(ElementName = "GetPlatformApplicationAttributesResult")]
        ...
        /// <summary>
        /// Determines whether the <see cref="GetPlatformApplicationAttributesResult"/> property is set.
        /// </summary>
        /// <returns>
        ///   <c>true</c> if the result field of the request is set; otherwise, <c>false</c>.
        /// </returns>
        public bool IsSetGetPlatformApplicationAttributesResult()
        {
