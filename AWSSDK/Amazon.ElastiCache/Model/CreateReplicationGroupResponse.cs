...
namespace Amazon.ElastiCache.Model
{
    ...
    {
        private CreateReplicationGroupResult createReplicationGroupResult;
        ...
        public CreateReplicationGroupResult CreateReplicationGroupResult
        {
            get
            {
                if(this.createReplicationGroupResult == null)
                {
                    this.createReplicationGroupResult = new CreateReplicationGroupResult();
                }

                return this.createReplicationGroupResult;
            }
            set { this.createReplicationGroupResult = value; }
        }
    }
}
