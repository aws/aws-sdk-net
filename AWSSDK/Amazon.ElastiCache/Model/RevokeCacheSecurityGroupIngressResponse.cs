...
namespace Amazon.ElastiCache.Model
{
    ...
    /// </summary>
    public class RevokeCacheSecurityGroupIngressResponse : AmazonWebServiceResponse
    {
        private RevokeCacheSecurityGroupIngressResult revokeCacheSecurityGroupIngressResult;
