...
namespace Amazon.ElastiCache.Model
{
    ...
    public class DescribeReplicationGroupsRequest : AmazonWebServiceRequest
    {
        ...
        /// <summary>
        /// The identifier for the replication group to be described. This parameter is not case sensitive. If you do not specify this parameter,
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public DescribeReplicationGroupsRequest WithMaxRecords(int maxRecords)
        {
