...
{
    /// <summary>
    ///    Result Unmarshaller for CreateSnapshot operation
    /// </summary>
    internal class CreateSnapshotResultUnmarshaller : IUnmarshaller<CreateSnapshotResult, XmlUnmarshallerContext> {

        public CreateSnapshotResult Unmarshall(XmlUnmarshallerContext context) 
        {
