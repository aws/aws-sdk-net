...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DeleteSnapshotResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)
                {
                    ...
                    {
                        response.DeleteSnapshotResult = DeleteSnapshotResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
