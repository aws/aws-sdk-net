...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class ModifyCacheClusterResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)
                {
                    ...
                    {
                        response.ModifyCacheClusterResult = ModifyCacheClusterResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static ModifyCacheClusterResponseUnmarshaller instance;

        public static ModifyCacheClusterResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new ModifyCacheClusterResponseUnmarshaller();
            }
            return instance;
        }
