...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
     ...
     /// </summary>
    internal class DescribeCacheParametersResultUnmarshaller : IUnmarshaller<DescribeCacheParametersResult, XmlUnmarshallerContext>, IUnmarshaller<DescribeCacheParametersResult, JsonUnmarshallerContext> 
    {
        public DescribeCacheParametersResult Unmarshall(XmlUnmarshallerContext context) 
        {
        ...
        public DescribeCacheParametersResult Unmarshall(JsonUnmarshallerContext context) 
        {
            return null;
        }
