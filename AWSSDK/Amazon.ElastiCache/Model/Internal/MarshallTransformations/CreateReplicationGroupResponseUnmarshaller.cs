...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class CreateReplicationGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)
                {
                    ...
                    {
                        response.CreateReplicationGroupResult = CreateReplicationGroupResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static CreateReplicationGroupResponseUnmarshaller instance;
