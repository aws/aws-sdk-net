...
namespace Amazon.ElastiCache.Model
{
    ...
    {
        private DeleteSnapshotResult deleteSnapshotResult;
        ...
        public DeleteSnapshotResult DeleteSnapshotResult
        {
            get
            {
                if(this.deleteSnapshotResult == null)
                {
                    this.deleteSnapshotResult = new DeleteSnapshotResult();
                }

                return this.deleteSnapshotResult;
            }
            set { this.deleteSnapshotResult = value; }
        }
    }
}
