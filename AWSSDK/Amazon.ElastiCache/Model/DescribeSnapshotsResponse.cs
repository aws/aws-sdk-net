...
namespace Amazon.ElastiCache.Model
{
    ...
    {
        private DescribeSnapshotsResult describeSnapshotsResult;
        ...
        public DescribeSnapshotsResult DescribeSnapshotsResult
        {
            get
            {
                if(this.describeSnapshotsResult == null)
                {
                    this.describeSnapshotsResult = new DescribeSnapshotsResult();
                }

                return this.describeSnapshotsResult;
            }
            set { this.describeSnapshotsResult = value; }
        }
    }
}
