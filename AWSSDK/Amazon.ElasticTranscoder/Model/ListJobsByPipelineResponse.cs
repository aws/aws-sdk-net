...
namespace Amazon.ElasticTranscoder.Model
{
    ...
    {
        private ListJobsByPipelineResult listJobsByPipelineResult;
        ...
        public ListJobsByPipelineResult ListJobsByPipelineResult
        {
            get
            {
                if(this.listJobsByPipelineResult == null)
                {
                    this.listJobsByPipelineResult = new ListJobsByPipelineResult();
                }

                return this.listJobsByPipelineResult;
            }
            set { this.listJobsByPipelineResult = value; }
        }
    }
}
