 ...
 */
    ...
    {
      /// <summary>
      /// CreateJobResultUnmarshaller
      /// </summary>
      internal class CreateJobResultUnmarshaller : IUnmarshaller<CreateJobResult, XmlUnmarshallerContext>, IUnmarshaller<CreateJobResult, JsonUnmarshallerContext>
      {
        ...
        public CreateJobResult Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.Read())
            {
              ...
              {
                createJobResult.Job = JobUnmarshaller.GetInstance().Unmarshall(context);
                continue;
              }
