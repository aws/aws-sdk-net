...
{
    /// <summary>
    /// Response Unmarshaller for ReadJob Object
    /// </summary>  
    public class ReadJobResultUnmarshaller : IUnmarshaller<ReadJobResult, XmlUnmarshallerContext>, IUnmarshaller<ReadJobResult, JsonUnmarshallerContext>
    {
        ...
        public ReadJobResult Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            var unmarshalledObject = new ReadJobResult();
