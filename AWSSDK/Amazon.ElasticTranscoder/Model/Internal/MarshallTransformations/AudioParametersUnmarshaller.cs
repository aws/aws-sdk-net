...
namespace Amazon.ElasticTranscoder.Model.Internal.MarshallTransformations
{
    ...
    public class AudioParametersUnmarshaller : IUnmarshaller<AudioParameters, XmlUnmarshallerContext>, IUnmarshaller<AudioParameters, JsonUnmarshallerContext>
    {
        ...
        public AudioParameters Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            var unmarshalledObject = new AudioParameters();
            ...
            while (context.Read())
            {
                if ((context.IsKey) && (context.CurrentDepth == targetDepth))
                {
                    ...
                    {
                        unmarshalledObject.Channels = StringUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                    ...
                    {
                        unmarshalledObject.CodecOptions = AudioCodecOptionsUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("SampleRate", targetDepth))
                    {
                        unmarshalledObject.SampleRate = StringUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                }
