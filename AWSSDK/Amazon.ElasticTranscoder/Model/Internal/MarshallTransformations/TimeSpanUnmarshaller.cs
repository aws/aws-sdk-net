...
namespace Amazon.ElasticTranscoder.Model.Internal.MarshallTransformations
{
    ...
    public class TimeSpanUnmarshaller : IUnmarshaller<TimeSpan, XmlUnmarshallerContext>, IUnmarshaller<TimeSpan, JsonUnmarshallerContext>
    {
        ...
        public TimeSpan Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            var unmarshalledObject = new TimeSpan();
            ...
            while (context.Read())
            {
                if ((context.IsKey) && (context.CurrentDepth == targetDepth))
                {
                    ...
                    {
                        unmarshalledObject.Duration = StringUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("StartTime", targetDepth))
                    {
                        unmarshalledObject.StartTime = StringUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                }
