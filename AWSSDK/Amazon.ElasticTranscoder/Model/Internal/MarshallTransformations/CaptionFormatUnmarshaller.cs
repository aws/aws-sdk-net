...
namespace Amazon.ElasticTranscoder.Model.Internal.MarshallTransformations
{
    ...
    public class CaptionFormatUnmarshaller : IUnmarshaller<CaptionFormat, XmlUnmarshallerContext>, IUnmarshaller<CaptionFormat, JsonUnmarshallerContext>
    {
        ...
        public CaptionFormat Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            var unmarshalledObject = new CaptionFormat();
            ...
            while (context.Read())
            {
                if ((context.IsKey) && (context.CurrentDepth == targetDepth))
                {
                    ...
                    {
                        unmarshalledObject.Pattern = StringUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                }
        ...
        private static CaptionFormatUnmarshaller instance;
        public static CaptionFormatUnmarshaller GetInstance()
        {
            if (instance == null)
            {
                instance = new CaptionFormatUnmarshaller();
            }
            return instance;
        }
