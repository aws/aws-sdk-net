...
namespace Amazon.ElasticTranscoder.Model
{
    ...
    public partial class CreatePipelineRequest : AmazonWebServiceRequest
    {
        ...
        /// want to                notify when Elastic Transcoder has started to process a job
        ...
        /// Amazon Simple Notification Service Developer Guide.</li>            <li><b>Completed</b>:
        ...
        ///   <li><b>Warning</b>: The topic ARN for the Amazon SNS topic that you want to notify
        ...
        /// you created the topic.</li>            <li><b>Error</b>: The topic ARN for the Amazon
        /// SNS topic that you want to notify when Elastic Transcoder                encounters
        /// an error condition while processing a job in this pipeline. This is the          
        ...
        ///         
        /// <para>
        /// Specify this value when all of the following are true: <ul>                <li>You
        /// want to save transcoded files, thumbnails (if any), and playlists (if any)       
        ///             together in one bucket.</li>                <li>You do not want to specify
        /// the users or groups who have access to the transcoded                    files, thumbnails,
        /// and playlists.</li>                <li>You do not want to specify the permissions
        /// that Elastic Transcoder grants to the                    files. <important>When Elastic
        /// Transcoder saves files in                            <code>OutputBucket</code>, it
        /// grants full control over the files only to                        the AWS account
        /// that owns the role that is specified by                        <code>Role</code>.</important></li>
        ///                <li>You want to associate the transcoded files and thumbnails with
        /// the Amazon S3                    Standard storage class.</li>            </ul>
        /// </para>
        ///         
        /// <para>
        /// If you want to save transcoded files and playlists in one bucket and thumbnails in
        ///            another bucket, specify which users can access the transcoded files or
        /// the permissions            the users have, or change the Amazon S3 storage class,
        /// omit <code>OutputBucket</code>            and specify values for <code>ContentConfig</code>
