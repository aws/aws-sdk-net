...
namespace Amazon.ElasticTranscoder.Model
{
    ...
    {
        private DeletePresetResult deletePresetResult;
        ...
        public DeletePresetResult DeletePresetResult
        {
            get
            {
                if(this.deletePresetResult == null)
                {
                    this.deletePresetResult = new DeletePresetResult();
                }

                return this.deletePresetResult;
            }
            set { this.deletePresetResult = value; }
        }
    }
}
