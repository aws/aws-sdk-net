...
namespace Amazon.ElasticTranscoder.Model
{
    ...
    public partial class Captions
    {
        ...
        /// <summary>
        /// Sets the CaptionFormats property
        /// </summary>
        /// <param name="captionFormats">The values to add to the CaptionFormats collection </param>
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public Captions WithCaptionFormats(params CaptionFormat[] captionFormats)
        {
            foreach (var element in captionFormats)
            {
                this._captionFormats.Add(element);
            }
            return this;
        }
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public Captions WithCaptionFormats(IEnumerable<CaptionFormat> captionFormats)
        {
            foreach (var element in captionFormats)
            {
                this._captionFormats.Add(element);
        ...
        /// <summary>
        /// Sets the CaptionSources property
        /// </summary>
        /// <param name="captionSources">The values to add to the CaptionSources collection </param>
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public Captions WithCaptionSources(params CaptionSource[] captionSources)
        {
            foreach (var element in captionSources)
            {
                this._captionSources.Add(element);
            }
            return this;
        }
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public Captions WithCaptionSources(IEnumerable<CaptionSource> captionSources)
        {
            foreach (var element in captionSources)
            {
                this._captionSources.Add(element);
        ...
        /// captions and ignores the            sidecar captions for that language. If <guilabel>CaptionSources</guilabel>
