...
namespace Amazon.ElasticTranscoder.Model
{
    ...
    public partial class CreateJobOutput
    {
        ...
        /// </summary>
        /// <param name="albumArt">The value to set for the AlbumArt property </param>
        ...
        /// </summary>
        /// <param name="captions">The value to set for the Captions property </param>
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        ...
        {
            this._thumbnailPattern = thumbnailPattern;
            return this;
        }
