...
namespace Amazon.ElasticTranscoder.Model
{
    ...
    public partial class VideoParameters
    {
        ...
        {
            this._displayAspectRatio = displayAspectRatio;
            return this;
        }
        ...
        {
            this._keyframesMaxDist = keyframesMaxDist;
            return this;
        }
        ...
        {
            this._paddingPolicy = paddingPolicy;
            return this;
        }
        ...
        {
            this._sizingPolicy = sizingPolicy;
            return this;
        }
        ...
        {
            foreach (var element in watermarks)
            {
                this._watermarks.Add(element);
            }
            return this;
        }
