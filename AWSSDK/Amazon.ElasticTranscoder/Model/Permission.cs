...
namespace Amazon.ElasticTranscoder.Model
{
    ...
    public partial class Permission
    {
        ...
        ///            values include: <ul>                <li><code>READ</code>: The grantee
        /// can read the thumbnails and metadata for                    thumbnails that Elastic
        /// Transcoder adds to the Amazon S3 bucket.</li>                <li><code>READ_ACP</code>:
        ...
        /// adds to the Amazon S3 bucket.</li>                <li><code>FULL_CONTROL</code>: The
        ...
        {
            foreach (var element in access)
            {
                this._access.Add(element);
            }
            return this;
        }
        ...
        /// To            identify the user or group, you can specify the canonical user ID for
        /// an AWS account, an            origin access identity for a CloudFront distribution,
        ...
        /// identity for an Amazon CloudFront distribution. <important>A                     
