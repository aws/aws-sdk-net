...
namespace Amazon.RDS.Model
{
    ...
    /// </summary>
    public class AuthorizeDBSecurityGroupIngressResponse : AmazonWebServiceResponse
    {
        private AuthorizeDBSecurityGroupIngressResult authorizeDBSecurityGroupIngressResult;
