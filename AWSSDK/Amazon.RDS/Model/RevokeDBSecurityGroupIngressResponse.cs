...
namespace Amazon.RDS.Model
{
    ...
    /// </summary>
    public class RevokeDBSecurityGroupIngressResponse : AmazonWebServiceResponse
    {
        private RevokeDBSecurityGroupIngressResult revokeDBSecurityGroupIngressResult;
