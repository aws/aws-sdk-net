...
namespace Amazon.RDS.Model
{
    ...
    /// </summary>
    public class DescribeEngineDefaultParametersResponse : AmazonWebServiceResponse
    {
        private DescribeEngineDefaultParametersResult describeEngineDefaultParametersResult;
