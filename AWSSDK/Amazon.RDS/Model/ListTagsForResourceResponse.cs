...
namespace Amazon.RDS.Model
{
    ...
    /// </summary>
    public class ListTagsForResourceResponse : AmazonWebServiceResponse
    {
        ...
        public ListTagsForResourceResult ListTagsForResourceResult
        {
            get
            {
                if(this.listTagsForResourceResult == null)
                {
                    this.listTagsForResourceResult = new ListTagsForResourceResult();
                }

                return this.listTagsForResourceResult;
            }
            set { this.listTagsForResourceResult = value; }
        }
    }
}
