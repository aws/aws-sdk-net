...
namespace Amazon.RDS.Model
{
    ...
    /// </summary>
    public class RestoreDBInstanceToPointInTimeResponse : AmazonWebServiceResponse
    {
        private RestoreDBInstanceToPointInTimeResult restoreDBInstanceToPointInTimeResult;
