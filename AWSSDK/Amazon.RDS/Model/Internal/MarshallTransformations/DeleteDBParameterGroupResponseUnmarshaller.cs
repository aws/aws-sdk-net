...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DeleteDBParameterGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {

        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            DeleteDBParameterGroupResponse response = new DeleteDBParameterGroupResponse();
        ...
        private static DeleteDBParameterGroupResponseUnmarshaller instance;

        public static DeleteDBParameterGroupResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DeleteDBParameterGroupResponseUnmarshaller();
            }
            return instance;
        }
