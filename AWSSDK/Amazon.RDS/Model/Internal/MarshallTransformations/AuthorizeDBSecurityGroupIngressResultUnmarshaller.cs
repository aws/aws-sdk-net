...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    internal class AuthorizeDBSecurityGroupIngressResultUnmarshaller : IUnmarshaller<AuthorizeDBSecurityGroupIngressResult, XmlUnmarshallerContext> {
        ...
        private static AuthorizeDBSecurityGroupIngressResultUnmarshaller instance;
        
        public static AuthorizeDBSecurityGroupIngressResultUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new AuthorizeDBSecurityGroupIngressResultUnmarshaller();
            }
            return instance;
        }        
    }
