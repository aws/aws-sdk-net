...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class RemoveSourceIdentifierFromSubscriptionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)
                {
                    ...
                    {
                        response.RemoveSourceIdentifierFromSubscriptionResult = RemoveSourceIdentifierFromSubscriptionResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static RemoveSourceIdentifierFromSubscriptionResponseUnmarshaller instance;
