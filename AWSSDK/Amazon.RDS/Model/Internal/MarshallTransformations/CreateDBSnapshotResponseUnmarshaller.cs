...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    internal class CreateDBSnapshotResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)
                {
                    ...
                    if(context.TestExpression("CreateDBSnapshotResult", 2))
                    {
                        response.CreateDBSnapshotResult = CreateDBSnapshotResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static CreateDBSnapshotResponseUnmarshaller instance;
