...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    internal class CreateDBSubnetGroupResultUnmarshaller : IUnmarshaller<CreateDBSubnetGroupResult, XmlUnmarshallerContext> {
        ...
        private static CreateDBSubnetGroupResultUnmarshaller instance;
        
        public static CreateDBSubnetGroupResultUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new CreateDBSubnetGroupResultUnmarshaller();
            }
            return instance;
        }        
    }
