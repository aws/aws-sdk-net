...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    internal class CreateDBSecurityGroupResultUnmarshaller : IUnmarshaller<CreateDBSecurityGroupResult, XmlUnmarshallerContext> {
        ...
        public CreateDBSecurityGroupResult Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        result.DBSecurityGroup = DBSecurityGroupUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                }
        ...
        private static CreateDBSecurityGroupResultUnmarshaller instance;
        
        public static CreateDBSecurityGroupResultUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new CreateDBSecurityGroupResultUnmarshaller();
            }
            return instance;
        }        
    }
