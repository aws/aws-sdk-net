...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class PromoteReadReplicaResponseUnmarshaller : XmlResponseUnmarshaller
    {

        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            PromoteReadReplicaResponse response = new PromoteReadReplicaResponse();
            ...
            while (context.Read())
            {
                if (context.IsStartElement)
                {
                    ...
                    if(context.TestExpression("PromoteReadReplicaResult", 2))
                    {
                        response.PromoteReadReplicaResult = PromoteReadReplicaResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static PromoteReadReplicaResponseUnmarshaller instance;
