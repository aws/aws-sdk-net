...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class AddTagsToResourceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static AddTagsToResourceResponseUnmarshaller instance;

        public static AddTagsToResourceResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new AddTagsToResourceResponseUnmarshaller();
            }
            return instance;
        }
