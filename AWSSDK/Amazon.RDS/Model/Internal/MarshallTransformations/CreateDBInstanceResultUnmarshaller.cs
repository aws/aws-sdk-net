...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    internal class CreateDBInstanceResultUnmarshaller : IUnmarshaller<CreateDBInstanceResult, XmlUnmarshallerContext> {
        ...
        private static CreateDBInstanceResultUnmarshaller instance;
        
        public static CreateDBInstanceResultUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new CreateDBInstanceResultUnmarshaller();
            }
            return instance;
        }        
    }
