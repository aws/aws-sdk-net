...
{
    /// <summary>
    /// Response Unmarshaller for GetFederationToken Object
    /// </summary>  
    public class GetFederationTokenResultUnmarshaller : IUnmarshaller<GetFederationTokenResult, XmlUnmarshallerContext>
    {
        public GetFederationTokenResult Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = FederatedUserUnmarshaller.GetInstance();
                        result.FederatedUser = unmarshaller.Unmarshall(context);
                        continue;
                    }
