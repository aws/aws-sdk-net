...
namespace Amazon.SecurityToken.Model
{
    ...
    /// </summary>
    public partial class AssumeRoleWithSAMLRequest : AmazonWebServiceRequest
    {
        ...
        public AssumeRoleWithSAMLRequest WithDurationSeconds(int durationSeconds)
        {
        ...
        /// </summary>
        /// <param name="principalArn">The value to set for the PrincipalArn property </param>
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public AssumeRoleWithSAMLRequest WithPrincipalArn(string principalArn)
        {
            this._principalArn = principalArn;
            return this;
        }
        ...
        /// </summary>
        /// <param name="sAMLAssertion">The value to set for the SAMLAssertion property </param>
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
