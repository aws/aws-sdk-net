...
namespace Amazon.Auth.AccessControlPolicy.ActionIdentifiers
{
    ...
    public class S3ActionIdentifiers
    {
        ...
        public static readonly ActionIdentifier GetCORSConfiguration = new ActionIdentifier("s3:GetCORSConfiguration");
        ...
        public static readonly ActionIdentifier PutCORSConfiguration = new ActionIdentifier("s3:PutCORSConfiguration");
