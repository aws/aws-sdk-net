...
namespace Amazon.Auth.AccessControlPolicy.ActionIdentifiers
{
    ...
    public class SQSActionIdentifiers
    {
        ...
        public static readonly ActionIdentifier ChangeMessageVisibilityBatch = new ActionIdentifier("sqs:ChangeMessageVisibilityBatch");
        ...
        public static readonly ActionIdentifier DeleteMessageBatch = new ActionIdentifier("sqs:DeleteMessageBatch");
        ...
        public static readonly ActionIdentifier SendMessageBatch = new ActionIdentifier("sqs:SendMessageBatch");
