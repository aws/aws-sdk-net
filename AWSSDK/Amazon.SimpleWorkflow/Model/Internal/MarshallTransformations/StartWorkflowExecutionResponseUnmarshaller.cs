 ...
 */
    ...
    namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class StartWorkflowExecutionResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
          ...
          if (errorResponse.Code != null && errorResponse.Code.Equals("DefaultUndefinedException"))
          {
          ...
          if (errorResponse.Code != null && errorResponse.Code.Equals("WorkflowExecutionAlreadyStartedException"))
          {
        ...
        private static StartWorkflowExecutionResponseUnmarshaller instance;
