 ...
 */
    ...
    {
      /// <summary>
      /// DescribeObjectsResultUnmarshaller
      /// </summary>
      internal class DescribeObjectsResultUnmarshaller : IUnmarshaller<DescribeObjectsResult, XmlUnmarshallerContext>, IUnmarshaller<DescribeObjectsResult, JsonUnmarshallerContext>
      {
        DescribeObjectsResult IUnmarshaller<DescribeObjectsResult, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static DescribeObjectsResultUnmarshaller instance;
        public static DescribeObjectsResultUnmarshaller GetInstance()
        {
            if (instance == null)
                instance = new DescribeObjectsResultUnmarshaller();
            return instance;
        }
    }
}
