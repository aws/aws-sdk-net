 ...
 */
    ...
    namespace Amazon.DataPipeline.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class ReportTaskProgressResponseUnmarshaller : JsonResponseUnmarshaller
      {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
          ...
          response.ReportTaskProgressResult = ReportTaskProgressResultUnmarshaller.GetInstance().Unmarshall(context);
        ...
        private static ReportTaskProgressResponseUnmarshaller instance;
        public static ReportTaskProgressResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new ReportTaskProgressResponseUnmarshaller();
          }
          return instance;
        }
