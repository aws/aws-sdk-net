...
namespace Amazon.DataPipeline.Model
{
    ...
    {
        private QueryObjectsResult queryObjectsResult;
        ...
        public QueryObjectsResult QueryObjectsResult
        {
            get
            {
                if(this.queryObjectsResult == null)
                {
                    this.queryObjectsResult = new QueryObjectsResult();
                }

                return this.queryObjectsResult;
            }
            set { this.queryObjectsResult = value; }
        }
    }
}
