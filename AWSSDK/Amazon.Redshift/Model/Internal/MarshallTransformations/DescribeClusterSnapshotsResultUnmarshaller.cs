...
{
    /// <summary>
    /// Response Unmarshaller for DescribeClusterSnapshots Object
    /// </summary>  
    public class DescribeClusterSnapshotsResultUnmarshaller : IUnmarshaller<DescribeClusterSnapshotsResult, XmlUnmarshallerContext>
    {
        public DescribeClusterSnapshotsResult Unmarshall(XmlUnmarshallerContext context) 
        {
            DescribeClusterSnapshotsResult result = new DescribeClusterSnapshotsResult();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = SnapshotUnmarshaller.GetInstance();
