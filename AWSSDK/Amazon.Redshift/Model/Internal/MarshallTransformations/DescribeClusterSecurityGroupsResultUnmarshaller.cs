...
{
    /// <summary>
    /// Response Unmarshaller for DescribeClusterSecurityGroups Object
    /// </summary>  
    public class DescribeClusterSecurityGroupsResultUnmarshaller : IUnmarshaller<DescribeClusterSecurityGroupsResult, XmlUnmarshallerContext>
    {
        public DescribeClusterSecurityGroupsResult Unmarshall(XmlUnmarshallerContext context) 
        {
            DescribeClusterSecurityGroupsResult result = new DescribeClusterSecurityGroupsResult();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = ClusterSecurityGroupUnmarshaller.GetInstance();
                        var item = unmarshaller.Unmarshall(context);
                        result.ClusterSecurityGroups.Add(item);
                        continue;
                    }
