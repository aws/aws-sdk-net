...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DescribeReservedNodesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)                
                {
                    ...
                    {
                        response.DescribeReservedNodesResult = DescribeReservedNodesResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static DescribeReservedNodesResponseUnmarshaller instance;

        public static DescribeReservedNodesResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DescribeReservedNodesResponseUnmarshaller();
            }
            return instance;
        }
