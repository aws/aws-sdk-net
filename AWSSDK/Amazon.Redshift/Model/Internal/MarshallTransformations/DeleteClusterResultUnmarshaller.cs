...
{
    /// <summary>
    ///    Result Unmarshaller for DeleteCluster operation
    /// </summary>
    internal class DeleteClusterResultUnmarshaller : IUnmarshaller<DeleteClusterResult, XmlUnmarshallerContext> {
