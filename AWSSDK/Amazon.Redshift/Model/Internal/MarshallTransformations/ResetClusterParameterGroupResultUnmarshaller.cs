...
{
     /// <summary>
     ///   ResetClusterParameterGroupResult Unmarshaller
     /// </summary>
    internal class ResetClusterParameterGroupResultUnmarshaller : IUnmarshaller<ResetClusterParameterGroupResult, XmlUnmarshallerContext>, IUnmarshaller<ResetClusterParameterGroupResult, JsonUnmarshallerContext> 
    {
        public ResetClusterParameterGroupResult Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                ...
                { 
                    ...
                    {
                        resetClusterParameterGroupResult.ParameterGroupName = StringUnmarshaller.GetInstance().Unmarshall(context);
                            
                        continue;
                    } 
                    if (context.TestExpression("ParameterGroupStatus", targetDepth))
                    {
                        resetClusterParameterGroupResult.ParameterGroupStatus = StringUnmarshaller.GetInstance().Unmarshall(context);
        ...
        public ResetClusterParameterGroupResult Unmarshall(JsonUnmarshallerContext context) 
        {
            return null;
        }
