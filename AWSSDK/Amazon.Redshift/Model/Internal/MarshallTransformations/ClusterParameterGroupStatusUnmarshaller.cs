...
{
     /// <summary>
     ///   ClusterParameterGroupStatus Unmarshaller
     /// </summary>
    internal class ClusterParameterGroupStatusUnmarshaller : IUnmarshaller<ClusterParameterGroupStatus, XmlUnmarshallerContext>, IUnmarshaller<ClusterParameterGroupStatus, JsonUnmarshallerContext> 
    {
        public ClusterParameterGroupStatus Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                ...
                { 
                    ...
                    {
                        clusterParameterGroupStatus.ParameterGroupName = StringUnmarshaller.GetInstance().Unmarshall(context);
                            
                        continue;
                    } 
                    if (context.TestExpression("ParameterApplyStatus", targetDepth))
                    {
                        clusterParameterGroupStatus.ParameterApplyStatus = StringUnmarshaller.GetInstance().Unmarshall(context);
