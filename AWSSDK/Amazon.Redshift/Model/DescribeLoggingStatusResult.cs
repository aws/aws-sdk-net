...
namespace Amazon.Redshift.Model
{
    ...
    /// </summary>
    public partial class DescribeLoggingStatusResult
    {
        ...
        public DescribeLoggingStatusResult WithLoggingEnabled(bool loggingEnabled)
        {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public DescribeLoggingStatusResult WithLastSuccessfulDeliveryTime(DateTime lastSuccessfulDeliveryTime)
        {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public DescribeLoggingStatusResult WithLastFailureTime(DateTime lastFailureTime)
        {
