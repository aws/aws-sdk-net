...
{
    /// <summary>
    /// <para>Options for a latlon field. A latlon field contains a location stored as a latitude and longitude value pair. Present if
    /// <c>IndexFieldType</c> specifies the field is of type <c>latlon</c> . All options are enabled by default.</para>
    /// </summary>
    public partial class LatLonOptions
    {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public LatLonOptions WithFacetEnabled(bool facetEnabled)
        {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public LatLonOptions WithSearchEnabled(bool searchEnabled)
        {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public LatLonOptions WithReturnEnabled(bool returnEnabled)
        {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public LatLonOptions WithSortEnabled(bool sortEnabled)
        {
