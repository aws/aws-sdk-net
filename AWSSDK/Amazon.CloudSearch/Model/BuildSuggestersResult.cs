...
namespace Amazon.CloudSearch.Model
{
    ...
    /// </summary>
    public partial class BuildSuggestersResult
    {
        ...
        public BuildSuggestersResult WithFieldNames(params string[] fieldNames)
        {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public BuildSuggestersResult WithFieldNames(IEnumerable<string> fieldNames)
        {
            foreach (string element in fieldNames)
            {
                this.fieldNames.Add(element);
