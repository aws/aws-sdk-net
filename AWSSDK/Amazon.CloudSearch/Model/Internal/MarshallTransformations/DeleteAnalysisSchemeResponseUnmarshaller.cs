...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DeleteAnalysisSchemeResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)                
                {
                    ...
                    {
                        response.DeleteAnalysisSchemeResult = DeleteAnalysisSchemeResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static DeleteAnalysisSchemeResponseUnmarshaller instance;

        public static DeleteAnalysisSchemeResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DeleteAnalysisSchemeResponseUnmarshaller();
            }
            return instance;
        }
