...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    internal class UpdateStemmingOptionsResultUnmarshaller : IUnmarshaller<UpdateStemmingOptionsResult, XmlUnmarshallerContext> 
    {
        public UpdateStemmingOptionsResult Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                ...
                { 
                    ...
                    {
                        updateStemmingOptionsResult.Stems = StemmingOptionsStatusUnmarshaller.GetInstance().Unmarshall(context);
        ...
        public static UpdateStemmingOptionsResultUnmarshaller GetInstance() 
        {
            if (instance == null) 
               instance = new UpdateStemmingOptionsResultUnmarshaller();
