...
{
     /// <summary>
     ///   Suggester Unmarshaller
     /// </summary>
    internal class SuggesterUnmarshaller : IUnmarshaller<Suggester, XmlUnmarshallerContext>, IUnmarshaller<Suggester, JsonUnmarshallerContext> 
    {
        ...
        private static SuggesterUnmarshaller instance;

        public static SuggesterUnmarshaller GetInstance() 
        {
            if (instance == null) 
               instance = new SuggesterUnmarshaller();
