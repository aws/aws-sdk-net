...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DefineAnalysisSchemeResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)                
                {
                    ...
                    {
                        response.DefineAnalysisSchemeResult = DefineAnalysisSchemeResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static DefineAnalysisSchemeResponseUnmarshaller instance;

        public static DefineAnalysisSchemeResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DefineAnalysisSchemeResponseUnmarshaller();
            }
            return instance;
        }
