...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DeleteSuggesterResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)                
                {
                    ...
                    {
                        response.DeleteSuggesterResult = DeleteSuggesterResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static DeleteSuggesterResponseUnmarshaller instance;

        public static DeleteSuggesterResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DeleteSuggesterResponseUnmarshaller();
            }
            return instance;
        }
