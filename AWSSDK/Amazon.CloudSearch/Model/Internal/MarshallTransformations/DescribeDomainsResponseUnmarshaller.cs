...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DescribeDomainsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static DescribeDomainsResponseUnmarshaller instance;

        public static DescribeDomainsResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DescribeDomainsResponseUnmarshaller();
            }
            return instance;
        }
