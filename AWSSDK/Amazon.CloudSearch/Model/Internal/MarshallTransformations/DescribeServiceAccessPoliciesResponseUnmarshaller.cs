...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DescribeServiceAccessPoliciesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)                
                {
                    ...
                    {
                        response.DescribeServiceAccessPoliciesResult = DescribeServiceAccessPoliciesResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
