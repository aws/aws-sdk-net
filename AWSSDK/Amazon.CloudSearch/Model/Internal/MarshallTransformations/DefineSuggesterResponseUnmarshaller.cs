...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DefineSuggesterResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)                
                {
                    ...
                    {
                        response.DefineSuggesterResult = DefineSuggesterResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static DefineSuggesterResponseUnmarshaller instance;

        public static DefineSuggesterResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DefineSuggesterResponseUnmarshaller();
            }
            return instance;
        }
