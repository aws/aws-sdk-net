...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class UpdateScalingParametersResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)                
                {
                    ...
                    {
                        response.UpdateScalingParametersResult = UpdateScalingParametersResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static UpdateScalingParametersResponseUnmarshaller instance;

        public static UpdateScalingParametersResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new UpdateScalingParametersResponseUnmarshaller();
            }
            return instance;
        }
