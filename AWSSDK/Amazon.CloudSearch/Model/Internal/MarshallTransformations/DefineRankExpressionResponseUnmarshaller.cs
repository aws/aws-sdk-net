...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DefineRankExpressionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)                
                {
                    ...
                    {
                        response.DefineRankExpressionResult = DefineRankExpressionResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static DefineRankExpressionResponseUnmarshaller instance;
