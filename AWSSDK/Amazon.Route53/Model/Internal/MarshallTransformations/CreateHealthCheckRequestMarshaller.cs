    ...
    public class CreateHealthCheckRequestMarshaller : IMarshaller<IRequest, CreateHealthCheckRequest>
    {
        ...
        if (createHealthCheckRequest != null) 
        {
            ...
            if (healthCheckConfigHealthCheckConfig != null) 
            {
                ...
                {
                    xmlWriter.WriteElementString("RequestInterval", "https://route53.amazonaws.com/doc/2013-04-01/", healthCheckConfigHealthCheckConfig.RequestInterval.ToString());
                  }
                if (healthCheckConfigHealthCheckConfig.IsSetFailureThreshold()) 
                {
                    xmlWriter.WriteElementString("FailureThreshold", "https://route53.amazonaws.com/doc/2013-04-01/", healthCheckConfigHealthCheckConfig.FailureThreshold.ToString());
                  }
