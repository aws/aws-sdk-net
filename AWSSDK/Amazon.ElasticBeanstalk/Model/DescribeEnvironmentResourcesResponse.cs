...
namespace Amazon.ElasticBeanstalk.Model
{
    ...
    {
        private DescribeEnvironmentResourcesResult _describeEnvironmentResourcesResult;
        ...
        public DescribeEnvironmentResourcesResult DescribeEnvironmentResourcesResult
        {
            get
            {
                if(this._describeEnvironmentResourcesResult == null)
                {
                    this._describeEnvironmentResourcesResult = new DescribeEnvironmentResourcesResult();
                }
                return this._describeEnvironmentResourcesResult;
            }
            set { this._describeEnvironmentResourcesResult = value; }
        }
    }
}