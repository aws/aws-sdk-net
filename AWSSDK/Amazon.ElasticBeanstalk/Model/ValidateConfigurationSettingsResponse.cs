...
namespace Amazon.ElasticBeanstalk.Model
{
    ...
    {
        private ValidateConfigurationSettingsResult _validateConfigurationSettingsResult;
        ...
        public ValidateConfigurationSettingsResult ValidateConfigurationSettingsResult
        {
            get
            {
                if(this._validateConfigurationSettingsResult == null)
                {
                    this._validateConfigurationSettingsResult = new ValidateConfigurationSettingsResult();
                }
                return this._validateConfigurationSettingsResult;
            }
            set { this._validateConfigurationSettingsResult = value; }
        }
    }
}