...
{
    /// <summary>
    /// Response Unmarshaller for UpdateConfigurationTemplate Object
    /// </summary>  
    public class UpdateConfigurationTemplateResultUnmarshaller : IUnmarshaller<UpdateConfigurationTemplateResult, XmlUnmarshallerContext>
    {
        public UpdateConfigurationTemplateResult Unmarshall(XmlUnmarshallerContext context) 
        {
            UpdateConfigurationTemplateResult result = new UpdateConfigurationTemplateResult();
