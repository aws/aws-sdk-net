...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    {
        public IRequest Marshall(CreateApplicationRequest createApplicationRequest)
        {
            IRequest request = new DefaultRequest(createApplicationRequest, "AmazonElasticBeanstalk");
