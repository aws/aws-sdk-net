...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    {
        public IRequest Marshall(DescribeApplicationsRequest describeApplicationsRequest)
        {
            IRequest request = new DefaultRequest(describeApplicationsRequest, "AmazonElasticBeanstalk");
