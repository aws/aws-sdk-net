...
{
    /// <summary>
    /// Response Unmarshaller for DescribeConfigurationOptions Object
    /// </summary>  
    public class DescribeConfigurationOptionsResultUnmarshaller : IUnmarshaller<DescribeConfigurationOptionsResult, XmlUnmarshallerContext>
    {
        public DescribeConfigurationOptionsResult Unmarshall(XmlUnmarshallerContext context) 
        {
            DescribeConfigurationOptionsResult result = new DescribeConfigurationOptionsResult();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = ConfigurationOptionDescriptionUnmarshaller.GetInstance();
