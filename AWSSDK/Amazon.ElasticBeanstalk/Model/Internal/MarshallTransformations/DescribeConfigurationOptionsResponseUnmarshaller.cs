...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DescribeConfigurationOptionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)                
                {
                    ...
                    {
                        response.DescribeConfigurationOptionsResult = DescribeConfigurationOptionsResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static DescribeConfigurationOptionsResponseUnmarshaller instance;
