...
{
    /// <summary>
    /// Response Unmarshaller for TerminateEnvironment Object
    /// </summary>  
    public class TerminateEnvironmentResultUnmarshaller : IUnmarshaller<TerminateEnvironmentResult, XmlUnmarshallerContext>
    {
        public TerminateEnvironmentResult Unmarshall(XmlUnmarshallerContext context) 
        {
            TerminateEnvironmentResult result = new TerminateEnvironmentResult();
