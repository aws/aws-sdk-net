...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    {
        public IRequest Marshall(SwapEnvironmentCNAMEsRequest swapEnvironmentCNAMEsRequest)
        {
            IRequest request = new DefaultRequest(swapEnvironmentCNAMEsRequest, "AmazonElasticBeanstalk");
