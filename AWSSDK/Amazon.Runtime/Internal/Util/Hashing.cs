...
namespace Amazon.Runtime.Internal.Util
{
    public static class Hashing
    {
        ...
        /// </summary>
        /// <param name="objectsToHash"></param>
        /// <returns></returns>
        public static int Hash(params object[] objectsToHash)
        {
            int result = 0;
            foreach (object toHash in objectsToHash)
            {
                int hash = (toHash == null ? 0 : toHash.GetHashCode());
