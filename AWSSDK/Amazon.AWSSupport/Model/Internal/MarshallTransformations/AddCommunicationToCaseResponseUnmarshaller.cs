    ...
    namespace Amazon.AWSSupport.Model.Internal.MarshallTransformations
    {
      ...
      internal class AddCommunicationToCaseResponseUnmarshaller : JsonResponseUnmarshaller
      {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
          ...
          response.AddCommunicationToCaseResult = AddCommunicationToCaseResultUnmarshaller.GetInstance().Unmarshall(context);
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
          ...
          {
            CaseIdNotFoundException ex = new CaseIdNotFoundException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
