...
namespace Amazon.CloudSearch_2011_02_01.Model.Internal.MarshallTransformations
{
    ...
    internal class DeleteRankExpressionResultUnmarshaller : IUnmarshaller<DeleteRankExpressionResult, XmlUnmarshallerContext>, IUnmarshaller<DeleteRankExpressionResult, JsonUnmarshallerContext> 
    {
        public DeleteRankExpressionResult Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                ...
                { 
                    ...
                    {
                        deleteRankExpressionResult.RankExpression = RankExpressionStatusUnmarshaller.GetInstance().Unmarshall(context);
        ...
        public static DeleteRankExpressionResultUnmarshaller GetInstance() 
        {
            if (instance == null) 
               instance = new DeleteRankExpressionResultUnmarshaller();
