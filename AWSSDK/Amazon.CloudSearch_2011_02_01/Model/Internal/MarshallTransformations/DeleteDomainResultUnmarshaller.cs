...
namespace Amazon.CloudSearch_2011_02_01.Model.Internal.MarshallTransformations
{
    ...
    internal class DeleteDomainResultUnmarshaller : IUnmarshaller<DeleteDomainResult, XmlUnmarshallerContext>, IUnmarshaller<DeleteDomainResult, JsonUnmarshallerContext> 
    {
        public DeleteDomainResult Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                ...
                { 
                    ...
                    {
                        deleteDomainResult.DomainStatus = DomainStatusUnmarshaller.GetInstance().Unmarshall(context);
        ...
        public static DeleteDomainResultUnmarshaller GetInstance() 
        {
            if (instance == null) 
               instance = new DeleteDomainResultUnmarshaller();
