...
namespace Amazon.CloudSearch_2011_02_01.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DescribeStemmingOptionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)                
                {
                    ...
                    {
                        response.DescribeStemmingOptionsResult = DescribeStemmingOptionsResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static DescribeStemmingOptionsResponseUnmarshaller instance;

        public static DescribeStemmingOptionsResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DescribeStemmingOptionsResponseUnmarshaller();
            }
            return instance;
        }
