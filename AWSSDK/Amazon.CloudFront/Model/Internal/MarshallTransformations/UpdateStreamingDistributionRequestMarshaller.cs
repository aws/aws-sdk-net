    ...
    public class UpdateStreamingDistributionRequestMarshaller : IMarshaller<IRequest, UpdateStreamingDistributionRequest>
    {
                    ...
                    if (updateStreamingDistributionRequest != null) 
        {
            ...
            if (streamingDistributionConfigStreamingDistributionConfig != null) 
            {
                ...
                {
                    xmlWriter.WriteElementString("CallerReference", "http://cloudfront.amazonaws.com/doc/2014-01-31/", streamingDistributionConfigStreamingDistributionConfig.CallerReference.ToString());
                  }
                if (streamingDistributionConfigStreamingDistributionConfig != null) 
                {
                    ...
                    if (s3OriginS3Origin != null) 
                    {
                        ...
                        {
                            xmlWriter.WriteElementString("DomainName", "http://cloudfront.amazonaws.com/doc/2014-01-31/", s3OriginS3Origin.DomainName.ToString());
                          }
                        if (s3OriginS3Origin.IsSetOriginAccessIdentity()) 
                        {
                            xmlWriter.WriteElementString("OriginAccessIdentity", "http://cloudfront.amazonaws.com/doc/2014-01-31/", s3OriginS3Origin.OriginAccessIdentity.ToString());
                          }
                ...
                if (streamingDistributionConfigStreamingDistributionConfig != null) 
                {
                    ...
                    if (aliasesAliases != null) 
                    {
                        ...
                        {
                            xmlWriter.WriteElementString("Quantity", "http://cloudfront.amazonaws.com/doc/2014-01-31/", aliasesAliases.Quantity.ToString());
                          }
                ...
                {
                    xmlWriter.WriteElementString("Comment", "http://cloudfront.amazonaws.com/doc/2014-01-31/", streamingDistributionConfigStreamingDistributionConfig.Comment.ToString());
                  }
                if (streamingDistributionConfigStreamingDistributionConfig != null) 
                {
                    ...
                    if (streamingLoggingConfigLogging != null) 
                    {
                        ...
                        {
                            xmlWriter.WriteElementString("Enabled", "http://cloudfront.amazonaws.com/doc/2014-01-31/", streamingLoggingConfigLogging.Enabled.ToString().ToLower());
                          }
                        if (streamingLoggingConfigLogging.IsSetBucket()) 
                        {
                            xmlWriter.WriteElementString("Bucket", "http://cloudfront.amazonaws.com/doc/2014-01-31/", streamingLoggingConfigLogging.Bucket.ToString());
                          }
                        if (streamingLoggingConfigLogging.IsSetPrefix()) 
                        {
                            xmlWriter.WriteElementString("Prefix", "http://cloudfront.amazonaws.com/doc/2014-01-31/", streamingLoggingConfigLogging.Prefix.ToString());
                          }
                        xmlWriter.WriteEndElement();
                    }
                }
                if (streamingDistributionConfigStreamingDistributionConfig != null) 
                {
                    ...
                    if (trustedSignersTrustedSigners != null) 
                    {
                        ...
                        {
                            xmlWriter.WriteElementString("Enabled", "http://cloudfront.amazonaws.com/doc/2014-01-31/", trustedSignersTrustedSigners.Enabled.ToString().ToLower());
                          }
                        if (trustedSignersTrustedSigners.IsSetQuantity()) 
                        {
                            xmlWriter.WriteElementString("Quantity", "http://cloudfront.amazonaws.com/doc/2014-01-31/", trustedSignersTrustedSigners.Quantity.ToString());
                          }
                ...
                {
                    xmlWriter.WriteElementString("PriceClass", "http://cloudfront.amazonaws.com/doc/2014-01-31/", streamingDistributionConfigStreamingDistributionConfig.PriceClass.ToString());
                  }
                if (streamingDistributionConfigStreamingDistributionConfig.IsSetEnabled()) 
                {
                    xmlWriter.WriteElementString("Enabled", "http://cloudfront.amazonaws.com/doc/2014-01-31/", streamingDistributionConfigStreamingDistributionConfig.Enabled.ToString().ToLower());
                  }
                xmlWriter.WriteEndElement();
            }
        }
