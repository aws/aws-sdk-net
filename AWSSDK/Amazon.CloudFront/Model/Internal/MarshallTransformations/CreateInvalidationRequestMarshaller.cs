...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class CreateInvalidationRequestMarshaller : IMarshaller<IRequest, CreateInvalidationRequest>
    {
                    ...
                    if (createInvalidationRequest != null) 
        {
            ...
            {
                xmlWriter.WriteStartElement("InvalidationBatch", "http://cloudfront.amazonaws.com/doc/2013-08-26/");
                if (invalidationBatchInvalidationBatch != null) 
                {
                    Paths pathsPaths = invalidationBatchInvalidationBatch.Paths;
                    if (pathsPaths != null) 
                    {
                        xmlWriter.WriteStartElement("Paths", "http://cloudfront.amazonaws.com/doc/2013-08-26/");
                        if (pathsPaths.IsSetQuantity()) 
                        {
                            xmlWriter.WriteElementString("Quantity", "http://cloudfront.amazonaws.com/doc/2013-08-26/", pathsPaths.Quantity.ToString());
                          }
                        ...
                        if (pathsPaths != null) 
                        {
                            ...
                            if (pathsPathsitemsList != null && pathsPathsitemsList.Count > 0) 
                            {
                                ...
                                {
                                    xmlWriter.WriteStartElement("Path", "http://cloudfront.amazonaws.com/doc/2013-08-26/");
                ...
                {
                    xmlWriter.WriteElementString("CallerReference", "http://cloudfront.amazonaws.com/doc/2013-08-26/", invalidationBatchInvalidationBatch.CallerReference.ToString());
                  }
                xmlWriter.WriteEndElement();
            }
        }
