...
{
    /// <summary>
    /// Result Unmarshaller for CreateStreamingDistribution operation
    /// </summary>  
    public class CreateStreamingDistributionResultUnmarshaller : IUnmarshaller<CreateStreamingDistributionResult, XmlUnmarshallerContext>
    {
        public CreateStreamingDistributionResult Unmarshall(XmlUnmarshallerContext context)
        {
            var unmarshalledObject = new CreateStreamingDistributionResult();
