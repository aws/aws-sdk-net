    ...
    public class UpdateDistributionRequestMarshaller : IMarshaller<IRequest, UpdateDistributionRequest>
    {
                    ...
                    if (updateDistributionRequest != null) 
        {
            ...
            if (distributionConfigDistributionConfig != null) 
            {
                ...
                {
                    xmlWriter.WriteElementString("CallerReference", "http://cloudfront.amazonaws.com/doc/2013-11-11/", distributionConfigDistributionConfig.CallerReference.ToString());
                  }
                if (distributionConfigDistributionConfig != null) 
                {
                ...
                {
                    xmlWriter.WriteElementString("DefaultRootObject", "http://cloudfront.amazonaws.com/doc/2013-11-11/", distributionConfigDistributionConfig.DefaultRootObject.ToString());
                  }
                if (distributionConfigDistributionConfig != null) 
                {
                    ...
                    if (originsOrigins != null) 
                    {
                        ...
                        {
                            xmlWriter.WriteElementString("Quantity", "http://cloudfront.amazonaws.com/doc/2013-11-11/", originsOrigins.Quantity.ToString());
                          }
                        ...
                        if (originsOrigins != null) 
                        {
                            ...
                            if (originsOriginsitemsList != null && originsOriginsitemsList.Count > 0) 
                            {
                                ...
                                foreach (Origin originsOriginsitemsListValue in originsOriginsitemsList) 
                                {
                                    ...
                                    {
                                        xmlWriter.WriteElementString("Id", "http://cloudfront.amazonaws.com/doc/2013-11-11/", originsOriginsitemsListValue.Id.ToString());
                                      }
                                    if (originsOriginsitemsListValue.IsSetDomainName()) 
                                    {
                                        xmlWriter.WriteElementString("DomainName", "http://cloudfront.amazonaws.com/doc/2013-11-11/", originsOriginsitemsListValue.DomainName.ToString());
                                      }
                                    if (originsOriginsitemsListValue != null) 
                                    {
                                        ...
                                        if (s3OriginConfigS3OriginConfig != null) 
                                        {
                                            ...
                                            {
                                                xmlWriter.WriteElementString("OriginAccessIdentity", "http://cloudfront.amazonaws.com/doc/2013-11-11/", s3OriginConfigS3OriginConfig.OriginAccessIdentity.ToString());
                                              }
                                            xmlWriter.WriteEndElement();
                                        }
                                    }
                                    if (originsOriginsitemsListValue != null) 
                                    {
                                        ...
                                        if (customOriginConfigCustomOriginConfig != null) 
                                        {
                                            ...
                                            {
                                                xmlWriter.WriteElementString("HTTPPort", "http://cloudfront.amazonaws.com/doc/2013-11-11/", customOriginConfigCustomOriginConfig.HTTPPort.ToString());
                                              }
                                            if (customOriginConfigCustomOriginConfig.IsSetHTTPSPort()) 
                                            {
                                                xmlWriter.WriteElementString("HTTPSPort", "http://cloudfront.amazonaws.com/doc/2013-11-11/", customOriginConfigCustomOriginConfig.HTTPSPort.ToString());
                                              }
                                            if (customOriginConfigCustomOriginConfig.IsSetOriginProtocolPolicy()) 
                                            {
                                                xmlWriter.WriteElementString("OriginProtocolPolicy", "http://cloudfront.amazonaws.com/doc/2013-11-11/", customOriginConfigCustomOriginConfig.OriginProtocolPolicy.ToString());
                                              }
                                            xmlWriter.WriteEndElement();
                                        }
                                    }
                ...
                if (distributionConfigDistributionConfig != null) 
                {
                    ...
                    if (defaultCacheBehaviorDefaultCacheBehavior != null) 
                    {
                        ...
                        {
                            xmlWriter.WriteElementString("TargetOriginId", "http://cloudfront.amazonaws.com/doc/2013-11-11/", defaultCacheBehaviorDefaultCacheBehavior.TargetOriginId.ToString());
                          }
                        if (defaultCacheBehaviorDefaultCacheBehavior != null) 
                        {
                            ...
                            if (forwardedValuesForwardedValues != null) 
                            {
                                ...
                                {
                                    xmlWriter.WriteElementString("QueryString", "http://cloudfront.amazonaws.com/doc/2013-11-11/", forwardedValuesForwardedValues.QueryString.ToString().ToLower());
                                  }
                                if (forwardedValuesForwardedValues != null) 
                                {
                                    ...
                                    if (cookiePreferenceCookies != null) 
                                    {
                                        ...
                                        {
                                            xmlWriter.WriteElementString("Forward", "http://cloudfront.amazonaws.com/doc/2013-11-11/", cookiePreferenceCookies.Forward.ToString());
                                          }
                                        if (cookiePreferenceCookies != null) 
                                        {
                                            ...
                                            if (cookieNamesWhitelistedNames != null) 
                                            {
                                                ...
                                                {
                                                    xmlWriter.WriteElementString("Quantity", "http://cloudfront.amazonaws.com/doc/2013-11-11/", cookieNamesWhitelistedNames.Quantity.ToString());
                                                  }
                        ...
                        {
                            xmlWriter.WriteElementString("ViewerProtocolPolicy", "http://cloudfront.amazonaws.com/doc/2013-11-11/", defaultCacheBehaviorDefaultCacheBehavior.ViewerProtocolPolicy.ToString());
                          }
                        if (defaultCacheBehaviorDefaultCacheBehavior.IsSetMinTTL()) 
                        {
                            xmlWriter.WriteElementString("MinTTL", "http://cloudfront.amazonaws.com/doc/2013-11-11/", defaultCacheBehaviorDefaultCacheBehavior.MinTTL.ToString());
                          }
                        if (defaultCacheBehaviorDefaultCacheBehavior != null) 
                        {
                            ...
                            if (allowedMethodsAllowedMethods != null) 
                            {
                                ...
                                {
                                    xmlWriter.WriteElementString("Quantity", "http://cloudfront.amazonaws.com/doc/2013-11-11/", allowedMethodsAllowedMethods.Quantity.ToString());
                                  }
                ...
                if (distributionConfigDistributionConfig != null) 
                {
                    ...
                    if (cacheBehaviorsCacheBehaviors != null) 
                    {
                        ...
                        {
                            xmlWriter.WriteElementString("Quantity", "http://cloudfront.amazonaws.com/doc/2013-11-11/", cacheBehaviorsCacheBehaviors.Quantity.ToString());
                          }
                        ...
                        if (cacheBehaviorsCacheBehaviors != null) 
                        {
                            ...
                            if (cacheBehaviorsCacheBehaviorsitemsList != null && cacheBehaviorsCacheBehaviorsitemsList.Count > 0) 
                            {
                                ...
                                foreach (CacheBehavior cacheBehaviorsCacheBehaviorsitemsListValue in cacheBehaviorsCacheBehaviorsitemsList) 
                                {
                                    ...
                                    {
                                        xmlWriter.WriteElementString("PathPattern", "http://cloudfront.amazonaws.com/doc/2013-11-11/", cacheBehaviorsCacheBehaviorsitemsListValue.PathPattern.ToString());
                                      }
                                    if (cacheBehaviorsCacheBehaviorsitemsListValue.IsSetTargetOriginId()) 
                                    {
                                        xmlWriter.WriteElementString("TargetOriginId", "http://cloudfront.amazonaws.com/doc/2013-11-11/", cacheBehaviorsCacheBehaviorsitemsListValue.TargetOriginId.ToString());
                                      }
                                    ...
                                    {
                                        xmlWriter.WriteElementString("ViewerProtocolPolicy", "http://cloudfront.amazonaws.com/doc/2013-11-11/", cacheBehaviorsCacheBehaviorsitemsListValue.ViewerProtocolPolicy.ToString());
                                      }
                                    if (cacheBehaviorsCacheBehaviorsitemsListValue.IsSetMinTTL()) 
                                    {
                                        xmlWriter.WriteElementString("MinTTL", "http://cloudfront.amazonaws.com/doc/2013-11-11/", cacheBehaviorsCacheBehaviorsitemsListValue.MinTTL.ToString());
                                      }
                                    if (cacheBehaviorsCacheBehaviorsitemsListValue != null) 
                                    {
                ...
                if (distributionConfigDistributionConfig != null) 
                {
                    ...
                    if (customErrorResponsesCustomErrorResponses != null) 
                    {
                        ...
                        {
                            xmlWriter.WriteElementString("Quantity", "http://cloudfront.amazonaws.com/doc/2013-11-11/", customErrorResponsesCustomErrorResponses.Quantity.ToString());
                          }
                        ...
                        if (customErrorResponsesCustomErrorResponses != null) 
                        {
                            ...
                            if (customErrorResponsesCustomErrorResponsesitemsList != null && customErrorResponsesCustomErrorResponsesitemsList.Count > 0) 
                            {
                                ...
                                foreach (CustomErrorResponse customErrorResponsesCustomErrorResponsesitemsListValue in customErrorResponsesCustomErrorResponsesitemsList) 
                                {
                                    ...
                                    {
                                        xmlWriter.WriteElementString("ErrorCode", "http://cloudfront.amazonaws.com/doc/2013-11-11/", customErrorResponsesCustomErrorResponsesitemsListValue.ErrorCode.ToString());
                                      }
                                    if (customErrorResponsesCustomErrorResponsesitemsListValue.IsSetResponsePagePath()) 
                                    {
                                        xmlWriter.WriteElementString("ResponsePagePath", "http://cloudfront.amazonaws.com/doc/2013-11-11/", customErrorResponsesCustomErrorResponsesitemsListValue.ResponsePagePath.ToString());
                                      }
                                    if (customErrorResponsesCustomErrorResponsesitemsListValue.IsSetResponseCode()) 
                                    {
                                        xmlWriter.WriteElementString("ResponseCode", "http://cloudfront.amazonaws.com/doc/2013-11-11/", customErrorResponsesCustomErrorResponsesitemsListValue.ResponseCode.ToString());
                                      }
                                    if (customErrorResponsesCustomErrorResponsesitemsListValue.IsSetErrorCachingMinTTL()) 
                                    {
                                        xmlWriter.WriteElementString("ErrorCachingMinTTL", "http://cloudfront.amazonaws.com/doc/2013-11-11/", customErrorResponsesCustomErrorResponsesitemsListValue.ErrorCachingMinTTL.ToString());
                                      }
                                xmlWriter.WriteEndElement();
                ...
                {
                    xmlWriter.WriteElementString("Comment", "http://cloudfront.amazonaws.com/doc/2013-11-11/", distributionConfigDistributionConfig.Comment.ToString());
                  }
                if (distributionConfigDistributionConfig != null) 
                {
                    ...
                    if (loggingConfigLogging != null) 
                    {
                        ...
                        {
                            xmlWriter.WriteElementString("Enabled", "http://cloudfront.amazonaws.com/doc/2013-11-11/", loggingConfigLogging.Enabled.ToString().ToLower());
                          }
                        if (loggingConfigLogging.IsSetIncludeCookies()) 
                        {
                            xmlWriter.WriteElementString("IncludeCookies", "http://cloudfront.amazonaws.com/doc/2013-11-11/", loggingConfigLogging.IncludeCookies.ToString().ToLower());
                          }
                        if (loggingConfigLogging.IsSetBucket()) 
                        {
                            xmlWriter.WriteElementString("Bucket", "http://cloudfront.amazonaws.com/doc/2013-11-11/", loggingConfigLogging.Bucket.ToString());
                          }
                        if (loggingConfigLogging.IsSetPrefix()) 
                        {
                            xmlWriter.WriteElementString("Prefix", "http://cloudfront.amazonaws.com/doc/2013-11-11/", loggingConfigLogging.Prefix.ToString());
                          }
                        xmlWriter.WriteEndElement();
                    }
                }
                ...
                {
                    xmlWriter.WriteElementString("PriceClass", "http://cloudfront.amazonaws.com/doc/2013-11-11/", distributionConfigDistributionConfig.PriceClass.ToString());
                  }
                if (distributionConfigDistributionConfig.IsSetEnabled()) 
                {
                    xmlWriter.WriteElementString("Enabled", "http://cloudfront.amazonaws.com/doc/2013-11-11/", distributionConfigDistributionConfig.Enabled.ToString().ToLower());
                  }
                if (distributionConfigDistributionConfig != null) 
                {
                    ...
                    if (viewerCertificateViewerCertificate != null) 
                    {
                        ...
                        {
                            xmlWriter.WriteElementString("IAMCertificateId", "http://cloudfront.amazonaws.com/doc/2013-11-11/", viewerCertificateViewerCertificate.IAMCertificateId.ToString());
                          }
                        if (viewerCertificateViewerCertificate.IsSetCloudFrontDefaultCertificate()) 
                        {
                            xmlWriter.WriteElementString("CloudFrontDefaultCertificate", "http://cloudfront.amazonaws.com/doc/2013-11-11/", viewerCertificateViewerCertificate.CloudFrontDefaultCertificate.ToString().ToLower());
                          }
                        xmlWriter.WriteEndElement();
                    }
                }
                    ...
                    if (restrictionsRestrictions != null) 
                    {
                        ...
                        if (restrictionsRestrictions != null) 
                        {
                            ...
                            if (geoRestrictionGeoRestriction != null) 
                            {
                                ...
                                {
                                    xmlWriter.WriteElementString("RestrictionType", "http://cloudfront.amazonaws.com/doc/2013-11-11/", geoRestrictionGeoRestriction.RestrictionType.ToString());
                                  }
                                if (geoRestrictionGeoRestriction.IsSetQuantity()) 
                                {
                                    xmlWriter.WriteElementString("Quantity", "http://cloudfront.amazonaws.com/doc/2013-11-11/", geoRestrictionGeoRestriction.Quantity.ToString());
                                  }
