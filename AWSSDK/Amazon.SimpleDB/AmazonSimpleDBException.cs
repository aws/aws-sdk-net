...
namespace Amazon.SimpleDB
{
    ...
    public class AmazonSimpleDBException : Exception, ISerializable
    {
        ...
        public AmazonSimpleDBException(string message, HttpStatusCode statusCode, Exception innerException)
        ...
        /// </param>
        protected AmazonSimpleDBException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("boxUsage", boxUsage, typeof(string));
