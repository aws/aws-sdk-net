...
namespace Amazon.DynamoDB.Model
{
    ...
    {
        private UpdateTableResult updateTableResult;
        ...
        public UpdateTableResult UpdateTableResult
        {
            get 
            {
                if(this.updateTableResult == null)
                {
                    this.updateTableResult = new UpdateTableResult();
                }

                return this.updateTableResult; 
            }
            set { this.updateTableResult = value; }
        }
    }
}
