...
namespace Amazon.DynamoDB.Model
{
    ...
    public class DeleteItemResult  
    {
        ...
        /// <summary>
        /// If the <c>ReturnValues</c> parameter is provided as <c>ALL_OLD</c> in the request, Amazon DynamoDB returns an array of attribute name-value
