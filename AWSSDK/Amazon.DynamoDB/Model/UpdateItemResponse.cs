...
namespace Amazon.DynamoDB.Model
{
    ...
    /// </summary>
    public class UpdateItemResponse : AmazonWebServiceResponse
    {
        ...
        public UpdateItemResult UpdateItemResult
        {
            get 
            {
                if(this.updateItemResult == null)
                {
                    this.updateItemResult = new UpdateItemResult();
                }

                return this.updateItemResult; 
            }
            set { this.updateItemResult = value; }
        }
    }
}
