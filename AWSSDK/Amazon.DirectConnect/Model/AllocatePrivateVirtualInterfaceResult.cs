...
namespace Amazon.DirectConnect.Model
{
    ...
    public class AllocatePrivateVirtualInterfaceResult
    {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public AllocatePrivateVirtualInterfaceResult WithVlan(int vlan)
        {
            this.vlan = vlan;
            return this;
        }
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public AllocatePrivateVirtualInterfaceResult WithAsn(int asn)
        {
            this.asn = asn;
            return this;
        }
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public AllocatePrivateVirtualInterfaceResult WithRouteFilterPrefixes(params RouteFilterPrefix[] routeFilterPrefixes)
        {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public AllocatePrivateVirtualInterfaceResult WithRouteFilterPrefixes(IEnumerable<RouteFilterPrefix> routeFilterPrefixes)
        {
            foreach (RouteFilterPrefix element in routeFilterPrefixes)
            {
                this.routeFilterPrefixes.Add(element);
