...
namespace Amazon.DirectConnect.Model
{
    ...
    public class DescribeConnectionsOnInterconnectResult
    {
        ...
        public DescribeConnectionsOnInterconnectResult WithConnections(params Connection[] connections)
        {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public DescribeConnectionsOnInterconnectResult WithConnections(IEnumerable<Connection> connections)
        {
            foreach (Connection element in connections)
            {
                this.connections.Add(element);
