...
namespace Amazon.DirectConnect.Model
{
    ...
    public class AllocatePublicVirtualInterfaceResult
    {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public AllocatePublicVirtualInterfaceResult WithVlan(int vlan)
        {
            this.vlan = vlan;
            return this;
        }
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public AllocatePublicVirtualInterfaceResult WithAsn(int asn)
        {
            this.asn = asn;
            return this;
        }
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public AllocatePublicVirtualInterfaceResult WithRouteFilterPrefixes(params RouteFilterPrefix[] routeFilterPrefixes)
        {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public AllocatePublicVirtualInterfaceResult WithRouteFilterPrefixes(IEnumerable<RouteFilterPrefix> routeFilterPrefixes)
        {
            foreach (RouteFilterPrefix element in routeFilterPrefixes)
            {
                this.routeFilterPrefixes.Add(element);
