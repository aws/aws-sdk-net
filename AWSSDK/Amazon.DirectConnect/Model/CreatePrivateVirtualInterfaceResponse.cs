...
{
    /// <summary>
    /// Returns information about the  CreatePrivateVirtualInterfaceResult response and response metadata.
    /// </summary>
    public class CreatePrivateVirtualInterfaceResponse : AmazonWebServiceResponse
    {
        private CreatePrivateVirtualInterfaceResult createPrivateVirtualInterfaceResult;

        /// <summary>
        /// Gets and sets the CreatePrivateVirtualInterfaceResult property.
