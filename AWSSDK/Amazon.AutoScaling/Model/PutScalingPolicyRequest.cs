...
namespace Amazon.AutoScaling.Model
{
    ...
    public partial class PutScalingPolicyRequest : AmazonWebServiceRequest
    {
        ...
        ///         the scaling policy changes the <code>DesiredCapacity</code> of the Auto Scaling
        ...
        /// determines the interpretation            of this number (e.g., as an absolute number
        /// or as            a percentage of the existing Auto Scaling group            size).
        /// A positive increment adds to the current            capacity and a negative value
