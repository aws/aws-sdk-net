...
{
    /// <summary>
    /// Response Unmarshaller for DescribeNotificationConfigurations Object
    /// </summary>  
    public class DescribeNotificationConfigurationsResultUnmarshaller : IUnmarshaller<DescribeNotificationConfigurationsResult, XmlUnmarshallerContext>
    {
        public DescribeNotificationConfigurationsResult Unmarshall(XmlUnmarshallerContext context) 
        {
            DescribeNotificationConfigurationsResult result = new DescribeNotificationConfigurationsResult();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = NotificationConfigurationUnmarshaller.GetInstance();
                        var item = unmarshaller.Unmarshall(context);
                        result.NotificationConfigurations.Add(item);
                        continue;
                    }
                } 
