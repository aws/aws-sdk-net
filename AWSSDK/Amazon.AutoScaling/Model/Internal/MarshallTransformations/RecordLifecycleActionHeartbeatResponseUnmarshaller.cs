...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    public class RecordLifecycleActionHeartbeatResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static RecordLifecycleActionHeartbeatResponseUnmarshaller instance;
        public static RecordLifecycleActionHeartbeatResponseUnmarshaller GetInstance()
        {
            if (instance == null)
            {
                instance = new RecordLifecycleActionHeartbeatResponseUnmarshaller();
            }
            return instance;
        }
