...
{
    /// <summary>
    /// Response Unmarshaller for DescribeLaunchConfigurations Object
    /// </summary>  
    public class DescribeLaunchConfigurationsResultUnmarshaller : IUnmarshaller<DescribeLaunchConfigurationsResult, XmlUnmarshallerContext>
    {
        public DescribeLaunchConfigurationsResult Unmarshall(XmlUnmarshallerContext context) 
        {
            DescribeLaunchConfigurationsResult result = new DescribeLaunchConfigurationsResult();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("LaunchConfigurations/member", targetDepth))
                    {
                        ...
                        result.LaunchConfigurations.Add(item);
                        continue;
                    }
