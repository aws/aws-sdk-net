...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CompleteLifecycleActionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static CompleteLifecycleActionResponseUnmarshaller instance;
        public static CompleteLifecycleActionResponseUnmarshaller GetInstance()
        {
            if (instance == null)
            {
                instance = new CompleteLifecycleActionResponseUnmarshaller();
            }
            return instance;
        }
