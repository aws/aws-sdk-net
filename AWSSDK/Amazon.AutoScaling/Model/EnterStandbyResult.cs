...
namespace Amazon.AutoScaling.Model
{
    ...
    /// 
    /// </summary>
    public partial class EnterStandbyResult
    {
        ...
        public EnterStandbyResult WithActivities(params Activity[] activities)
        {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public EnterStandbyResult WithActivities(IEnumerable<Activity> activities)
        {
            foreach (var element in activities)
            {
                this._activities.Add(element);
