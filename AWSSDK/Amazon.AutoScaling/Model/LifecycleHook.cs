...
namespace Amazon.AutoScaling.Model
{
    ...
    public partial class LifecycleHook
    {
        ...
        /// <summary>
        /// Sets the GlobalTimeout property
        /// </summary>
        /// <param name="globalTimeout">The value to set for the GlobalTimeout property </param>
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public LifecycleHook WithGlobalTimeout(int globalTimeout)
        {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public LifecycleHook WithHeartbeatTimeout(int heartbeatTimeout)
        {
