...
namespace Amazon.AutoScaling.Model
{
    ...
    /// 
    /// </summary>
    public partial class EnterStandbyRequest : AmazonWebServiceRequest
    {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public EnterStandbyRequest WithInstanceIds(params string[] instanceIds)
        {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public EnterStandbyRequest WithInstanceIds(IEnumerable<string> instanceIds)
        {
            foreach (var element in instanceIds)
            {
                this._instanceIds.Add(element);
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public EnterStandbyRequest WithShouldDecrementDesiredCapacity(bool shouldDecrementDesiredCapacity)
        {
