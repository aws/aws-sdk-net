...
{
    /// <summary>
    /// Returns information about the  ListMultipartUploadsResult response and response metadata.
    /// </summary>
    public class ListMultipartUploadsResponse : AmazonWebServiceResponse
    {
        ...
        public ListMultipartUploadsResult ListMultipartUploadsResult
        {
            get 
            {
                ...
                {
                    this.listMultipartUploadsResult = new ListMultipartUploadsResult();
                }

                return this.listMultipartUploadsResult; 
            }
            set { this.listMultipartUploadsResult = value; }
        }
    }
}
