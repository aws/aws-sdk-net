...
namespace Amazon.CloudTrail
{
    ...
    /// </summary>
    public partial class AmazonCloudTrailClient : AmazonWebServiceClient, AmazonCloudTrail
    {
        ...
        public AmazonCloudTrailClient()
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonCloudTrailConfig(), true, AuthenticationTypes.User | AuthenticationTypes.Session) { }
        ...
        public AmazonCloudTrailClient(RegionEndpoint region)
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonCloudTrailConfig(){RegionEndpoint = region}, true, AuthenticationTypes.User | AuthenticationTypes.Session) { }
