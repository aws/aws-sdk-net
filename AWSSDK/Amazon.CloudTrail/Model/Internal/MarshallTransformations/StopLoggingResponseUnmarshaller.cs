 ...
 */
    ...
    namespace Amazon.CloudTrail.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class StopLoggingResponseUnmarshaller : JsonResponseUnmarshaller
      {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
          ...
          response.StopLoggingResult = StopLoggingResultUnmarshaller.GetInstance().Unmarshall(context);
        ...
        private static StopLoggingResponseUnmarshaller instance;
