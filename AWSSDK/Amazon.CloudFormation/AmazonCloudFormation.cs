...
namespace Amazon.CloudFormation
{
    ...
    public interface AmazonCloudFormation : IDisposable
    {
        ...
        /// 
        GetStackPolicyResponse GetStackPolicy(GetStackPolicyRequest getStackPolicyRequest);
        ...
        ///         operation.</returns>
        IAsyncResult BeginGetStackPolicy(GetStackPolicyRequest getStackPolicyRequest, AsyncCallback callback, object state);
