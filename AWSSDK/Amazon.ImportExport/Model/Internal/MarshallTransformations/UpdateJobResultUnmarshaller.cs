...
namespace Amazon.ImportExport.Model.Internal.MarshallTransformations
{
     ...
     /// </summary>
    internal class UpdateJobResultUnmarshaller : IUnmarshaller<UpdateJobResult, XmlUnmarshallerContext> 
    {
        public UpdateJobResult Unmarshall(XmlUnmarshallerContext context) 
        {
