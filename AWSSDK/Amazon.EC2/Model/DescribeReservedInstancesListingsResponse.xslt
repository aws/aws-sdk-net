...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="ec2:DescribeReservedInstancesListingsResponse">
    <xsl:element name="DescribeReservedInstancesListingsResponse">
      <xsl:element name="ResponseMetadata">
        <xsl:element name="RequestId">
          <xsl:value-of select="ec2:requestId" />
        </xsl:element>
      </xsl:element>
      <xsl:element name="DescribeReservedInstancesListingsResult">
