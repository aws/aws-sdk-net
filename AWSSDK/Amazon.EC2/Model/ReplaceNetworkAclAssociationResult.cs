...
namespace Amazon.EC2.Model
{
    ...
    {    
        private string newAssociationIdField;

        /// <summary>
        /// Gets and sets the NewAssociationId property.
        /// The ID representing the new association.
        /// </summary>
        [XmlElementAttribute(ElementName = "NewAssociationId")]
        public string NewAssociationId
        {
            get { return this.newAssociationIdField; }
            set { this.newAssociationIdField = value; }
        }
        ...
        public bool IsSetNewAssociationId()
        {
            return this.newAssociationIdField != null;
        }
