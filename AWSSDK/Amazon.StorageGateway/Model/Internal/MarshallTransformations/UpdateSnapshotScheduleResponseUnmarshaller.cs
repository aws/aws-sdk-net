 ...
 */ 
    ...
    { 
      ...
      /// </summary> 
      internal class UpdateSnapshotScheduleResponseUnmarshaller : JsonResponseUnmarshaller 
      { 
        ...
        private static UpdateSnapshotScheduleResponseUnmarshaller instance; 
        public static UpdateSnapshotScheduleResponseUnmarshaller GetInstance() 
        { 
          if (instance == null) 
          { 
            instance = new UpdateSnapshotScheduleResponseUnmarshaller(); 
          } 
          return instance;
        } 
