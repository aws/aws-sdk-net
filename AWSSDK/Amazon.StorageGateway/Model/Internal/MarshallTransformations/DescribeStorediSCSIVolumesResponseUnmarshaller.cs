 ...
 */ 
    ...
    { 
      /// <summary> 
      /// Response Unmarshaller for DescribeStorediSCSIVolumes operation 
      /// </summary> 
      internal class DescribeStorediSCSIVolumesResponseUnmarshaller : JsonResponseUnmarshaller 
      { 
        ...
        { 
          ...
          response.DescribeStorediSCSIVolumesResult = DescribeStorediSCSIVolumesResultUnmarshaller.GetInstance().Unmarshall(context); 
        ...
        private static DescribeStorediSCSIVolumesResponseUnmarshaller instance; 
        public static DescribeStorediSCSIVolumesResponseUnmarshaller GetInstance() 
        { 
          if (instance == null) 
          { 
            instance = new DescribeStorediSCSIVolumesResponseUnmarshaller(); 
          } 
          return instance;
        } 
