 ...
 */
    ...
    {
      /// <summary>
      /// Response Unmarshaller for DeleteTapeArchive operation
      /// </summary>
      internal class DeleteTapeArchiveResponseUnmarshaller : JsonResponseUnmarshaller
      {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
          ...
          response.DeleteTapeArchiveResult = DeleteTapeArchiveResultUnmarshaller.GetInstance().Unmarshall(context);
        ...
        private static DeleteTapeArchiveResponseUnmarshaller instance;
        public static DeleteTapeArchiveResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new DeleteTapeArchiveResponseUnmarshaller();
          }
          return instance;
        }
