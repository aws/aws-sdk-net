 ...
 */
    ...
    namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class DescribeTapeRecoveryPointsResponseUnmarshaller : JsonResponseUnmarshaller
      {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
          ...
          response.DescribeTapeRecoveryPointsResult = DescribeTapeRecoveryPointsResultUnmarshaller.GetInstance().Unmarshall(context);
        ...
        private static DescribeTapeRecoveryPointsResponseUnmarshaller instance;
        public static DescribeTapeRecoveryPointsResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new DescribeTapeRecoveryPointsResponseUnmarshaller();
          }
          return instance;
        }
