 ...
 */ 
    ...
    { 
      /// <summary> 
      /// Response Unmarshaller for StartGateway operation 
      /// </summary> 
      internal class StartGatewayResponseUnmarshaller : JsonResponseUnmarshaller 
      { 
        ...
        private static StartGatewayResponseUnmarshaller instance; 
        public static StartGatewayResponseUnmarshaller GetInstance() 
        { 
          if (instance == null) 
          { 
            instance = new StartGatewayResponseUnmarshaller(); 
          } 
          return instance;
        } 
