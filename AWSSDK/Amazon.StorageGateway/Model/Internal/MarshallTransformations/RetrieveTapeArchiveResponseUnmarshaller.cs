 ...
 */
    ...
    namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class RetrieveTapeArchiveResponseUnmarshaller : JsonResponseUnmarshaller
      {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
          ...
          response.RetrieveTapeArchiveResult = RetrieveTapeArchiveResultUnmarshaller.GetInstance().Unmarshall(context);
        ...
        private static RetrieveTapeArchiveResponseUnmarshaller instance;
