 ...
 */
    ...
    {
      /// <summary>
      /// Response Unmarshaller for CancelRetrieval operation
      /// </summary>
      internal class CancelRetrievalResponseUnmarshaller : JsonResponseUnmarshaller
      {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
          CancelRetrievalResponse response = new CancelRetrievalResponse();
          
          context.Read();
      
          response.CancelRetrievalResult = CancelRetrievalResultUnmarshaller.GetInstance().Unmarshall(context);
        ...
        private static CancelRetrievalResponseUnmarshaller instance;
        public static CancelRetrievalResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new CancelRetrievalResponseUnmarshaller();
          }
          return instance;
        }
