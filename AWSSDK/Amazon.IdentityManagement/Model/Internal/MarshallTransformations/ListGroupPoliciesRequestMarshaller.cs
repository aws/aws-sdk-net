...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListGroupPoliciesRequestMarshaller : IMarshaller<IRequest, ListGroupPoliciesRequest>
    {
        public IRequest Marshall(ListGroupPoliciesRequest listGroupPoliciesRequest)
        {
            IRequest request = new DefaultRequest(listGroupPoliciesRequest, "AmazonIdentityManagementService");
