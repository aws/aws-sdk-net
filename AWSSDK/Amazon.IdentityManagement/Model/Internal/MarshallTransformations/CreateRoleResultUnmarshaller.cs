...
{
    /// <summary>
    /// Response Unmarshaller for CreateRole Object
    /// </summary>  
    public class CreateRoleResultUnmarshaller : IUnmarshaller<CreateRoleResult, XmlUnmarshallerContext>
    {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("Role", targetDepth))
                    {
                        ...
                        result.Role = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
