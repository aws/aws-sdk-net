...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DeleteAccountPasswordPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static DeleteAccountPasswordPolicyResponseUnmarshaller instance;

        public static DeleteAccountPasswordPolicyResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DeleteAccountPasswordPolicyResponseUnmarshaller();
            }
            return instance;
        }
