...
{
    /// <summary>
    /// Response Unmarshaller for ListServerCertificates Object
    /// </summary>  
    public class ListServerCertificatesResultUnmarshaller : IUnmarshaller<ListServerCertificatesResult, XmlUnmarshallerContext>
    {
        public ListServerCertificatesResult Unmarshall(XmlUnmarshallerContext context) 
        {
            ListServerCertificatesResult result = new ListServerCertificatesResult();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("ServerCertificateMetadataList/member", targetDepth))
                    {
                        ...
                        result.ServerCertificateMetadataList.Add(item);
                        continue;
                    }
                } 
