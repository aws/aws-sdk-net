...
{
    /// <summary>
    /// Response Unmarshaller for GetRolePolicy Object
    /// </summary>  
    public class GetRolePolicyResultUnmarshaller : IUnmarshaller<GetRolePolicyResult, XmlUnmarshallerContext>
    {
        public GetRolePolicyResult Unmarshall(XmlUnmarshallerContext context) 
        {
            GetRolePolicyResult result = new GetRolePolicyResult();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.GetInstance();
                        result.RoleName = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
