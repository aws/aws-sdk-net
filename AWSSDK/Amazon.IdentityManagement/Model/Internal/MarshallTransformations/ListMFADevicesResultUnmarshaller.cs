...
{
    /// <summary>
    /// Response Unmarshaller for ListMFADevices Object
    /// </summary>  
    public class ListMFADevicesResultUnmarshaller : IUnmarshaller<ListMFADevicesResult, XmlUnmarshallerContext>
    {
        public ListMFADevicesResult Unmarshall(XmlUnmarshallerContext context) 
        {
            ListMFADevicesResult result = new ListMFADevicesResult();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = MFADeviceUnmarshaller.GetInstance();
                        var item = unmarshaller.Unmarshall(context);
                        result.MFADevices.Add(item);
                        continue;
                    }
                } 
