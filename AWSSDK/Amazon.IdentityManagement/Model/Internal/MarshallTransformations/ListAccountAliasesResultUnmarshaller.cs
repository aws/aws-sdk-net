...
{
    /// <summary>
    /// Response Unmarshaller for ListAccountAliases Object
    /// </summary>  
    public class ListAccountAliasesResultUnmarshaller : IUnmarshaller<ListAccountAliasesResult, XmlUnmarshallerContext>
    {
        public ListAccountAliasesResult Unmarshall(XmlUnmarshallerContext context) 
        {
            ListAccountAliasesResult result = new ListAccountAliasesResult();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("AccountAliases/member", targetDepth))
                    {
                        ...
                        result.AccountAliases.Add(item);
                        continue;
                    }
