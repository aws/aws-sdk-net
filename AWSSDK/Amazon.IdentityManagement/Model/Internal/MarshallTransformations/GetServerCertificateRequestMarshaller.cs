...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    {
        public IRequest Marshall(GetServerCertificateRequest getServerCertificateRequest)
        {
            IRequest request = new DefaultRequest(getServerCertificateRequest, "AmazonIdentityManagementService");
