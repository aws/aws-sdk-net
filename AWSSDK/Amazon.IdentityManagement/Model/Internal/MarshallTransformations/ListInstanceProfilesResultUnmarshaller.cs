...
{
    /// <summary>
    /// Response Unmarshaller for ListInstanceProfiles Object
    /// </summary>  
    public class ListInstanceProfilesResultUnmarshaller : IUnmarshaller<ListInstanceProfilesResult, XmlUnmarshallerContext>
    {
        public ListInstanceProfilesResult Unmarshall(XmlUnmarshallerContext context) 
        {
            ListInstanceProfilesResult result = new ListInstanceProfilesResult();
