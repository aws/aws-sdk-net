...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class UpdateAssumeRolePolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {

        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            UpdateAssumeRolePolicyResponse response = new UpdateAssumeRolePolicyResponse();
        ...
        private static UpdateAssumeRolePolicyResponseUnmarshaller instance;

        public static UpdateAssumeRolePolicyResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new UpdateAssumeRolePolicyResponseUnmarshaller();
            }
            return instance;
        }
