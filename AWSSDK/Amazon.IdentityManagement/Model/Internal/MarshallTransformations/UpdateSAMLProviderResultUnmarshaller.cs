...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSAMLProvider Object
    /// </summary>  
    public class UpdateSAMLProviderResultUnmarshaller : IUnmarshaller<UpdateSAMLProviderResult, XmlUnmarshallerContext>
    {
        public UpdateSAMLProviderResult Unmarshall(XmlUnmarshallerContext context) 
        {
            UpdateSAMLProviderResult result = new UpdateSAMLProviderResult();
