...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    {
        public IRequest Marshall(ListMFADevicesRequest listMFADevicesRequest)
        {
            IRequest request = new DefaultRequest(listMFADevicesRequest, "AmazonIdentityManagementService");
