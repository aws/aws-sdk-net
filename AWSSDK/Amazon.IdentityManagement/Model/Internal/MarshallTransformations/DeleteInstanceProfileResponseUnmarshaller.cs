...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DeleteInstanceProfileResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static DeleteInstanceProfileResponseUnmarshaller instance;

        public static DeleteInstanceProfileResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DeleteInstanceProfileResponseUnmarshaller();
            }
            return instance;
        }
