...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    {
        public IRequest Marshall(UpdateSigningCertificateRequest updateSigningCertificateRequest)
        {
            IRequest request = new DefaultRequest(updateSigningCertificateRequest, "AmazonIdentityManagementService");
