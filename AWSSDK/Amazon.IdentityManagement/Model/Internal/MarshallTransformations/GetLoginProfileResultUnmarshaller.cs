...
{
    /// <summary>
    /// Response Unmarshaller for GetLoginProfile Object
    /// </summary>  
    public class GetLoginProfileResultUnmarshaller : IUnmarshaller<GetLoginProfileResult, XmlUnmarshallerContext>
    {
        public GetLoginProfileResult Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = LoginProfileUnmarshaller.GetInstance();
                        result.LoginProfile = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
