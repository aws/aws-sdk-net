...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DeleteUserPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {

        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            DeleteUserPolicyResponse response = new DeleteUserPolicyResponse();
        ...
        private static DeleteUserPolicyResponseUnmarshaller instance;
