...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class GetRolePolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)                
                {
                    ...
                    {
                        response.GetRolePolicyResult = GetRolePolicyResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static GetRolePolicyResponseUnmarshaller instance;
