...
{
    /// <summary>
    /// Response Unmarshaller for CreateInstanceProfile Object
    /// </summary>  
    public class CreateInstanceProfileResultUnmarshaller : IUnmarshaller<CreateInstanceProfileResult, XmlUnmarshallerContext>
    {
        public CreateInstanceProfileResult Unmarshall(XmlUnmarshallerContext context) 
        {
            CreateInstanceProfileResult result = new CreateInstanceProfileResult();
