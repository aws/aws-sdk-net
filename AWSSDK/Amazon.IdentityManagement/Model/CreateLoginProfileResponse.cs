...
namespace Amazon.IdentityManagement.Model
{
    ...
    {
        private CreateLoginProfileResult _createLoginProfileResult;
        ...
        public CreateLoginProfileResult CreateLoginProfileResult
        {
            get
            {
                if(this._createLoginProfileResult == null)
                {
                    this._createLoginProfileResult = new CreateLoginProfileResult();
                }
                return this._createLoginProfileResult;
            }
            set { this._createLoginProfileResult = value; }
        }
    }
}