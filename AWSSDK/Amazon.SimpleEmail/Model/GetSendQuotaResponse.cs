...
namespace Amazon.SimpleEmail.Model
{
    ...
    {
        private GetSendQuotaResult _getSendQuotaResult;
        ...
        public GetSendQuotaResult GetSendQuotaResult
        {
            get
            {
                if(this._getSendQuotaResult == null)
                {
                    this._getSendQuotaResult = new GetSendQuotaResult();
                }
                return this._getSendQuotaResult;
            }
            set { this._getSendQuotaResult = value; }
        }
    }
}