...
namespace Amazon.SimpleEmail.Model
{
    ...
    public partial class SendRawEmailRequest : AmazonWebServiceRequest
    {
        ...
        public SendRawEmailRequest WithDestinations(params string[] destinations)
        {
            ...
            {
                this._destinations.Add(element);
            }
            return this;
        }
        ...
        /// then bounce notifications and            complaints will be sent to this email address.
        /// This takes precedence over any            <i>Return-Path</i>            header that
        /// you might include in the raw text of the message.        </note>
        /// </summary>
