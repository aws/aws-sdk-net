...
namespace Amazon.SimpleEmail.Model
{
    ...
    {
        private DeleteIdentityResult deleteIdentityResult;
        ...
        public DeleteIdentityResult DeleteIdentityResult
        {
            get 
            {
                if(this.deleteIdentityResult == null)
                {
                    this.deleteIdentityResult = new DeleteIdentityResult();
                }

                return this.deleteIdentityResult; 
            }
            set { this.deleteIdentityResult = value; }
        }
    }
}
