...
namespace Amazon.SimpleEmail.Model
{
    ...
    {
        private SetIdentityNotificationTopicResult _setIdentityNotificationTopicResult;
        ...
        public SetIdentityNotificationTopicResult SetIdentityNotificationTopicResult
        {
            get
            {
                if(this._setIdentityNotificationTopicResult == null)
                {
                    this._setIdentityNotificationTopicResult = new SetIdentityNotificationTopicResult();
                }
                return this._setIdentityNotificationTopicResult;
            }
            set { this._setIdentityNotificationTopicResult = value; }
        }
    }
}