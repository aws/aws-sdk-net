...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    {
        public IRequest Marshall(GetSendStatisticsRequest getSendStatisticsRequest)
        {
            IRequest request = new DefaultRequest(getSendStatisticsRequest, "AmazonSimpleEmailService");
