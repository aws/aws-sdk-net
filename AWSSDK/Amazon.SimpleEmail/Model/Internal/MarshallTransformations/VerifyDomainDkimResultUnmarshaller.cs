...
{
     /// <summary>
     ///   VerifyDomainDkimResult Unmarshaller
     /// </summary>
    internal class VerifyDomainDkimResultUnmarshaller : IUnmarshaller<VerifyDomainDkimResult, XmlUnmarshallerContext>, IUnmarshaller<VerifyDomainDkimResult, JsonUnmarshallerContext> 
    {
        public VerifyDomainDkimResult Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                ...
                { 
                    ...
                    {
                        verifyDomainDkimResult.DkimTokens.Add(StringUnmarshaller.GetInstance().Unmarshall(context));
        ...
        public VerifyDomainDkimResult Unmarshall(JsonUnmarshallerContext context) 
        {
            return null;
        }
