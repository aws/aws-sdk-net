...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class DeleteIdentityResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)                
                {
                    ...
                    {
                        response.DeleteIdentityResult = DeleteIdentityResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static DeleteIdentityResponseUnmarshaller instance;
