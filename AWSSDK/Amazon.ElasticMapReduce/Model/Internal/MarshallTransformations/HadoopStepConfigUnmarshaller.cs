...
namespace Amazon.ElasticMapReduce.Model.Internal.MarshallTransformations
{
    ...
    public class HadoopStepConfigUnmarshaller : IUnmarshaller<HadoopStepConfig, XmlUnmarshallerContext>, IUnmarshaller<HadoopStepConfig, JsonUnmarshallerContext>
    {
        ...
        public HadoopStepConfig Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            var unmarshalledObject = new HadoopStepConfig();
            ...
            while (context.Read())
            {
                if ((context.IsKey) && (context.CurrentDepth == targetDepth))
                {
                    ...
                    if (context.TestExpression("Properties", targetDepth))
                    {
                        ...
                        unmarshalledObject.Properties = new Dictionary<string, string>();
                        ...
                        while (context.Read())
                        {
                              ...
                              ((context.IsKey) && (context.CurrentDepth == targetDepth+1)))
                          {
                            ...
                            unmarshalledObject.Properties.Add(kvp.Key, kvp.Value);
                          }
