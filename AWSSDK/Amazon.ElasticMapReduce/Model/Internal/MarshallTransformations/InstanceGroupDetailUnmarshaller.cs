...
namespace Amazon.ElasticMapReduce.Model.Internal.MarshallTransformations
{
    ...
    public class InstanceGroupDetailUnmarshaller : IUnmarshaller<InstanceGroupDetail, XmlUnmarshallerContext>, IUnmarshaller<InstanceGroupDetail, JsonUnmarshallerContext>
    {
        ...
        public InstanceGroupDetail Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            var unmarshalledObject = new InstanceGroupDetail();
            ...
            while (context.Read())
            {
                if ((context.IsKey) && (context.CurrentDepth == targetDepth))
                {
                    ...
                    {
                        unmarshalledObject.InstanceGroupId = StringUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("InstanceRequestCount", targetDepth))
                    {
                        unmarshalledObject.InstanceRequestCount = IntUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("InstanceRole", targetDepth))
                    {
                        unmarshalledObject.InstanceRole = StringUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("InstanceRunningCount", targetDepth))
                    {
                        unmarshalledObject.InstanceRunningCount = IntUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
