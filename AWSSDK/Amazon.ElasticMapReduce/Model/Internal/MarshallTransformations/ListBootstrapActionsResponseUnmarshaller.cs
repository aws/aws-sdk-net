...
namespace Amazon.ElasticMapReduce.Model.Internal.MarshallTransformations
{
    ...
    public class ListBootstrapActionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        {
            var response = new ListBootstrapActionsResponse();
            context.Read();
            response.ListBootstrapActionsResult = ListBootstrapActionsResultUnmarshaller.GetInstance().Unmarshall(context);
            return response;
        }
        ...
        private static ListBootstrapActionsResponseUnmarshaller instance;
