...
{
    /// <summary>
    /// Response Unmarshaller for RunJobFlow Object
    /// </summary>  
    public class RunJobFlowResultUnmarshaller : IUnmarshaller<RunJobFlowResult, XmlUnmarshallerContext>, IUnmarshaller<RunJobFlowResult, JsonUnmarshallerContext>
    {
        ...
        public RunJobFlowResult Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            var unmarshalledObject = new RunJobFlowResult();
