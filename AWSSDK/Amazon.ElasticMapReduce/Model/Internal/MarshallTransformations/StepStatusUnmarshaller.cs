...
namespace Amazon.ElasticMapReduce.Model.Internal.MarshallTransformations
{
    ...
    public class StepStatusUnmarshaller : IUnmarshaller<StepStatus, XmlUnmarshallerContext>, IUnmarshaller<StepStatus, JsonUnmarshallerContext>
    {
        ...
        public StepStatus Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            var unmarshalledObject = new StepStatus();
            ...
            while (context.Read())
            {
                if ((context.IsKey) && (context.CurrentDepth == targetDepth))
                {
                    ...
                    {
                        unmarshalledObject.StateChangeReason = StepStateChangeReasonUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("Timeline", targetDepth))
                    {
                        unmarshalledObject.Timeline = StepTimelineUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                }
