...
namespace Amazon.ElasticMapReduce.Model.Internal.MarshallTransformations
{
    ...
    public class Ec2InstanceAttributesUnmarshaller : IUnmarshaller<Ec2InstanceAttributes, XmlUnmarshallerContext>, IUnmarshaller<Ec2InstanceAttributes, JsonUnmarshallerContext>
    {
        ...
        public Ec2InstanceAttributes Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            var unmarshalledObject = new Ec2InstanceAttributes();
            ...
            while (context.Read())
            {
                if ((context.IsKey) && (context.CurrentDepth == targetDepth))
                {
                    ...
                    {
                        unmarshalledObject.Ec2AvailabilityZone = StringUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                    ...
                    {
                        unmarshalledObject.IamInstanceProfile = StringUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                }
