...
namespace Amazon.ElasticMapReduce.Model.Internal.MarshallTransformations
{
    ...
    public class RemoveTagsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        {
            var response = new RemoveTagsResponse();
            context.Read();
            response.RemoveTagsResult = RemoveTagsResultUnmarshaller.GetInstance().Unmarshall(context);
            return response;
        }
        ...
        private static RemoveTagsResponseUnmarshaller instance;
