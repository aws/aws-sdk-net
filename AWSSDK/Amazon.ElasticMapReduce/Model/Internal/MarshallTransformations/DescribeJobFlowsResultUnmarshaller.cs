...
{
    /// <summary>
    /// Response Unmarshaller for DescribeJobFlows Object
    /// </summary>  
    public class DescribeJobFlowsResultUnmarshaller : IUnmarshaller<DescribeJobFlowsResult, XmlUnmarshallerContext>, IUnmarshaller<DescribeJobFlowsResult, JsonUnmarshallerContext>
    {
        ...
        public DescribeJobFlowsResult Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            var unmarshalledObject = new DescribeJobFlowsResult();
                ...
                if ((context.IsKey) && (context.CurrentDepth == targetDepth))
                {
                    ...
                    if (context.TestExpression("JobFlows", targetDepth))
                    {
                        ...
                        while (context.Read())
                        {
                          ...
                          {
                             unmarshalledObject.JobFlows.Add(unmarshaller.Unmarshall(context));
                          }
