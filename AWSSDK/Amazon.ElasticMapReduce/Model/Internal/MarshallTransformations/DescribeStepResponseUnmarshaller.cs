...
namespace Amazon.ElasticMapReduce.Model.Internal.MarshallTransformations
{
    ...
    public class DescribeStepResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        {
            var response = new DescribeStepResponse();
            context.Read();
            response.DescribeStepResult = DescribeStepResultUnmarshaller.GetInstance().Unmarshall(context);
            return response;
        }
        ...
        private static DescribeStepResponseUnmarshaller instance;
        public static DescribeStepResponseUnmarshaller GetInstance()
        {
            if (instance == null)
            {
                instance = new DescribeStepResponseUnmarshaller();
            }
            return instance;
        }
