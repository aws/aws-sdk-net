...
namespace Amazon.ElasticMapReduce.Model
{
    ...
    {
        private DescribeJobFlowsResult _describeJobFlowsResult;
        ...
        public DescribeJobFlowsResult DescribeJobFlowsResult
        {
            get
            {
                if(this._describeJobFlowsResult == null)
                {
                    this._describeJobFlowsResult = new DescribeJobFlowsResult();
                }
                return this._describeJobFlowsResult;
            }
            set { this._describeJobFlowsResult = value; }
        }
    }
}