...
namespace Amazon.ElasticMapReduce.Model
{
    ...
    {
        private DescribeClusterResult _describeClusterResult;
        ...
        public DescribeClusterResult DescribeClusterResult
        {
            get
            {
                if(this._describeClusterResult == null)
                {
                    this._describeClusterResult = new DescribeClusterResult();
                }
                return this._describeClusterResult;
            }
            set { this._describeClusterResult = value; }
        }
    }
}