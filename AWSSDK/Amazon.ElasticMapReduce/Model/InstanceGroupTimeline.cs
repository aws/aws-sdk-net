...
namespace Amazon.ElasticMapReduce.Model
{
    ...
    public partial class InstanceGroupTimeline
    {
        ...
        public InstanceGroupTimeline WithCreationDateTime(DateTime creationDateTime)
        {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public InstanceGroupTimeline WithEndDateTime(DateTime endDateTime)
        {
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public InstanceGroupTimeline WithReadyDateTime(DateTime readyDateTime)
        {
