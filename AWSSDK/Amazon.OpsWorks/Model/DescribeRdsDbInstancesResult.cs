...
namespace Amazon.OpsWorks.Model
{
    ...
    /// </summary>
    public partial class DescribeRdsDbInstancesResult
    {
        ...
        /// <summary>
        /// Sets the RdsDbInstances property
        /// </summary>
        /// <param name="rdsDbInstances">The values to add to the RdsDbInstances collection </param>
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public DescribeRdsDbInstancesResult WithRdsDbInstances(params RdsDbInstance[] rdsDbInstances)
        {
            foreach (var element in rdsDbInstances)
            {
                this._rdsDbInstances.Add(element);
            }
            return this;
        }
        ...
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public DescribeRdsDbInstancesResult WithRdsDbInstances(IEnumerable<RdsDbInstance> rdsDbInstances)
        {
            foreach (var element in rdsDbInstances)
            {
                this._rdsDbInstances.Add(element);
