 ...
 */
    ...
    {
      /// <summary>
      /// DescribeLayersResultUnmarshaller
      /// </summary>
      internal class DescribeLayersResultUnmarshaller : IUnmarshaller<DescribeLayersResult, XmlUnmarshallerContext>, IUnmarshaller<DescribeLayersResult, JsonUnmarshallerContext>
      {
        ...
        public DescribeLayersResult Unmarshall(JsonUnmarshallerContext context)
        {
          ...
          describeLayersResult.Layers = null;
            ...
            while (context.Read())
            {
              ...
              {
                describeLayersResult.Layers = new List<Layer>();
                        LayerUnmarshaller unmarshaller = LayerUnmarshaller.GetInstance();
                while (context.Read())
                {
                  if ((context.IsArrayElement) && (context.CurrentDepth == targetDepth))
                  {
                     describeLayersResult.Layers.Add(unmarshaller.Unmarshall(context));
                  }
