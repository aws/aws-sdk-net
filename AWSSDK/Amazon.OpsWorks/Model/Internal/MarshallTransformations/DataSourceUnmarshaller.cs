...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    public class DataSourceUnmarshaller : IUnmarshaller<DataSource, XmlUnmarshallerContext>, IUnmarshaller<DataSource, JsonUnmarshallerContext>
    {
        ...
        public DataSource Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.Read())
            {
                if ((context.IsKey) && (context.CurrentDepth == targetDepth))
                {
                    ...
                    {
                        unmarshalledObject.DatabaseName = StringUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static DataSourceUnmarshaller instance;
        public static DataSourceUnmarshaller GetInstance()
        {
            if (instance == null)
            {
                instance = new DataSourceUnmarshaller();
            }
            return instance;
        }
