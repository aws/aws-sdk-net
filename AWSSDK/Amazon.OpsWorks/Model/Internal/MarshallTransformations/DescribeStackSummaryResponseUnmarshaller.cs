...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    public class DescribeStackSummaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        {
            var response = new DescribeStackSummaryResponse();
            context.Read();
            response.DescribeStackSummaryResult = DescribeStackSummaryResultUnmarshaller.GetInstance().Unmarshall(context);
            return response;
        }
