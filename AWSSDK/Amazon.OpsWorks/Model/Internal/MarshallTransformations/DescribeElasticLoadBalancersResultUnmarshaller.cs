...
{
    /// <summary>
    /// Response Unmarshaller for DescribeElasticLoadBalancers Object
    /// </summary>  
    public class DescribeElasticLoadBalancersResultUnmarshaller : IUnmarshaller<DescribeElasticLoadBalancersResult, XmlUnmarshallerContext>, IUnmarshaller<DescribeElasticLoadBalancersResult, JsonUnmarshallerContext>
    {
        ...
        public DescribeElasticLoadBalancersResult Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            var unmarshalledObject = new DescribeElasticLoadBalancersResult();
                ...
                if ((context.IsKey) && (context.CurrentDepth == targetDepth))
                {
                    ...
                    if (context.TestExpression("ElasticLoadBalancers", targetDepth))
                    {
                        ...
                        while (context.Read())
                        {
                          ...
                          {
                             unmarshalledObject.ElasticLoadBalancers.Add(unmarshaller.Unmarshall(context));
                          }
