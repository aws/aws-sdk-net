 ...
 */
    ...
    {
      /// <summary>
      /// Response Unmarshaller for AttachElasticLoadBalancer operation
      /// </summary>
      internal class AttachElasticLoadBalancerResponseUnmarshaller : JsonResponseUnmarshaller
      {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
          AttachElasticLoadBalancerResponse response = new AttachElasticLoadBalancerResponse();
