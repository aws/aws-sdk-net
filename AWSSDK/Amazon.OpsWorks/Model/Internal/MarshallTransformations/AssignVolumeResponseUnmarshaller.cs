 ...
 */
    ...
    {
      /// <summary>
      /// Response Unmarshaller for AssignVolume operation
      /// </summary>
      internal class AssignVolumeResponseUnmarshaller : JsonResponseUnmarshaller
      {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
          AssignVolumeResponse response = new AssignVolumeResponse();
