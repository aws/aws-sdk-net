...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    public class DeregisterRdsDbInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        {
            var response = new DeregisterRdsDbInstanceResponse();
            return response;
        }
        ...
        private static DeregisterRdsDbInstanceResponseUnmarshaller instance;
        public static DeregisterRdsDbInstanceResponseUnmarshaller GetInstance()
        {
            if (instance == null)
            {
                instance = new DeregisterRdsDbInstanceResponseUnmarshaller();
            }
            return instance;
        }
