...
{
    /// <summary>
    /// Response Unmarshaller for StopStack operation
    /// </summary>  
    public class StopStackResponseUnmarshaller : JsonResponseUnmarshaller
    {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            var response = new StopStackResponse();
            return response;
        }
        ...
        private static StopStackResponseUnmarshaller instance;
