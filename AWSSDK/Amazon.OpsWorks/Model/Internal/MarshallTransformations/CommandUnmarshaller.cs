...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    public class CommandUnmarshaller : IUnmarshaller<Command, XmlUnmarshallerContext>, IUnmarshaller<Command, JsonUnmarshallerContext>
    {
        ...
        public Command Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            var unmarshalledObject = new Command();
            ...
            while (context.Read())
            {
                if ((context.IsKey) && (context.CurrentDepth == targetDepth))
                {
                    ...
                    {
                        unmarshalledObject.AcknowledgedAt = StringUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("CommandId", targetDepth))
                    {
                        unmarshalledObject.CommandId = StringUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                    ...
                    {
                        unmarshalledObject.ExitCode = IntUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                    ...
                    {
                        unmarshalledObject.LogUrl = StringUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
