 ...
 */
    ...
    namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class DescribeServiceErrorsResponseUnmarshaller : JsonResponseUnmarshaller
      {
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
          ...
          response.DescribeServiceErrorsResult = DescribeServiceErrorsResultUnmarshaller.GetInstance().Unmarshall(context);
        ...
        private static DescribeServiceErrorsResponseUnmarshaller instance;
        public static DescribeServiceErrorsResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new DescribeServiceErrorsResponseUnmarshaller();
          }
          return instance;
        }
