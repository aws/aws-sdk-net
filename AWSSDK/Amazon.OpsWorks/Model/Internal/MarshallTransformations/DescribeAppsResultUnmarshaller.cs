 ...
 */
    ...
    {
      /// <summary>
      /// DescribeAppsResultUnmarshaller
      /// </summary>
      internal class DescribeAppsResultUnmarshaller : IUnmarshaller<DescribeAppsResult, XmlUnmarshallerContext>, IUnmarshaller<DescribeAppsResult, JsonUnmarshallerContext>
      {
        ...
        public DescribeAppsResult Unmarshall(JsonUnmarshallerContext context)
        {
          ...
          describeAppsResult.Apps = null;
            ...
            while (context.Read())
            {
              ...
              {
                describeAppsResult.Apps = new List<App>();
                        AppUnmarshaller unmarshaller = AppUnmarshaller.GetInstance();
                while (context.Read())
                {
                  if ((context.IsArrayElement) && (context.CurrentDepth == targetDepth))
                  {
                     describeAppsResult.Apps.Add(unmarshaller.Unmarshall(context));
                  }
