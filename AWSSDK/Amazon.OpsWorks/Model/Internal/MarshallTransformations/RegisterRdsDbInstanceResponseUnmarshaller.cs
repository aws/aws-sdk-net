...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    public class RegisterRdsDbInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        {
            var response = new RegisterRdsDbInstanceResponse();
            return response;
        }
        ...
        private static RegisterRdsDbInstanceResponseUnmarshaller instance;
        public static RegisterRdsDbInstanceResponseUnmarshaller GetInstance()
        {
            if (instance == null)
            {
                instance = new RegisterRdsDbInstanceResponseUnmarshaller();
            }
            return instance;
        }
