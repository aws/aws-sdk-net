...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DetachElasticLoadBalancerRequestMarshaller : IMarshaller<IRequest, DetachElasticLoadBalancerRequest> 
    {
        public IRequest Marshall(DetachElasticLoadBalancerRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest != null && publicRequest.IsSetElasticLoadBalancerName())
                {
