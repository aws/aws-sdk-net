...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateRdsDbInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        {
            var response = new UpdateRdsDbInstanceResponse();
            return response;
        }
        ...
        private static UpdateRdsDbInstanceResponseUnmarshaller instance;
        public static UpdateRdsDbInstanceResponseUnmarshaller GetInstance()
        {
            if (instance == null)
            {
                instance = new UpdateRdsDbInstanceResponseUnmarshaller();
            }
            return instance;
        }
