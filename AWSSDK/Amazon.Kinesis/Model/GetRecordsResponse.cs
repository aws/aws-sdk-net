...
{
    /// <summary>
    /// Returns information about the  GetRecordsResult response and response metadata.
    /// </summary>
    public class GetRecordsResponse : AmazonWebServiceResponse
    {
        ...
        public GetRecordsResult GetRecordsResult
        {
            get
            {
                ...
                {
                    this.getRecordsResult = new GetRecordsResult();
                }

                return this.getRecordsResult;
            }
            set { this.getRecordsResult = value; }
        }
    }
}
