...
namespace Amazon.Kinesis.Model
{
    ...
    /// account.</para>
    /// </summary>
    /// <seealso cref="Amazon.Kinesis.AmazonKinesis.ListStreams"/>
    public class ListStreamsRequest : AmazonWebServiceRequest
    {
        ...
        public ListStreamsRequest WithLimit(int limit)
        {
            this.limit = limit;
            return this;
        }
        ...
        /// </summary>
        /// <param name="exclusiveStartStreamName">The value to set for the ExclusiveStartStreamName property </param>
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
