 ...
 */
    ...
    namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
    {
      ...
      /// </summary>
      internal class DeleteStreamResponseUnmarshaller : JsonResponseUnmarshaller
      {
        ...
        private static DeleteStreamResponseUnmarshaller instance;
        public static DeleteStreamResponseUnmarshaller GetInstance()
        {
          if (instance == null)
          {
            instance = new DeleteStreamResponseUnmarshaller();
          }
          return instance;
        }
