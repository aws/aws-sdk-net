...
{
    /// <summary>
    /// Returns information about the  PutRecordResult response and response metadata.
    /// </summary>
    public class PutRecordResponse : AmazonWebServiceResponse
    {
        ...
        public PutRecordResult PutRecordResult
        {
            get
            {
                if(this.putRecordResult == null)
                {
                    this.putRecordResult = new PutRecordResult();
                }

                return this.putRecordResult;
            }
            set { this.putRecordResult = value; }
        }
    }
}
