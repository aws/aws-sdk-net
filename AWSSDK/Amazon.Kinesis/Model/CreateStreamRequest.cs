...
namespace Amazon.Kinesis.Model
{
    ...
    public class CreateStreamRequest : AmazonWebServiceRequest
    {
        ...
        /// for greater provisioned throughput. <b>Note:</b> The default limit for an AWS account is 10 shards per stream. If you need to create a
        /// stream with more than 10 shards, <a href="http://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html">contact AWS Support</a> to
        ...
        /// </summary>
        /// <param name="shardCount">The value to set for the ShardCount property </param>
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        public CreateStreamRequest WithShardCount(int shardCount)
        {
