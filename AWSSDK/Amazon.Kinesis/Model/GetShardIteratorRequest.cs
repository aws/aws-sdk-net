...
namespace Amazon.Kinesis.Model
{
    ...
    public class GetShardIteratorRequest : AmazonWebServiceRequest
    {
        ...
        /// <summary>
        /// Sets the ShardIteratorType property
        /// </summary>
        /// <param name="shardIteratorType">The value to set for the ShardIteratorType property </param>
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        ...
        /// </summary>
        /// <param name="startingSequenceNumber">The value to set for the StartingSequenceNumber property </param>
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
