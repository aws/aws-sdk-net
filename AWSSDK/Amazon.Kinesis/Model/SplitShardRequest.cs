...
namespace Amazon.Kinesis.Model
{
    ...
    public class SplitShardRequest : AmazonWebServiceRequest
    {
        ...
        /// </summary>
        /// <param name="shardToSplit">The value to set for the ShardToSplit property </param>
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        ...
        /// </summary>
        /// <param name="newStartingHashKey">The value to set for the NewStartingHashKey property </param>
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
