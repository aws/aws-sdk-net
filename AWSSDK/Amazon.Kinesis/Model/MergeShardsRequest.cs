...
namespace Amazon.Kinesis.Model
{
    ...
    /// </summary>
    /// <seealso cref="Amazon.Kinesis.AmazonKinesis.MergeShards"/>
    public class MergeShardsRequest : AmazonWebServiceRequest
    {
        ...
        /// <summary>
        /// Sets the ShardToMerge property
        /// </summary>
        /// <param name="shardToMerge">The value to set for the ShardToMerge property </param>
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
        ...
        /// <summary>
        /// Sets the AdjacentShardToMerge property
        /// </summary>
        /// <param name="adjacentShardToMerge">The value to set for the AdjacentShardToMerge property </param>
        /// <returns>this instance</returns>
        [Obsolete("The With methods are obsolete and will be removed in version 2 of the AWS SDK for .NET. See http://aws.amazon.com/sdkfornet/#version2 for more information.")]
