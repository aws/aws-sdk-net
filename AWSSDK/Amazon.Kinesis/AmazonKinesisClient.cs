...
namespace Amazon.Kinesis
{
    ...
    /// big data.</para>
    /// </summary>
    public partial class AmazonKinesisClient : AmazonWebServiceClient, AmazonKinesis
    {
        ...
        public AmazonKinesisClient()
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonKinesisConfig(), true, AuthenticationTypes.User | AuthenticationTypes.Session) { }
        ...
        public AmazonKinesisClient(RegionEndpoint region)
            : base(FallbackCredentialsFactory.GetCredentials(), new AmazonKinesisConfig(){RegionEndpoint = region}, true, AuthenticationTypes.User | AuthenticationTypes.Session) { }
        ...
        /// <seealso cref="Amazon.Kinesis.AmazonKinesis.DescribeStream"/>
        /// </summary>
        /// 
        ...
        /// 
        /// <returns>Returns a DescribeStreamResult from AmazonKinesis.</returns>
        public DescribeStreamResponse EndDescribeStream(IAsyncResult asyncResult)
        {
            return endOperation<DescribeStreamResponse>(asyncResult);
        }
        ...
        /// 
        /// <returns>Returns a GetShardIteratorResult from AmazonKinesis.</returns>
        public GetShardIteratorResponse EndGetShardIterator(IAsyncResult asyncResult)
        {
            return endOperation<GetShardIteratorResponse>(asyncResult);
        }
        ...
        /// 
        /// <returns>Returns a PutRecordResult from AmazonKinesis.</returns>
        public PutRecordResponse EndPutRecord(IAsyncResult asyncResult)
        {
            return endOperation<PutRecordResponse>(asyncResult);
        }
        ...
        /// <seealso cref="Amazon.Kinesis.AmazonKinesis.GetRecords"/>
        /// </summary>
        /// 
        ...
        /// 
        /// <returns>Returns a GetRecordsResult from AmazonKinesis.</returns>
        public GetRecordsResponse EndGetRecords(IAsyncResult asyncResult)
        {
            return endOperation<GetRecordsResponse>(asyncResult);
        }
        ...
        {
            return endOperation<SplitShardResponse>(asyncResult);
        }
        ...
        /// <seealso cref="Amazon.Kinesis.AmazonKinesis.CreateStream"/>
        /// </summary>
        /// 
        ...
        {
            return endOperation<CreateStreamResponse>(asyncResult);
        }
        ...
        {
            IAsyncResult asyncResult = invokeDeleteStream(deleteStreamRequest, null, null, true);
            return EndDeleteStream(asyncResult);
        }
        ...
        /// </summary>
        /// 
        /// <param name="deleteStreamRequest">Container for the necessary parameters to execute the DeleteStream operation on AmazonKinesis.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        public IAsyncResult BeginDeleteStream(DeleteStreamRequest deleteStreamRequest, AsyncCallback callback, object state)
        {
            return invokeDeleteStream(deleteStreamRequest, callback, state, false);
        }
        ...
        {
            return endOperation<DeleteStreamResponse>(asyncResult);
        }
        
        IAsyncResult invokeDeleteStream(DeleteStreamRequest deleteStreamRequest, AsyncCallback callback, object state, bool synchronized)
        {
            IRequest irequest = new DeleteStreamRequestMarshaller().Marshall(deleteStreamRequest);
        ...
        /// 
        /// <returns>Returns a ListStreamsResult from AmazonKinesis.</returns>
        public ListStreamsResponse EndListStreams(IAsyncResult asyncResult)
        {
            return endOperation<ListStreamsResponse>(asyncResult);
        }
        ...
        {
            return endOperation<MergeShardsResponse>(asyncResult);
        }
