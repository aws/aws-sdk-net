...
namespace Amazon.Kinesis
{
    ...
    /// big data.</para>
    /// </summary>
    public interface AmazonKinesis : IDisposable
    {
        ...
        DescribeStreamResponse DescribeStream(DescribeStreamRequest describeStreamRequest);
        ...
        ///         operation.</returns>
        IAsyncResult BeginDescribeStream(DescribeStreamRequest describeStreamRequest, AsyncCallback callback, object state);
        ...
        ///         operation.</returns>
        IAsyncResult BeginGetShardIterator(GetShardIteratorRequest getShardIteratorRequest, AsyncCallback callback, object state);
        ...
        /// <exception cref="InvalidArgumentException"/>
        /// <exception cref="ResourceNotFoundException"/>
        PutRecordResponse PutRecord(PutRecordRequest putRecordRequest);
        ...
        ///         operation.</returns>
        IAsyncResult BeginPutRecord(PutRecordRequest putRecordRequest, AsyncCallback callback, object state);
        ...
        ///         operation.</returns>
        IAsyncResult BeginGetRecords(GetRecordsRequest getRecordsRequest, AsyncCallback callback, object state);
        ...
        /// <exception cref="InvalidArgumentException"/>
        /// <exception cref="ResourceNotFoundException"/>
        SplitShardResponse SplitShard(SplitShardRequest splitShardRequest);
        ...
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        IAsyncResult BeginSplitShard(SplitShardRequest splitShardRequest, AsyncCallback callback, object state);
        ...
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        IAsyncResult BeginCreateStream(CreateStreamRequest createStreamRequest, AsyncCallback callback, object state);
        ...
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        IAsyncResult BeginDeleteStream(DeleteStreamRequest deleteStreamRequest, AsyncCallback callback, object state);
        ...
        ///         operation.</returns>
        IAsyncResult BeginListStreams(ListStreamsRequest listStreamsRequest, AsyncCallback callback, object state);
        ...
        /// <exception cref="InvalidArgumentException"/>
        /// <exception cref="ResourceNotFoundException"/>
        MergeShardsResponse MergeShards(MergeShardsRequest mergeShardsRequest);
        ...
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        IAsyncResult BeginMergeShards(MergeShardsRequest mergeShardsRequest, AsyncCallback callback, object state);
