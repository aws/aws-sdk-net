...
* OpenSearchServerless (3.7.506.0)
...
* BedrockAgentCoreControl (3.7.522.0)
...
* BedrockAgentCoreControl (3.7.518.0)
...
* OpenSearchService (3.7.509.0)
	* Adding support for DeploymentStrategyOptions
* QuickSight (3.7.513.0)
