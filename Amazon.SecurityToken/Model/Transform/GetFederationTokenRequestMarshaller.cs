...
namespace Amazon.SecurityToken.Model.Transform
{
    ...
    /// </summary>       
    public class GetFederationTokenRequestMarshaller : IMarshaller<IRequest<GetFederationTokenRequest>, GetFederationTokenRequest> 
    {

        public IRequest<GetFederationTokenRequest> Marshall(GetFederationTokenRequest getFederationTokenRequest) 
        {
            IRequest<GetFederationTokenRequest> request = new DefaultRequest<GetFederationTokenRequest>(getFederationTokenRequest, "AmazonSecurityTokenService");
