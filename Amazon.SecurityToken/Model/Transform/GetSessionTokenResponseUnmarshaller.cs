...
namespace Amazon.SecurityToken.Model.Transform
{
    ...
    /// </summary>
    internal class GetSessionTokenResponseUnmarshaller : IResponseUnmarshaller<GetSessionTokenResponse, UnmarshallerContext> {

        public GetSessionTokenResponse Unmarshall(UnmarshallerContext context) 
        {
