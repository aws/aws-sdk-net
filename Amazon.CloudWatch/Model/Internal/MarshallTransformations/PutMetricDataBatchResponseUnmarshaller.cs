...
{
    /// <summary>
    ///    Response Unmarshaller for PutMetricDataBatch operation
    /// </summary>
    internal class PutMetricDataBatchResponseUnmarshaller : XmlResponseUnmarshaller
    {

        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context) 
        {
            PutMetricDataBatchResponse response = new PutMetricDataBatchResponse();
        ...
        private static PutMetricDataBatchResponseUnmarshaller instance;
