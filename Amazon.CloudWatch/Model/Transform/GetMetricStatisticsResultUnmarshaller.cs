...
namespace Amazon.CloudWatch.Model.Transform
{
     ...
     /// </summary>
    internal class GetMetricStatisticsResultUnmarshaller : IUnmarshaller<GetMetricStatisticsResult, UnmarshallerContext> 
    {
        public GetMetricStatisticsResult Unmarshall(UnmarshallerContext context) 
        {
