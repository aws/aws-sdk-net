...
namespace Amazon.CloudWatch.Model.Transform
{
    ...
    /// </summary>       
    public class PutMetricAlarmRequestMarshaller : IMarshaller<IRequest<PutMetricAlarmRequest>, PutMetricAlarmRequest> 
    {

        public IRequest<PutMetricAlarmRequest> Marshall(PutMetricAlarmRequest putMetricAlarmRequest) 
        {
            IRequest<PutMetricAlarmRequest> request = new DefaultRequest<PutMetricAlarmRequest>(putMetricAlarmRequest, "AmazonCloudWatch");
