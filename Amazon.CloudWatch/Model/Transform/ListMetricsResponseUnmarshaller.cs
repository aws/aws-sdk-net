...
namespace Amazon.CloudWatch.Model.Transform
{
    ...
    /// </summary>
    internal class ListMetricsResponseUnmarshaller : IResponseUnmarshaller<ListMetricsResponse, UnmarshallerContext> {

        public ListMetricsResponse Unmarshall(UnmarshallerContext context) 
        {
