...
namespace Amazon.CloudWatch.Model.Transform
{
    ...
    /// </summary>
    internal class PutMetricAlarmResponseUnmarshaller : IResponseUnmarshaller<PutMetricAlarmResponse, UnmarshallerContext> {

        public PutMetricAlarmResponse Unmarshall(UnmarshallerContext context) 
        {
