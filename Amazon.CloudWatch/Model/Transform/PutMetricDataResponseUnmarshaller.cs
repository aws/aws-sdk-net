...
namespace Amazon.CloudWatch.Model.Transform
{
    ...
    /// </summary>
    internal class PutMetricDataResponseUnmarshaller : IResponseUnmarshaller<PutMetricDataResponse, UnmarshallerContext> {

        public PutMetricDataResponse Unmarshall(UnmarshallerContext context) 
        {
