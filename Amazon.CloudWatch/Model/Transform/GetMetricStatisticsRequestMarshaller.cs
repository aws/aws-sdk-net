...
namespace Amazon.CloudWatch.Model.Transform
{
    ...
    /// </summary>       
    public class GetMetricStatisticsRequestMarshaller : IMarshaller<IRequest<GetMetricStatisticsRequest>, GetMetricStatisticsRequest> 
    {

        public IRequest<GetMetricStatisticsRequest> Marshall(GetMetricStatisticsRequest getMetricStatisticsRequest) 
        {
            IRequest<GetMetricStatisticsRequest> request = new DefaultRequest<GetMetricStatisticsRequest>(getMetricStatisticsRequest, "AmazonCloudWatch");
