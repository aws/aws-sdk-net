...
namespace Amazon.CloudWatch.Model.Transform
{
     ...
     /// </summary>
    internal class DescribeAlarmsForMetricResultUnmarshaller : IUnmarshaller<DescribeAlarmsForMetricResult, UnmarshallerContext> 
    {
        public DescribeAlarmsForMetricResult Unmarshall(UnmarshallerContext context) 
        {
