...
namespace Amazon.CloudWatch.Model.Transform
{
    ...
    /// </summary>       
    public class DescribeAlarmsRequestMarshaller : IMarshaller<IRequest<DescribeAlarmsRequest>, DescribeAlarmsRequest> 
    {

        public IRequest<DescribeAlarmsRequest> Marshall(DescribeAlarmsRequest describeAlarmsRequest) 
        {
            IRequest<DescribeAlarmsRequest> request = new DefaultRequest<DescribeAlarmsRequest>(describeAlarmsRequest, "AmazonCloudWatch");
