...
namespace Amazon.CloudWatch.Model.Transform
{
    ...
    /// </summary>       
    public class DescribeAlarmHistoryRequestMarshaller : IMarshaller<IRequest<DescribeAlarmHistoryRequest>, DescribeAlarmHistoryRequest> 
    {

        public IRequest<DescribeAlarmHistoryRequest> Marshall(DescribeAlarmHistoryRequest describeAlarmHistoryRequest) 
        {
            IRequest<DescribeAlarmHistoryRequest> request = new DefaultRequest<DescribeAlarmHistoryRequest>(describeAlarmHistoryRequest, "AmazonCloudWatch");
