...
namespace Amazon.CloudWatch.Model.Transform
{
    ...
    /// </summary>       
    public class DescribeAlarmsForMetricRequestMarshaller : IMarshaller<IRequest<DescribeAlarmsForMetricRequest>, DescribeAlarmsForMetricRequest> 
    {

        public IRequest<DescribeAlarmsForMetricRequest> Marshall(DescribeAlarmsForMetricRequest describeAlarmsForMetricRequest) 
        {
            IRequest<DescribeAlarmsForMetricRequest> request = new DefaultRequest<DescribeAlarmsForMetricRequest>(describeAlarmsForMetricRequest, "AmazonCloudWatch");
