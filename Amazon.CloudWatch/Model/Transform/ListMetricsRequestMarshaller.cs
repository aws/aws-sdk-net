...
namespace Amazon.CloudWatch.Model.Transform
{
    ...
    /// </summary>       
    public class ListMetricsRequestMarshaller : IMarshaller<IRequest<ListMetricsRequest>, ListMetricsRequest> 
    {

        public IRequest<ListMetricsRequest> Marshall(ListMetricsRequest listMetricsRequest) 
        {
            IRequest<ListMetricsRequest> request = new DefaultRequest<ListMetricsRequest>(listMetricsRequest, "AmazonCloudWatch");
