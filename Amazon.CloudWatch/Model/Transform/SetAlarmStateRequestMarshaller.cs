...
namespace Amazon.CloudWatch.Model.Transform
{
    ...
    /// </summary>       
    public class SetAlarmStateRequestMarshaller : IMarshaller<IRequest<SetAlarmStateRequest>, SetAlarmStateRequest> 
    {

        public IRequest<SetAlarmStateRequest> Marshall(SetAlarmStateRequest setAlarmStateRequest) 
        {
            IRequest<SetAlarmStateRequest> request = new DefaultRequest<SetAlarmStateRequest>(setAlarmStateRequest, "AmazonCloudWatch");
