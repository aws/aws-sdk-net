...
namespace Amazon.CloudWatch.Model.Transform
{
    ...
    /// </summary>       
    public class PutMetricDataRequestMarshaller : IMarshaller<IRequest<PutMetricDataRequest>, PutMetricDataRequest> 
    {

        public IRequest<PutMetricDataRequest> Marshall(PutMetricDataRequest putMetricDataRequest) 
        {
            IRequest<PutMetricDataRequest> request = new DefaultRequest<PutMetricDataRequest>(putMetricDataRequest, "AmazonCloudWatch");
