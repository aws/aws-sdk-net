...
namespace Amazon.CloudWatch.Model.Transform
{
     ...
     /// </summary>
    internal class DescribeAlarmHistoryResultUnmarshaller : IUnmarshaller<DescribeAlarmHistoryResult, UnmarshallerContext> 
    {
        public DescribeAlarmHistoryResult Unmarshall(UnmarshallerContext context) 
        {
