...
namespace Amazon.CloudWatch.Model.Transform
{
    ...
    /// </summary>
    internal class DescribeAlarmsForMetricResponseUnmarshaller : IResponseUnmarshaller<DescribeAlarmsForMetricResponse, UnmarshallerContext> {

        public DescribeAlarmsForMetricResponse Unmarshall(UnmarshallerContext context) 
        {
