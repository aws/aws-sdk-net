...
namespace Amazon.CloudWatch.Model.Transform
{
    ...
    /// </summary>
    internal class GetMetricStatisticsResponseUnmarshaller : IResponseUnmarshaller<GetMetricStatisticsResponse, UnmarshallerContext> {

        public GetMetricStatisticsResponse Unmarshall(UnmarshallerContext context) 
        {
