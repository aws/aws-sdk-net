...
namespace Amazon.CloudWatch.Model.Transform
{
    ...
    /// </summary>
    internal class DescribeAlarmHistoryResponseUnmarshaller : IResponseUnmarshaller<DescribeAlarmHistoryResponse, UnmarshallerContext> {

        public DescribeAlarmHistoryResponse Unmarshall(UnmarshallerContext context) 
        {
