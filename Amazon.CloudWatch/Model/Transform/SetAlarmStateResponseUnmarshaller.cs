...
namespace Amazon.CloudWatch.Model.Transform
{
    ...
    /// </summary>
    internal class SetAlarmStateResponseUnmarshaller : IResponseUnmarshaller<SetAlarmStateResponse, UnmarshallerContext> {

        public SetAlarmStateResponse Unmarshall(UnmarshallerContext context) 
        {
