...
namespace Amazon.CloudWatch.Model.Transform
{
    ...
    /// </summary>       
    public class DisableAlarmActionsRequestMarshaller : IMarshaller<IRequest<DisableAlarmActionsRequest>, DisableAlarmActionsRequest> 
    {

        public IRequest<DisableAlarmActionsRequest> Marshall(DisableAlarmActionsRequest disableAlarmActionsRequest) 
        {
            IRequest<DisableAlarmActionsRequest> request = new DefaultRequest<DisableAlarmActionsRequest>(disableAlarmActionsRequest, "AmazonCloudWatch");
