...
namespace Amazon.CloudWatch.Model.Transform
{
     ...
     /// </summary>
    internal class AlarmHistoryItemUnmarshaller : IUnmarshaller<AlarmHistoryItem, UnmarshallerContext> 
    {
        public AlarmHistoryItem Unmarshall(UnmarshallerContext context) 
        {
