...
namespace Amazon.CloudWatch.Model.Transform
{
    ...
    /// </summary>
    internal class DeleteAlarmsResponseUnmarshaller : IResponseUnmarshaller<DeleteAlarmsResponse, UnmarshallerContext> {

        public DeleteAlarmsResponse Unmarshall(UnmarshallerContext context) 
        {
