...
namespace Amazon.AWSSupport
{
	...
	public partial interface IAmazonAWSSupport : IDisposable
    {
        ...
        /// </param>
		Task<AddAttachmentsToSetResponse> AddAttachmentsToSetAsync(AddAttachmentsToSetRequest addAttachmentsToSetRequest, CancellationToken cancellationToken = default(CancellationToken));
        ...
        ///     A cancellation token that can be used by other objects or threads to receive notice of cancellation.
        /// </param>
		Task<DescribeAttachmentResponse> DescribeAttachmentAsync(DescribeAttachmentRequest describeAttachmentRequest, CancellationToken cancellationToken = default(CancellationToken));
