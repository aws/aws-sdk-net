...
namespace Amazon.ElasticLoadBalancing
{
	...
	public partial interface IAmazonElasticLoadBalancing : IDisposable
    {
        ...
        ///     A cancellation token that can be used by other objects or threads to receive notice of cancellation.
        /// </param>
		Task<DescribeLoadBalancerAttributesResponse> DescribeLoadBalancerAttributesAsync(DescribeLoadBalancerAttributesRequest describeLoadBalancerAttributesRequest, CancellationToken cancellationToken = default(CancellationToken));
        ...
        ///     A cancellation token that can be used by other objects or threads to receive notice of cancellation.
        /// </param>
		Task<ModifyLoadBalancerAttributesResponse> ModifyLoadBalancerAttributesAsync(ModifyLoadBalancerAttributesRequest modifyLoadBalancerAttributesRequest, CancellationToken cancellationToken = default(CancellationToken));
