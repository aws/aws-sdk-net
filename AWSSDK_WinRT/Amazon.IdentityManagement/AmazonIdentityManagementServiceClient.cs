...
namespace Amazon.IdentityManagement
{
	...
	public partial class AmazonIdentityManagementServiceClient : AmazonWebServiceClient, Amazon.IdentityManagement.IAmazonIdentityManagementService
    {
        ...
        ///     A cancellation token that can be used by other objects or threads to receive notice of cancellation.
        /// </param>
		public Task<GenerateCredentialReportResponse> GenerateCredentialReportAsync(GenerateCredentialReportRequest generateCredentialReportRequest, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return Invoke<IRequest, GenerateCredentialReportRequest, GenerateCredentialReportResponse>(generateCredentialReportRequest, marshaller, unmarshaller, signer, cancellationToken);
        }
        ...
        ///     A cancellation token that can be used by other objects or threads to receive notice of cancellation.
        /// </param>
		public Task<GetCredentialReportResponse> GetCredentialReportAsync(GetCredentialReportRequest getCredentialReportRequest, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return Invoke<IRequest, GetCredentialReportRequest, GetCredentialReportResponse>(getCredentialReportRequest, marshaller, unmarshaller, signer, cancellationToken);
        }
