...
namespace Amazon.IdentityManagement
{
	...
	public partial interface IAmazonIdentityManagementService : IDisposable
    {
        ...
        ///     A cancellation token that can be used by other objects or threads to receive notice of cancellation.
        /// </param>
		Task<GenerateCredentialReportResponse> GenerateCredentialReportAsync(GenerateCredentialReportRequest generateCredentialReportRequest, CancellationToken cancellationToken = default(CancellationToken));
        ...
        ///     A cancellation token that can be used by other objects or threads to receive notice of cancellation.
        /// </param>
		Task<GetCredentialReportResponse> GetCredentialReportAsync(GetCredentialReportRequest getCredentialReportRequest, CancellationToken cancellationToken = default(CancellationToken));
