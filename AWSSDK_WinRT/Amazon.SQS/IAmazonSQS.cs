...
namespace Amazon.SQS
{
	...
	public partial interface IAmazonSQS : IDisposable
    {
        ...
        ///     A cancellation token that can be used by other objects or threads to receive notice of cancellation.
        /// </param>
		Task<ListDeadLetterSourceQueuesResponse> ListDeadLetterSourceQueuesAsync(ListDeadLetterSourceQueuesRequest listDeadLetterSourceQueuesRequest, CancellationToken cancellationToken = default(CancellationToken));
