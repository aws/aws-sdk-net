...
namespace Amazon.RDS.Model
{
    ...
    public class RestoreDBInstanceToPointInTimeResponse
    {
        ...
        /// <summary>
        /// Sets the RestoreDBInstanceToPointInTimeResult property
        /// </summary>
        /// <param name="restoreDBInstanceToPointInTimeResult">Information pertaining to the newly created DB Instance.</param>
        /// <returns>this instance</returns>
        public RestoreDBInstanceToPointInTimeResponse WithRestoreDBInstanceToPointInTimeResult(RestoreDBInstanceToPointInTimeResult restoreDBInstanceToPointInTimeResult)
        {
        ...
        /// <returns>this instance</returns>
        public RestoreDBInstanceToPointInTimeResponse WithResponseMetadata(ResponseMetadata responseMetadata)
        {
