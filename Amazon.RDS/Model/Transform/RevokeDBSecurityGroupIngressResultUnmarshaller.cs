...
namespace Amazon.RDS.Model.Transform
{
    ...
    internal class RevokeDBSecurityGroupIngressResultUnmarshaller : IUnmarshaller<RevokeDBSecurityGroupIngressResult, UnmarshallerContext> {
        ...
        private static RevokeDBSecurityGroupIngressResultUnmarshaller instance;
        
        public static RevokeDBSecurityGroupIngressResultUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new RevokeDBSecurityGroupIngressResultUnmarshaller();
            }
            return instance;
        }        
    }
