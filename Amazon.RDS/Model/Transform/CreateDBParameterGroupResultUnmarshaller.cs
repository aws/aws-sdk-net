...
namespace Amazon.RDS.Model.Transform
{
    ...
    internal class CreateDBParameterGroupResultUnmarshaller : IUnmarshaller<CreateDBParameterGroupResult, UnmarshallerContext> {
        ...
        public CreateDBParameterGroupResult Unmarshall(UnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        result.DBParameterGroup = DBParameterGroupUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
                }
        ...
        private static CreateDBParameterGroupResultUnmarshaller instance;
        
        public static CreateDBParameterGroupResultUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new CreateDBParameterGroupResultUnmarshaller();
            }
            return instance;
        }        
    }
