...
namespace Amazon.RDS.Model.Transform
{
    ...
    internal class DeleteDBInstanceResultUnmarshaller : IUnmarshaller<DeleteDBInstanceResult, UnmarshallerContext> {
        ...
        private static DeleteDBInstanceResultUnmarshaller instance;
        
        public static DeleteDBInstanceResultUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DeleteDBInstanceResultUnmarshaller();
            }
            return instance;
        }        
    }
