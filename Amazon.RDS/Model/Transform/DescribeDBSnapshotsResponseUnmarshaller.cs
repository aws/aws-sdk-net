...
namespace Amazon.RDS.Model.Transform
{
    ...
    /// </summary>
    internal class DescribeDBSnapshotsResponseUnmarshaller : IResponseUnmarshaller<DescribeDBSnapshotsResponse, UnmarshallerContext> {

        public DescribeDBSnapshotsResponse Unmarshall(UnmarshallerContext context) 
        {
        ...
        private static DescribeDBSnapshotsResponseUnmarshaller instance;

        public static DescribeDBSnapshotsResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DescribeDBSnapshotsResponseUnmarshaller();
            }
            return instance;
        }
