...
namespace Amazon.RDS.Model.Transform
{
    ...
    /// </summary>
    internal class DescribeReservedDBInstancesResponseUnmarshaller : IResponseUnmarshaller<DescribeReservedDBInstancesResponse, UnmarshallerContext> {

        public DescribeReservedDBInstancesResponse Unmarshall(UnmarshallerContext context) 
        {
