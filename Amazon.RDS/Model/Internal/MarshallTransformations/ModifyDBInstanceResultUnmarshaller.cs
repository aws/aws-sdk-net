...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    internal class ModifyDBInstanceResultUnmarshaller : IUnmarshaller<ModifyDBInstanceResult, UnmarshallerContext> {
        ...
        private static ModifyDBInstanceResultUnmarshaller instance;
        
        public static ModifyDBInstanceResultUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new ModifyDBInstanceResultUnmarshaller();
            }
            return instance;
        }        
    }
