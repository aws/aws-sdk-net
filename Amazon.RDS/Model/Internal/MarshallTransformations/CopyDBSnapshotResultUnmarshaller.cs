...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    internal class CopyDBSnapshotResultUnmarshaller : IUnmarshaller<CopyDBSnapshotResult, UnmarshallerContext> {
        ...
        private static CopyDBSnapshotResultUnmarshaller instance;
        
        public static CopyDBSnapshotResultUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new CopyDBSnapshotResultUnmarshaller();
            }
            return instance;
        }        
    }
