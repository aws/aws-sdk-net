...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    internal class RestoreDBInstanceFromDBSnapshotResultUnmarshaller : IUnmarshaller<RestoreDBInstanceFromDBSnapshotResult, UnmarshallerContext> {
        ...
        private static RestoreDBInstanceFromDBSnapshotResultUnmarshaller instance;
        
        public static RestoreDBInstanceFromDBSnapshotResultUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new RestoreDBInstanceFromDBSnapshotResultUnmarshaller();
            }
            return instance;
        }        
    }
