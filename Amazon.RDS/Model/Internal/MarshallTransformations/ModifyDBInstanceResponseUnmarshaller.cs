...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>
    internal class ModifyDBInstanceResponseUnmarshaller : IResponseUnmarshaller<ModifyDBInstanceResponse, UnmarshallerContext> {

        public ModifyDBInstanceResponse Unmarshall(UnmarshallerContext context) 
        {
