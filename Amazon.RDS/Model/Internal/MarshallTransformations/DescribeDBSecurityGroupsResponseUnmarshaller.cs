    ...
    internal class DescribeDBSecurityGroupsResponseUnmarshaller : IResponseUnmarshaller<DescribeDBSecurityGroupsResponse, UnmarshallerContext> {
        ...
        public DescribeDBSecurityGroupsResponse Unmarshall(UnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                ...
                {
                    if(context.TestExpression("DescribeDBSecurityGroupsResult", 2))
                    {
                        response.DescribeDBSecurityGroupsResult = DescribeDBSecurityGroupsResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static DescribeDBSecurityGroupsResponseUnmarshaller instance;

        public static DescribeDBSecurityGroupsResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DescribeDBSecurityGroupsResponseUnmarshaller();
            }
            return instance;
        }
