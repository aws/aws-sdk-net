...
namespace Amazon.RDS.Model
{
    ...
    public class AuthorizeDBSecurityGroupIngressResponse
    {
        ...
        /// <summary>
        /// Sets the AuthorizeDBSecurityGroupIngressResult property
        /// </summary>
        /// <param name="authorizeDBSecurityGroupIngressResult">Details for a particular database security group.</param>
        /// <returns>this instance</returns>
        public AuthorizeDBSecurityGroupIngressResponse WithAuthorizeDBSecurityGroupIngressResult(AuthorizeDBSecurityGroupIngressResult authorizeDBSecurityGroupIngressResult)
        {
        ...
        /// <returns>this instance</returns>
        public AuthorizeDBSecurityGroupIngressResponse WithResponseMetadata(ResponseMetadata responseMetadata)
        {
