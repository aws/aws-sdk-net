...
namespace Amazon.RDS.Model
{
    ...
    public class DeleteDBSnapshotResponse
    {
        ...
        /// <summary>
        /// Sets the DeleteDBSnapshotResult property
        /// </summary>
        /// <param name="deleteDBSnapshotResult">A list of DB Snapshot data types.</param>
        /// <returns>this instance</returns>
        public DeleteDBSnapshotResponse WithDeleteDBSnapshotResult(DeleteDBSnapshotResult deleteDBSnapshotResult)
        {
        ...
        /// <returns>this instance</returns>
        public DeleteDBSnapshotResponse WithResponseMetadata(ResponseMetadata responseMetadata)
        {
