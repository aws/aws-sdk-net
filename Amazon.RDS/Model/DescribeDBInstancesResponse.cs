...
namespace Amazon.RDS.Model
{
    ...
    public class DescribeDBInstancesResponse
    {
        ...
        /// <summary>
        /// Sets the DescribeDBInstancesResult property
        /// </summary>
        /// <param name="describeDBInstancesResult">A list of DB Instance information</param>
        /// <returns>this instance</returns>
        public DescribeDBInstancesResponse WithDescribeDBInstancesResult(DescribeDBInstancesResult describeDBInstancesResult)
        {
        ...
        /// <returns>this instance</returns>
        public DescribeDBInstancesResponse WithResponseMetadata(ResponseMetadata responseMetadata)
        {
