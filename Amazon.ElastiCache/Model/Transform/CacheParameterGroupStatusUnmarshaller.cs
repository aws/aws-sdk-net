...
namespace Amazon.ElastiCache.Model.Transform
{
     ...
     /// </summary>
    internal class CacheParameterGroupStatusUnmarshaller : IUnmarshaller<CacheParameterGroupStatus, UnmarshallerContext> 
    {
        public CacheParameterGroupStatus Unmarshall(UnmarshallerContext context) 
        {
