...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>
    internal class RevokeCacheSecurityGroupIngressResponseUnmarshaller : IResponseUnmarshaller<RevokeCacheSecurityGroupIngressResponse, UnmarshallerContext> {

        public RevokeCacheSecurityGroupIngressResponse Unmarshall(UnmarshallerContext context) 
        {
