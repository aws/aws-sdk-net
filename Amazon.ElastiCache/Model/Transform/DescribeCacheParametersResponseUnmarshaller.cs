...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>
    internal class DescribeCacheParametersResponseUnmarshaller : IResponseUnmarshaller<DescribeCacheParametersResponse, UnmarshallerContext> {

        public DescribeCacheParametersResponse Unmarshall(UnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)
                {
                    ...
                    {
                        response.DescribeCacheParametersResult = DescribeCacheParametersResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
