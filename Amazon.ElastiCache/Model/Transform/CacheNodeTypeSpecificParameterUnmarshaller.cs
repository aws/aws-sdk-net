...
namespace Amazon.ElastiCache.Model.Transform
{
     ...
     /// </summary>
    internal class CacheNodeTypeSpecificParameterUnmarshaller : IUnmarshaller<CacheNodeTypeSpecificParameter, UnmarshallerContext> 
    {
        public CacheNodeTypeSpecificParameter Unmarshall(UnmarshallerContext context) 
        {
