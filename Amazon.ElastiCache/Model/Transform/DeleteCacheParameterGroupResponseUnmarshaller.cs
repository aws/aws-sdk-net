...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>
    internal class DeleteCacheParameterGroupResponseUnmarshaller : IResponseUnmarshaller<DeleteCacheParameterGroupResponse, UnmarshallerContext> {

        public DeleteCacheParameterGroupResponse Unmarshall(UnmarshallerContext context) 
        {
        ...
        private static DeleteCacheParameterGroupResponseUnmarshaller instance;
