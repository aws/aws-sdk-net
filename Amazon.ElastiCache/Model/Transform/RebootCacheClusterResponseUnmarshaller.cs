...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>
    internal class RebootCacheClusterResponseUnmarshaller : IResponseUnmarshaller<RebootCacheClusterResponse, UnmarshallerContext> {

        public RebootCacheClusterResponse Unmarshall(UnmarshallerContext context) 
        {
