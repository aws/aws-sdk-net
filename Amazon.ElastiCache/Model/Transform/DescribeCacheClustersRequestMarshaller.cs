...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>       
    public class DescribeCacheClustersRequestMarshaller : IMarshaller<IRequest<DescribeCacheClustersRequest>, DescribeCacheClustersRequest> 
    {

        public IRequest<DescribeCacheClustersRequest> Marshall(DescribeCacheClustersRequest describeCacheClustersRequest) 
        {
            IRequest<DescribeCacheClustersRequest> request = new DefaultRequest<DescribeCacheClustersRequest>(describeCacheClustersRequest, "AmazonElastiCache");
