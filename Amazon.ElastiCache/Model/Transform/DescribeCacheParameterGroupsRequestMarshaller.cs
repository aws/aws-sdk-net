...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>       
    public class DescribeCacheParameterGroupsRequestMarshaller : IMarshaller<IRequest<DescribeCacheParameterGroupsRequest>, DescribeCacheParameterGroupsRequest> 
    {

        public IRequest<DescribeCacheParameterGroupsRequest> Marshall(DescribeCacheParameterGroupsRequest describeCacheParameterGroupsRequest) 
        {
            IRequest<DescribeCacheParameterGroupsRequest> request = new DefaultRequest<DescribeCacheParameterGroupsRequest>(describeCacheParameterGroupsRequest, "AmazonElastiCache");
