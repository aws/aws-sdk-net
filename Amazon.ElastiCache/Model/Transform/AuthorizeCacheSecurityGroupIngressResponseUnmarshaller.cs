...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>
    internal class AuthorizeCacheSecurityGroupIngressResponseUnmarshaller : IResponseUnmarshaller<AuthorizeCacheSecurityGroupIngressResponse, UnmarshallerContext> {

        public AuthorizeCacheSecurityGroupIngressResponse Unmarshall(UnmarshallerContext context) 
        {
