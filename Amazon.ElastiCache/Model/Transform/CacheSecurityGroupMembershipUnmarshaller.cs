...
namespace Amazon.ElastiCache.Model.Transform
{
     ...
     /// </summary>
    internal class CacheSecurityGroupMembershipUnmarshaller : IUnmarshaller<CacheSecurityGroupMembership, UnmarshallerContext> 
    {
        public CacheSecurityGroupMembership Unmarshall(UnmarshallerContext context) 
        {
