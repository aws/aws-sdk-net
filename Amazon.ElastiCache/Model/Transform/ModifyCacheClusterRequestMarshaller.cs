...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>       
    public class ModifyCacheClusterRequestMarshaller : IMarshaller<IRequest<ModifyCacheClusterRequest>, ModifyCacheClusterRequest> 
    {

        public IRequest<ModifyCacheClusterRequest> Marshall(ModifyCacheClusterRequest modifyCacheClusterRequest) 
        {
            IRequest<ModifyCacheClusterRequest> request = new DefaultRequest<ModifyCacheClusterRequest>(modifyCacheClusterRequest, "AmazonElastiCache");
