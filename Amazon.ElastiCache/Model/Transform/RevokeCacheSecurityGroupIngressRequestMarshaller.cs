...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>       
    public class RevokeCacheSecurityGroupIngressRequestMarshaller : IMarshaller<IRequest<RevokeCacheSecurityGroupIngressRequest>, RevokeCacheSecurityGroupIngressRequest> 
    {

        public IRequest<RevokeCacheSecurityGroupIngressRequest> Marshall(RevokeCacheSecurityGroupIngressRequest revokeCacheSecurityGroupIngressRequest) 
        {
            IRequest<RevokeCacheSecurityGroupIngressRequest> request = new DefaultRequest<RevokeCacheSecurityGroupIngressRequest>(revokeCacheSecurityGroupIngressRequest, "AmazonElastiCache");
