...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>
    internal class ResetCacheParameterGroupResponseUnmarshaller : IResponseUnmarshaller<ResetCacheParameterGroupResponse, UnmarshallerContext> {

        public ResetCacheParameterGroupResponse Unmarshall(UnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)
                {
                    ...
                    {
                        response.ResetCacheParameterGroupResult = ResetCacheParameterGroupResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static ResetCacheParameterGroupResponseUnmarshaller instance;
