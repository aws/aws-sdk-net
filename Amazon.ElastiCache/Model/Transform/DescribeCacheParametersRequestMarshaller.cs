...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>       
    public class DescribeCacheParametersRequestMarshaller : IMarshaller<IRequest<DescribeCacheParametersRequest>, DescribeCacheParametersRequest> 
    {

        public IRequest<DescribeCacheParametersRequest> Marshall(DescribeCacheParametersRequest describeCacheParametersRequest) 
        {
            IRequest<DescribeCacheParametersRequest> request = new DefaultRequest<DescribeCacheParametersRequest>(describeCacheParametersRequest, "AmazonElastiCache");
