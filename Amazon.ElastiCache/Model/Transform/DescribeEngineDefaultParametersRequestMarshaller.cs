...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    public class DescribeEngineDefaultParametersRequestMarshaller : IMarshaller<IRequest<DescribeEngineDefaultParametersRequest>, DescribeEngineDefaultParametersRequest> 
    {
        ...
        {
            IRequest<DescribeEngineDefaultParametersRequest> request = new DefaultRequest<DescribeEngineDefaultParametersRequest>(describeEngineDefaultParametersRequest, "AmazonElastiCache");
