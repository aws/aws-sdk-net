...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>
    internal class CreateCacheSecurityGroupResponseUnmarshaller : IResponseUnmarshaller<CreateCacheSecurityGroupResponse, UnmarshallerContext> {

        public CreateCacheSecurityGroupResponse Unmarshall(UnmarshallerContext context) 
        {
