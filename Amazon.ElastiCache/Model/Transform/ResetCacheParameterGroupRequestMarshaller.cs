...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>       
    public class ResetCacheParameterGroupRequestMarshaller : IMarshaller<IRequest<ResetCacheParameterGroupRequest>, ResetCacheParameterGroupRequest> 
    {

        public IRequest<ResetCacheParameterGroupRequest> Marshall(ResetCacheParameterGroupRequest resetCacheParameterGroupRequest) 
        {
            IRequest<ResetCacheParameterGroupRequest> request = new DefaultRequest<ResetCacheParameterGroupRequest>(resetCacheParameterGroupRequest, "AmazonElastiCache");
