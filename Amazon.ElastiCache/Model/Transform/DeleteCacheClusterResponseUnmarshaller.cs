...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>
    internal class DeleteCacheClusterResponseUnmarshaller : IResponseUnmarshaller<DeleteCacheClusterResponse, UnmarshallerContext> {

        public DeleteCacheClusterResponse Unmarshall(UnmarshallerContext context) 
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)
                {
                    ...
                    {
                        response.DeleteCacheClusterResult = DeleteCacheClusterResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
        ...
        private static DeleteCacheClusterResponseUnmarshaller instance;

        public static DeleteCacheClusterResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new DeleteCacheClusterResponseUnmarshaller();
            }
            return instance;
        }
