...
namespace Amazon.ElastiCache.Model.Transform
{
     ...
     /// </summary>
    internal class CacheNodeTypeSpecificValueUnmarshaller : IUnmarshaller<CacheNodeTypeSpecificValue, UnmarshallerContext> 
    {
        public CacheNodeTypeSpecificValue Unmarshall(UnmarshallerContext context) 
        {
