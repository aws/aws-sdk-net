...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>
    internal class DescribeCacheParameterGroupsResponseUnmarshaller : IResponseUnmarshaller<DescribeCacheParameterGroupsResponse, UnmarshallerContext> {

        public DescribeCacheParameterGroupsResponse Unmarshall(UnmarshallerContext context) 
        {
