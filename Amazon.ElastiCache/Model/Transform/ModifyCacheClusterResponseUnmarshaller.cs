...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>
    internal class ModifyCacheClusterResponseUnmarshaller : IResponseUnmarshaller<ModifyCacheClusterResponse, UnmarshallerContext> {

        public ModifyCacheClusterResponse Unmarshall(UnmarshallerContext context) 
        {
