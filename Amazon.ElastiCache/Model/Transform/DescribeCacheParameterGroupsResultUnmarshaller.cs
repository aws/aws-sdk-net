...
{
     /// <summary>
     ///   DescribeCacheParameterGroupsResult Unmarshaller
     /// </summary>
    internal class DescribeCacheParameterGroupsResultUnmarshaller : IUnmarshaller<DescribeCacheParameterGroupsResult, UnmarshallerContext> 
    {
        public DescribeCacheParameterGroupsResult Unmarshall(UnmarshallerContext context) 
        {
        ...
        private static DescribeCacheParameterGroupsResultUnmarshaller instance;

        public static DescribeCacheParameterGroupsResultUnmarshaller GetInstance() 
        {
            if (instance == null) 
               instance = new DescribeCacheParameterGroupsResultUnmarshaller();
