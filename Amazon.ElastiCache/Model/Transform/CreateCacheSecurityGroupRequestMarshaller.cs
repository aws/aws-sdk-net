...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>       
    public class CreateCacheSecurityGroupRequestMarshaller : IMarshaller<IRequest<CreateCacheSecurityGroupRequest>, CreateCacheSecurityGroupRequest> 
    {

        public IRequest<CreateCacheSecurityGroupRequest> Marshall(CreateCacheSecurityGroupRequest createCacheSecurityGroupRequest) 
        {
            IRequest<CreateCacheSecurityGroupRequest> request = new DefaultRequest<CreateCacheSecurityGroupRequest>(createCacheSecurityGroupRequest, "AmazonElastiCache");
