...
namespace Amazon.ElastiCache.Model.Transform
{
    ...
    /// </summary>
    internal class DeleteCacheSecurityGroupResponseUnmarshaller : IResponseUnmarshaller<DeleteCacheSecurityGroupResponse, UnmarshallerContext> {

        public DeleteCacheSecurityGroupResponse Unmarshall(UnmarshallerContext context) 
        {
