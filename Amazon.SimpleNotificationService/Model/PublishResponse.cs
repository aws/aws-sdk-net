...
namespace Amazon.SimpleNotificationService.Model
{
    ...
    {    
        private PublishResult publishResultField;
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "PublishResult")]
        public PublishResult PublishResult
        {
            get { return this.publishResultField; }
            set { this.publishResultField = value; }
        }
        ...
        public bool IsSetPublishResult()
        {
            return this.publishResultField != null;
        }
